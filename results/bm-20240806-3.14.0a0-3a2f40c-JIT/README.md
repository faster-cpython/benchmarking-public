...
- Geometric mean: 1.01x faster (HPT: reliability of 77.17%, 1.00x faster at 99th %ile)
- Memory usage: 1.08x
...
- [📄table](bm-20240806-linux-x86_64-brandtbucher-replicate_more-3.14.0a0-3a2f40c-vs-3.13.0.md)
- [📈time plot](bm-20240806-linux-x86_64-brandtbucher-replicate_more-3.14.0a0-3a2f40c-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x faster (HPT: reliability of 93.53%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
