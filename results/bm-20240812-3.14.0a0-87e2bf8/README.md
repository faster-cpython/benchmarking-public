...
- Geometric mean: 1.01x faster (HPT: reliability of 75.64%, 1.00x slower at 99th %ile)
- Memory usage: 1.01x
...
- [📄table](bm-20240812-linux-x86_64-faster%252dcpython-fix_122821-3.14.0a0-87e2bf8-vs-3.13.0.md)
- [📈time plot](bm-20240812-linux-x86_64-faster%252dcpython-fix_122821-3.14.0a0-87e2bf8-vs-3.13.0.svg)
