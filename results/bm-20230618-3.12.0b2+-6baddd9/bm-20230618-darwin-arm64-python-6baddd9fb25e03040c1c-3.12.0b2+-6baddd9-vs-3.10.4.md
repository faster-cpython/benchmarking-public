...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230618-darwin-arm64-python-6baddd9fb25e03040c1c-3.12.0b2+-6baddd9 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| unpickle_pure_python | 203 us                                                 | 146 us: 1.40x faster                                                   |
| json_dumps           | 8.38 ms                                                | 6.34 ms: 1.32x faster                                                  |
...
| python_startup_no_site | 9.73 ms                                                | 9.20 ms: 1.06x faster                                                  |
| Geometric mean         | (ref)                                                  | 1.08x faster                                                           |
...
| Benchmark                | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230618-darwin-arm64-python-6baddd9fb25e03040c1c-3.12.0b2+-6baddd9 |
|--------------------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| typing_runtime_protocols | 344 us                                                 | 91.4 us: 3.77x faster                                                  |
...
| xml_etree_process        | 45.1 ms                                                | 38.9 ms: 1.16x faster                                                  |
| sqlalchemy_declarative   | 74.8 ms                                                | 64.8 ms: 1.16x faster                                                  |
...
| pathlib                  | 28.8 ms                                                | 33.4 ms: 1.16x slower                                                  |
| unpickle_list            | 2.66 us                                                | 3.17 us: 1.19x slower                                                  |
