...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230113-linux-x86_64-faster%2dcpython-faster_gen_close-3.12.0a4+-6ec191a |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------------:|
| float          | 77.2 ms                                                | 71.3 ms: 1.08x faster                                                        |
...
Benchmark hidden because not significant (9): djangocms, sqlglot_transpile, async_tree_none, python_startup, bench_mp_pool, xml_etree_generate, pickle_dict, django_template, async_tree_memoization
