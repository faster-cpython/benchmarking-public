...
- Geometric mean: 1.00x faster (HPT: reliability of 80.96%, 1.00x slower at 99th %ile)
- Memory usage: 1.06x
...
- [📄table](bm-20240813-linux-x86_64-savannahostrowski-jit_mem_10000-3.14.0a0-398f45a-vs-3.13.0.md)
- [📈time plot](bm-20240813-linux-x86_64-savannahostrowski-jit_mem_10000-3.14.0a0-398f45a-vs-3.13.0.svg)
