...
| xml_etree_iterparse  | 70.1 ms                                                | 74.5 ms: 1.06x slower                                                 |
...
| comprehensions           | 16.1 us                                                | 15.0 us: 1.08x faster                                                 |
...
| pickle_list              | 2.81 us                                                | 2.87 us: 1.02x slower                                                 |
| logging_silent           | 68.1 ns                                                | 69.4 ns: 1.02x slower                                                 |
...
| xml_etree_iterparse      | 70.1 ms                                                | 74.5 ms: 1.06x slower                                                 |
| json                     | 2.78 ms                                                | 2.96 ms: 1.07x slower                                                 |
...
| pathlib                  | 27.2 ms                                                | 33.6 ms: 1.23x slower                                                 |
| mypy2                    | 195 ms                                                 | 259 ms: 1.33x slower                                                  |
| async_generators         | 196 ms                                                 | 311 ms: 1.58x slower                                                  |
| Geometric mean           | (ref)                                                  | 1.02x faster                                                          |

Benchmark hidden because not significant (7): tornado_http, async_tree_io, nqueens, python_startup, raytrace, coroutines, python_startup_no_site
