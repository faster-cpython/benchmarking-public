...
- Geometric mean: 1.037x faster (HPT: reliability of 97.97%, 1.00x faster at 99th %ile)
- Memory usage: 0.98x
...
- [📄table](bm-20240912-linux-x86_64-brandtbucher-confidence-3.14.0a0-d06074b-vs-3.13.0.md)
- [📈time plot](bm-20240912-linux-x86_64-brandtbucher-confidence-3.14.0a0-d06074b-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.006x faster (HPT: reliability of 99.94%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
