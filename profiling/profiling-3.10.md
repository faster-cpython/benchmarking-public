...
| 1.01% | `python` | `PyObject_GenericGetAttr` | dynamic |
...
| 1.36% | `python` | `sre_ucs2_charset.isra.0` | library |
...
| 1.29% | `python` | `trace_call_function` | unknown |
...
| 1.55% | `python` | `_PyEval_MakeFrameVector` | unknown |
...
| 1.21% | `python` | `_PyDict_GetItem_KnownHash` | unknown |
...
| 1.33% | `libz.so.1.2.11` | `inflateBackEnd` | library |
...
| 1.26% | `python` | `_PyDict_GetItemHint` | unknown |
...
| 1.22% | `python` | `PyObject_RichCompareBool` | dynamic |
...
| 1.53% | `python` | `_PyObject_GetMethod` | dynamic |
...
| 1.65% | `python` | `set_add_entry` | unknown |
...
| 1.43% | `libc-2.31.so` | `pthread_attr_setschedparam` | libc |
...
| 2.02% | `python` | `lookdict_unicode_nodummy` | unknown |
...
| 1.80% | `python` | `_PyDict_GetItemHint` | unknown |
| 1.69% | `python` | `frame_dealloc` | memory |
...
| 1.01% | `python` | `lookdict_unicode_nodummy` | unknown |
| 1.00% | `python` | `_Py_CheckFunctionResult` | unknown |
...
| 1.50% | `python` | `_PyType_Lookup` | lookup |
...
| 1.14% | `python` | `_PyObject_GetMethod` | dynamic |
...
| 1.22% | `python` | `tupledealloc` | unknown |
...
| 1.79% | `_pickle.cpython-310-x86_64-linux-gnu.so` | `_Unpickler_MemoPut` | library |
| 1.62% | `libc-2.31.so` | `pthread_attr_setschedparam` | libc |
...
| 0.05% | python | long_to_decimal_string_internal |
...
| 0.03% | python | float_div |
| 0.03% | python | _PyAccu_Accumulate |
| 0.03% | python | long_div |
| 0.03% | python | _PyErr_Restore |
| 0.03% | python | anylib_count |
| 0.03% | python | _PyEval_SliceIndex |
| 0.03% | python | _PyType_GetModuleByDef |
| 0.02% | python | PyMember_SetOne |
| 0.02% | python | PyDict_GetItem |
| 0.02% | python | long_mod |
| 0.02% | python | async_gen_anext |
| 0.02% | python | tuplerichcompare |
| 0.02% | python | PyFloat_FromDouble |
| 0.02% | python | enum_next |
| 0.02% | python | list_contains |
| 0.02% | python | PySlice_Unpack |
| 0.02% | python | PyContextVar_Get |
| 0.02% | python | take_gil |
| 0.02% | python | deque_append |
| 0.02% | python | _PyAsyncGenValueWrapperNew |
| 0.02% | python | PyErr_ExceptionMatches |
| 0.02% | python | Py_EnterRecursiveCall |
...
| 0.02% | python | trace_call_function |
| 0.02% | python | map_next |
| 0.02% | python | vgetargskeywordsfast_impl |
| 0.02% | python | PyThreadState_Get |
| 0.01% | python | PyUnicode_FromFormatV |
| 0.01% | python | _PyTuple_FromArray |
| 0.01% | python | method_vectorcall |
| 0.01% | python | PyFunction_NewWithQualName |
| 0.01% | python | PyLong_FromLongLong |
| 0.01% | python | set_table_resize |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 2.15% | python | sre_ucs1_match |
| 1.29% | _pickle.cpython-310-x86_64-linux-gnu.so | save |
| 0.58% | python | sre_ucs2_charset.isra.0 |
| 0.38% | _pickle.cpython-310-x86_64-linux-gnu.so | _Pickler_Write |
| 0.32% | _pickle.cpython-310-x86_64-linux-gnu.so | load |
| 0.31% | _json.cpython-310-x86_64-linux-gnu.so | scanstring_unicode |
| 0.20% | python | sre_search |
| 0.20% | _pickle.cpython-310-x86_64-linux-gnu.so | _Pickler_Write.constprop.3 |
| 0.18% | _pickle.cpython-310-x86_64-linux-gnu.so | PyMemoTable_Set |
| 0.17% | _json.cpython-310-x86_64-linux-gnu.so | scan_once_unicode |
| 0.17% | _pickle.cpython-310-x86_64-linux-gnu.so | Pickler_dealloc |
| 0.15% | python | sre_ucs1_count |
| 0.13% | libpthread-2.31.so | __pthread_mutex_lock |
| 0.13% | libpthread-2.31.so | pthread_mutex_unlock |
| 0.10% | tracer.cpython-310-x86_64-linux-gnu.so | CTracer_trace |
| 0.09% | libm-2.31.so | f64xsubf128 |
| 0.07% | _json.cpython-310-x86_64-linux-gnu.so | py_encode_basestring_ascii |
| 0.07% | _pickle.cpython-310-x86_64-linux-gnu.so | load_counted_binunicode |
| 0.06% | _pickle.cpython-310-x86_64-linux-gnu.so | memo_put |
| 0.06% | _json.cpython-310-x86_64-linux-gnu.so | encoder_listencode_obj |
| 0.06% | _pickle.cpython-310-x86_64-linux-gnu.so | _Pickler_write_bytes |
| 0.05% | _pickle.cpython-310-x86_64-linux-gnu.so | do_append.isra.0 |
| 0.05% | libsqlite3.so.0.8.6 | sqlite3_reset |
| 0.04% | _pickle.cpython-310-x86_64-linux-gnu.so | Pdata_push |
| 0.03% | libm-2.31.so | __fmod_finite |
| 0.03% | libz.so.1.2.11 | inflateCodesUsed |
| 0.03% | pyexpat.cpython-310-x86_64-linux-gnu.so | normal_contentTok |
| 0.03% | array.cpython-310-x86_64-linux-gnu.so | array_subscr |
| 0.03% | _pickle.cpython-310-x86_64-linux-gnu.so | do_setitems.isra.0 |
| 0.03% | pyexpat.cpython-310-x86_64-linux-gnu.so | normal_updatePosition |
| 0.02% | _decimal.cpython-310-x86_64-linux-gnu.so | _mpd_qaddsub |
| 0.02% | _pickle.cpython-310-x86_64-linux-gnu.so | _Unpickler_MemoPut |
| 0.02% | _pickle.cpython-310-x86_64-linux-gnu.so | memo_get |
| 0.02% | _decimal.cpython-310-x86_64-linux-gnu.so | _mpd_check_exp |
| 0.02% | _decimal.cpython-310-x86_64-linux-gnu.so | mpd_setdigits |
| 0.02% | fastbinary.cpython-310-x86_64-linux-gnu.so | apache::thrift::py::ProtocolBase<apache::thrift::py::BinaryProtocol>::encodeValue |
| 0.02% | pyexpat.cpython-310-x86_64-linux-gnu.so | accountingDiffTolerated.part.0 |
| 0.02% | _decimal.cpython-310-x86_64-linux-gnu.so | nm_mpd_qadd |
| 0.02% | _decimal.cpython-310-x86_64-linux-gnu.so | _mpd_qmul |
| 0.02% | libz.so.1.2.11 | inflateBackEnd |
| 0.02% | _pickle.cpython-310-x86_64-linux-gnu.so | marker |
| 0.02% | libz.so.1.2.11 | inflate |
| 0.02% | libsqlite3.so.0.8.6 | sqlite3_randomness |
| 0.02% | pyexpat.cpython-310-x86_64-linux-gnu.so | sip24_update |
| 0.02% | python | pattern_subx |
| 0.01% | pyexpat.cpython-310-x86_64-linux-gnu.so | doContent |
| 0.01% | python | _sre_SRE_Pattern_search |
| 0.01% | _decimal.cpython-310-x86_64-linux-gnu.so | _mpd_baseshiftr |
| 0.01% | _pickle.cpython-310-x86_64-linux-gnu.so | 0x0000000000005d54 |
| 0.01% | pyexpat.cpython-310-x86_64-linux-gnu.so | normal_nameLength |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 3.28% | python | gc_collect_main |
| 1.14% | python | visit_reachable |
| 1.12% | python | visit_decref |
| 0.23% | python | list_traverse |
| 0.17% | python | dict_traverse |
| 0.07% | python | frame_traverse |
| 0.06% | python | subtype_traverse |
| 0.04% | python | _PyObject_GC_New |
| 0.03% | python | PyObject_IS_GC |
| 0.02% | python | _PyDict_MaybeUntrack |
| 0.02% | python | func_traverse |
| 0.02% | python | PyObject_GC_UnTrack |
| 0.01% | python | set_traverse |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 1.71% | python | _PyObject_Malloc |
| 1.61% | python | _PyObject_Free |
| 1.55% | python | frame_dealloc |
| 0.24% | python | list_dealloc |
| 0.13% | python | float_dealloc |
| 0.07% | python | gen_dealloc |
| 0.06% | python | _PyObject_Realloc |
| 0.06% | python | subtype_dealloc |
| 0.03% | python | set_dealloc |
| 0.03% | python | dict_dealloc |
| 0.03% | python | PyMem_Calloc |
| 0.03% | python | slice_dealloc |
| 0.03% | python | _PyObject_Calloc |
| 0.02% | python | unicode_dealloc |
| 0.02% | python | async_gen_asend_dealloc |
| 0.02% | python | PyObject_CallFinalizerFromDealloc |
| 0.01% | python | _Py_Dealloc |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 1.25% | python | _PyObject_GetMethod |
| 0.40% | python | PyObject_GenericGetAttr |
| 0.28% | python | PyObject_RichCompare |
| 0.20% | python | PyNumber_AsSsize_t |
| 0.19% | python | PyObject_Hash |
| 0.18% | python | PyObject_GetItem |
| 0.09% | python | PyObject_GenericSetAttr |
| 0.08% | python | PyNumber_Add |
| 0.08% | python | PyNumber_Multiply |
| 0.07% | python | PyObject_SetAttr |
| 0.04% | python | PyNumber_Subtract |
| 0.04% | python | PyObject_RichCompareBool |
| 0.04% | python | PyObject_GetAttr |
| 0.04% | python | type_getattro |
| 0.02% | python | PyObject_SetItem |
| 0.02% | python | PyObject_IsTrue |
| 0.02% | python | PyNumber_InPlaceSubtract |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 1.38% | libc-2.31.so | __nss_database_lookup |
| 0.20% | libc-2.31.so | pthread_attr_setschedparam |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.28% | [kernel.kallsyms] | copy_user_enhanced_fast_string |
