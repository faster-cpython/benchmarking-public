...
| scimark_sor                | 87.4 ms                                                | 85.4 ms: 1.02x faster                                                  |
...
| bench_mp_pool              | 44.9 ms                                                | 62.1 ms: 1.38x slower                                                  |
| python_startup_no_site     | 9.37 ms                                                | 14.6 ms: 1.56x slower                                                  |
| python_startup             | 11.4 ms                                                | 18.9 ms: 1.66x slower                                                  |
...
Benchmark hidden because not significant (3): pycparser, asyncio_tcp, tornado_http
