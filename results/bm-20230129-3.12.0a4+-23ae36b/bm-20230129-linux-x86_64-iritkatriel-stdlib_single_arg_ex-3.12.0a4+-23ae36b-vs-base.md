...
Benchmark hidden because not significant (7): json_loads, pickle, pickle_dict, pickle_list, pickle_pure_python, xml_etree_parse, xml_etree_generate
...
Benchmark hidden because not significant (29): aiohttp, async_generators, async_tree_none, async_tree_memoization, bench_mp_pool, coverage, crypto_pyaes, deltablue, djangocms, gunicorn, html5lib, json, json_loads, logging_simple, mypy, pickle, pickle_dict, pickle_list, pickle_pure_python, pycparser, regex_effbot, richards, scimark_lu, sqlglot_optimize, sympy_sum, sympy_str, thrift, xml_etree_parse, xml_etree_generate
