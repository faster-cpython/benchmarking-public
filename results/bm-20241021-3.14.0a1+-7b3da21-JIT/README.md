...
- Geometric mean: 1.02x slower (HPT: reliability of 53.38%, 1.00x faster at 99th %ile)
- Memory usage: 1.19x
...
- Geometric mean: 1.09x slower (HPT: reliability of 74.85%, 1.00x slower at 99th %ile)
- Memory usage: 1.10x
- missing benchmarks: aiohttp, asyncio_tcp, asyncio_tcp_ssl, chameleon, dask, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlalchemy_declarative, sqlalchemy_imperative, sqlite_synth, unpack_sequence, unpickle, unpickle_list
- new benchmarks: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, sphinx, thrift
...
- Geometric mean: 1.09x slower (HPT: reliability of 77.31%, 1.00x slower at 99th %ile)
- Memory usage: 1.20x
- missing benchmarks: aiohttp, asyncio_tcp, asyncio_tcp_ssl, chameleon, dask, flaskblogging, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlite_synth, unpack_sequence, unpickle, unpickle_list
- new benchmarks: sphinx
...
- Geometric mean: 1.01x slower (HPT: reliability of 98.96%, 1.00x faster at 99th %ile)
- Memory usage: 1.01x
...
- Geometric mean: 1.04x faster (HPT: reliability of 97.07%, 1.00x faster at 99th %ile)
- Memory usage: unknown
...
- Geometric mean: 1.01x slower (HPT: reliability of 98.48%, 1.00x slower at 99th %ile)
- Memory usage: unknown
...
- Geometric mean: 1.08x faster (HPT: reliability of 95.49%, 1.00x faster at 99th %ile)
- Memory usage: unknown
