...
| html5lib                | 63.2 ms                                                | 59.6 ms: 1.06x faster                                               |
| aiohttp                 | 1.05 ms                                                | 989 us: 1.06x faster                                                |
| float                   | 76.3 ms                                                | 72.3 ms: 1.06x faster                                               |
...
| crypto_pyaes            | 73.9 ms                                                | 76.6 ms: 1.04x slower                                               |
| regex_effbot            | 3.36 ms                                                | 3.48 ms: 1.04x slower                                               |
...
Benchmark hidden because not significant (4): async_tree_none, bench_mp_pool, unpickle_list, deepcopy_reduce
