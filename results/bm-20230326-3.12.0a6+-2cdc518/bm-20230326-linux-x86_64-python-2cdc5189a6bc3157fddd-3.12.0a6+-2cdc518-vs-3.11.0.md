...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230326-linux-x86_64-python-2cdc5189a6bc3157fddd-3.12.0a6+-2cdc518 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| coroutines              | 25.5 ms                                                | 23.9 ms: 1.06x faster                                                  |
...
| create_gc_cycles        | 1.49 ms                                                | 1.46 ms: 1.01x faster                                                  |
...
Benchmark hidden because not significant (9): pycparser, scimark_monte_carlo, genshi_text, djangocms, sympy_sum, async_tree_none, bench_mp_pool, deepcopy_reduce, async_tree_cpu_io_mixed
