...
Benchmark hidden because not significant (4): xml_etree_process, json_loads, xml_etree_generate, pickle_list
...
Benchmark hidden because not significant (33): async_tree_memoization, meteor_contest, deepcopy, mypy, async_tree_io, pyflate, scimark_lu, gunicorn, tornado_http, pylint, pycparser, richards, sqlalchemy_declarative, xml_etree_process, bench_mp_pool, json_loads, deltablue, bench_thread_pool, raytrace, sqlglot_optimize, regex_compile, flaskblogging, sqlglot_parse, django_template, xml_etree_generate, sympy_expand, pathlib, genshi_xml, scimark_sor, pickle_list, sqlglot_transpile, scimark_monte_carlo, html5lib
