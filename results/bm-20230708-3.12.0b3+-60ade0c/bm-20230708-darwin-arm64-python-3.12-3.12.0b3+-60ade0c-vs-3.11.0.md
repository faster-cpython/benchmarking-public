...
| Benchmark      | bm-20221024-darwin-arm64-python-v3.11.0-3.11.0-deaf509 | bm-20230708-darwin-arm64-python-3.12-3.12.0b3+-60ade0c |
|----------------|:------------------------------------------------------:|:------------------------------------------------------:|
...
| Benchmark              | bm-20221024-darwin-arm64-python-v3.11.0-3.11.0-deaf509 | bm-20230708-darwin-arm64-python-3.12-3.12.0b3+-60ade0c |
|------------------------|:------------------------------------------------------:|:------------------------------------------------------:|
| python_startup_no_site | 10.2 ms                                                | 9.60 ms: 1.06x faster                                  |
...
| asyncio_tcp              | 651 ms                                                 | 482 ms: 1.35x faster                                   |
| json_dumps               | 7.63 ms                                                | 6.31 ms: 1.21x faster                                  |
...
| scimark_monte_carlo      | 46.5 ms                                                | 43.2 ms: 1.07x faster                                  |
...
| float                    | 53.0 ms                                                | 57.3 ms: 1.08x slower                                  |
| telco                    | 3.41 ms                                                | 3.70 ms: 1.09x slower                                  |
| json_loads               | 16.1 us                                                | 17.6 us: 1.09x slower                                  |
| sqlglot_optimize         | 31.1 ms                                                | 34.3 ms: 1.10x slower                                  |
| xml_etree_process        | 35.1 ms                                                | 39.1 ms: 1.11x slower                                  |
| xml_etree_generate       | 48.3 ms                                                | 56.3 ms: 1.17x slower                                  |
| unpickle_list            | 2.65 us                                                | 3.19 us: 1.21x slower                                  |
| pathlib                  | 27.2 ms                                                | 33.5 ms: 1.23x slower                                  |
...
Benchmark hidden because not significant (2): tornado_http, crypto_pyaes
...
Ignored benchmarks (1) of results/bm-20230708-3.12.0b3+-60ade0c/bm-20230708-darwin-arm64-python-3.12-3.12.0b3+-60ade0c.json: dask


# HPT report

- Reliability score: 69.91% likely to be faster
