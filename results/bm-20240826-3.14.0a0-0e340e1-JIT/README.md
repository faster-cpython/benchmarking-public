...
- version: 3.14.0a0
- config: JIT
- commit hash: [0e340e1](https://github.com/brandtbucher/cpython/commit/0e340e1)
...
- [pystats raw](bm-20240826-azure-x86_64-brandtbucher-underflow-3.14.0a0-0e340e1-pystats.json)
- [pystats table](bm-20240826-azure-x86_64-brandtbucher-underflow-3.14.0a0-0e340e1-pystats.md)

### vs. base

- [pystats diff](bm-20240826-azure-x86_64-brandtbucher-underflow-3.14.0a0-0e340e1-pystats-vs-base.md)

## linux x86_64 (linux)

- [GitHub Action run](https://github.com/faster-cpython/benchmarking/actions/runs/10581492100)
- cpu model: Intel(R) Xeon(R) W-2255 CPU @ 3.70GHz
- platform: Linux-5.4.0-192-generic-x86_64-with-glibc2.31
- [raw results](bm-20240826-linux-x86_64-brandtbucher-underflow-3.14.0a0-0e340e1.json)
...
- [📄table](bm-20240826-linux-x86_64-brandtbucher-underflow-3.14.0a0-0e340e1-vs-3.10.4.md)
- [📈time plot](bm-20240826-linux-x86_64-brandtbucher-underflow-3.14.0a0-0e340e1-vs-3.10.4.svg)
