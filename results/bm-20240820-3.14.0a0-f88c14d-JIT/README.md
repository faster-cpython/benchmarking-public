...
- Geometric mean: 1.01x faster (HPT: reliability of 67.35%, 1.00x faster at 99th %ile)
- Memory usage: 1.09x
...
- [📄table](bm-20240820-linux-x86_64-python-f88c14d412522587085a-3.14.0a0-f88c14d-vs-3.13.0.md)
- [📈time plot](bm-20240820-linux-x86_64-python-f88c14d412522587085a-3.14.0a0-f88c14d-vs-3.13.0.svg)
