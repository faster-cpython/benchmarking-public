...
| Benchmark      | bm-20220323-linux-x86_64-python-v3.10.4-3.10.4-9d38120 | bm-20230711-linux-x86_64-python-af5cf1e75136fcef967d-3.13.0a0-af5cf1e |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| docutils       | 3.17 sec                                               | 2.66 sec: 1.19x faster                                                |
| tornado_http   | 127 ms                                                 | 95.8 ms: 1.33x faster                                                 |
...
| pickle_list          | 4.56 us                                                | 4.40 us: 1.03x faster                                                 |
...
| unpickle_list            | 4.82 us                                                | 5.17 us: 1.07x slower                                                 |
| telco                    | 6.54 ms                                                | 7.40 ms: 1.13x slower                                                 |
| python_startup_no_site   | 5.82 ms                                                | 6.68 ms: 1.15x slower                                                 |
| pickle_dict              | 27.3 us                                                | 31.4 us: 1.15x slower                                                 |
| regex_effbot             | 3.23 ms                                                | 3.76 ms: 1.17x slower                                                 |
