...
| Benchmark      | bm-20240605-linux-x86_64-python-v3.13.0b2-3.13.0b2-3a83b17 | bm-20240702-linux-x86_64-brandtbucher-underflow-3.14.0a0-2cefb49 |
|----------------|:----------------------------------------------------------:|:----------------------------------------------------------------:|
...
| genshi_xml                 | 51.6 ms                                                    | 61.8 ms: 1.20x slower                                            |
| deltablue                  | 3.25 ms                                                    | 4.19 ms: 1.29x slower                                            |
| Geometric mean             | (ref)                                                      | 1.03x faster                                                     |

Benchmark hidden because not significant (4): dask, raytrace, coverage, coroutines
