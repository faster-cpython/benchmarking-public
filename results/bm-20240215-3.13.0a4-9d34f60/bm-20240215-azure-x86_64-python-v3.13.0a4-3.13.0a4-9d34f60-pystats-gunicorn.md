...
| POP_JUMP_IF_NOT_NONE | 1,157,940 | 0.5% | 83.6% |  |
...
| RESUME_CHECK LOAD_FAST | 5,302,470 | 2.4% | 8.1% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 4,280,280 | 1.9% | 10.0% |
| POP_JUMP_IF_FALSE LOAD_FAST | 4,209,425 | 1.9% | 11.9% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 3,879,200 | 1.7% | 13.6% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 3,575,560 | 1.6% | 15.2% |
| LOAD_FAST LOAD_CONST | 3,513,940 | 1.6% | 16.8% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 3,213,510 | 1.4% | 18.3% |
| CACHE RESUME_CHECK | 2,521,510 | 1.1% | 19.4% |
| LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 2,267,800 | 1.0% | 20.4% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 2,257,400 | 1.0% | 21.4% |
| LOAD_FAST LOAD_ATTR | 2,110,090 | 0.9% | 22.4% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 1,597,145 | 0.7% | 28.7% |
| RETURN_CONST POP_TOP | 1,587,560 | 0.7% | 29.4% |
| POP_TOP LOAD_FAST | 1,484,930 | 0.7% | 30.1% |
| LOAD_CONST LOAD_CONST | 1,475,600 | 0.7% | 30.7% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 1,472,000 | 0.7% | 31.4% |
| RETURN_VALUE INTERPRETER_EXIT | 1,465,690 | 0.7% | 32.1% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 1,432,920 | 0.6% | 32.7% |
...
| LOAD_FAST TO_BOOL_BOOL | 1,104,620 | 0.5% | 39.4% |
...
| LOAD_FAST_LOAD_FAST LOAD_FAST | 778,560 | 0.4% | 50.9% |
...
| NOP LOAD_FAST | 686,345 | 0.3% | 52.5% |
...
| CALL RETURN_VALUE | 543,225 | 0.2% | 57.1% |
...
| POP_JUMP_IF_FALSE | 143,445 | 11.0% |
| POP_JUMP_IF_TRUE | 133,120 | 10.2% |
| POP_TOP | 92,380 | 7.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 686,345 | 52.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 1,484,930 | 27.5% |
| JUMP_BACKWARD | 1,024,120 | 19.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| INTERPRETER_EXIT | 1,465,690 | 24.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 423,960 | 56.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_TOP | 1,024,120 | 31.8% |
| POP_JUMP_IF_TRUE | 952,800 | 29.6% |
...
| RESUME_CHECK | 5,302,470 | 12.5% |
| POP_JUMP_IF_FALSE | 4,209,425 | 9.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 3,213,510 | 68.7% |
| POP_JUMP_IF_TRUE | 1,432,920 | 30.6% |
...
|---|---:|---:|
| Basic | 115,693,790 | 52.0% |
| Not specialized | 26,202,405 | 11.8% |
| Specialized hits | 79,660,925 | 35.8% |
| Specialized misses | 735,730 | 0.3% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| CALL_METHOD_DESCRIPTOR_NOARGS | 109,710 | 14.9% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 2,923,370 | 27.5% |
| Calls to Python functions inlined | 7,720,140 | 72.5% |
| Calls via PyEval_EvalFrame (total) | 2,923,370 | 27.5% |
| Calls via PyEval_EvalFrame (vector) | 2,543,410 | 23.9% |
| Calls via PyEval_EvalFrame (generator) | 379,960 | 3.6% |
| Calls via PyEval_EvalFrame (legacy) | 20 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 2,543,330 | 23.9% |
...
| Calls via PyEval_EvalFrame (method) | 71,610 | 0.7% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 8,848,225 | 37.3% |
| Frees to freelist | 8,850,545 |  |
| Allocations | 14,897,870 | 62.7% |
| Allocations to 512 bytes | 14,805,410 | 62.3% |
| Allocations to 4 kbytes | 82,180 | 0.3% |
| Allocations over 4 kbytes | 10,280 | 0.0% |
| Frees | 15,680,411 |  |
| New values | 379,260 |  |
| Interpreter increfs | 97,296,695 | 74.0% |
| Interpreter decrefs | 112,313,370 | 73.7% |
| Increfs | 34,224,667 | 26.0% |
| Decrefs | 40,169,886 | 26.3% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.0% |
| Method cache hits | 5,020,002 |  |
| Method cache misses | 160,693 |  |
| Method cache collisions | 238,161 |  |
| Method cache dunder hits | 3,993,232 |  |
| Method cache dunder misses | 83,168 |  |
