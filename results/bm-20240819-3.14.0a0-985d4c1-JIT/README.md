...
- Geometric mean: 1.01x faster (HPT: reliability of 65.19%, 1.00x slower at 99th %ile)
- Memory usage: 1.07x
...
- [📄table](bm-20240819-linux-x86_64-savannahostrowski-jit_mem_gc_increment-3.14.0a0-985d4c1-vs-3.13.0.md)
- [📈time plot](bm-20240819-linux-x86_64-savannahostrowski-jit_mem_gc_increment-3.14.0a0-985d4c1-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x slower (HPT: reliability of 82.16%, 1.00x slower at 99th %ile)
- Memory usage: 0.98x
