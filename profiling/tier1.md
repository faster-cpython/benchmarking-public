...
| 0.69% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
...
| 0.48% | `python` | `find_name_in_mro` | lookup |
| 0.47% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 0.47% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| 0.42% | `python` | `PyObject_GenericGetAttr` | dynamic |
...
| 0.30% | `python` | `tok_get_normal_mode` | compiler |
...
| 0.28% | `python` | `sre_ucs2_charset.isra.0` | library |
...
| 1.32% | `python` | `_PyType_LookupRef` | lookup |
...
| 0.47% | `libc-2.31.so` | `__gconv_transform_utf8_internal` | libc |
...
| 0.28% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 28.17% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 24.11% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.21% | `python` | `_PyObject_Malloc` | memory |
| 4.10% | `python` | `_PyObject_Free` | memory |
| 3.75% | `python` | `async_gen_asend_iternext` | async |
| 3.06% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 3.04% | `python` | `PyType_GenericAlloc` | memory |
| 2.79% | `python` | `tuple_dealloc` | memory |
| 2.06% | `python` | `PyErr_ExceptionMatches` | exceptions |
| 2.03% | `python` | `async_gen_anext` | async |
| 1.98% | `python` | `PyObject_CallOneArg` | dynamic |
| 1.82% | `python` | `_PyObject_MakeTpCall` | dynamic |
| 1.75% | `python` | `_PyErr_ExceptionMatches` | exceptions |
...
| 1.24% | `python` | `StopIteration_dealloc` | memory |
| 1.23% | `python` | `PyObject_GC_Del` | gc |
| 1.13% | `python` | `_Py_NewReference` | memory |
| 1.13% | `python` | `type_call` | dynamic |
| 1.01% | `python` | `PyObject_CallFinalizerFromDealloc` | memory |
...
| 0.76% | `python` | `visit_add_to_container` | gc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 29.35% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 2.34% | `python` | `gc_collect_region.isra.0` | gc |
...
| 0.38% | `[kernel.kallsyms]` | `rmqueue` | kernel |
| 0.37% | `python` | `insertdict` | dict |
...
| 0.31% | `_asyncio.cpython-314-x86_64-linux-gnu.so` | `TaskObj_clear` | library |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 21.10% | `python` | `k_mul` | int |
| 19.37% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.35% | `python` | `_PyObject_Malloc` | memory |
| 3.64% | `python` | `_PyObject_Free` | memory |
| 3.20% | `python` | `visit_add_to_container` | gc |
| 2.04% | `python` | `_PyGC_Collect` | gc |
| 1.83% | `python` | `PyErr_CheckSignals` | exceptions |
...
| 1.04% | `python` | `_PyLong_New` | memory |
...
| 0.84% | `python` | `PyThread_get_thread_ident` | unknown |
| 0.79% | `python` | `_PyType_LookupRef` | lookup |
| 0.74% | `python` | `context_tp_dealloc` | memory |
...
| 0.41% | `python` | `PyLong_FromUnsignedLong` | int |
...
| 2.08% | `python` | `_PyGC_Collect` | gc |
| 1.90% | `python` | `PyErr_CheckSignals` | exceptions |
| 1.54% | `python` | `gc_collect_region.isra.0` | gc |
| 1.37% | `math.cpython-314-x86_64-linux-gnu.so` | `factorial_partial_product` | library |
| 1.19% | `python` | `visit_decref` | gc |
| 1.18% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.13% | `python` | `_PyLong_New` | memory |
...
| 0.89% | `python` | `PyThread_get_thread_ident` | unknown |
...
| 0.49% | `python` | `long_lshift_int64` | int |
| 0.49% | `python` | `subtype_dealloc` | memory |
| 0.44% | `python` | `PyLong_FromUnsignedLong` | int |
| 0.41% | `python` | `PyObject_GenericGetAttr` | dynamic |
...
| 8.25% | `python` | `visit_add_to_container` | gc |
...
| 1.48% | `python` | `_PyEval_Vector` | interpreter |
...
| 0.58% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| 0.39% | `python` | `_PyThreadState_PushFrame` | interpreter |
...
| 0.37% | `[kernel.kallsyms]` | `rmqueue` | kernel |
...
| 0.53% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| 0.47% | `python` | `_PyThreadState_PopFrame` | interpreter |
| 0.47% | `[kernel.kallsyms]` | `rmqueue` | kernel |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 30.21% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.57% | `python` | `visit_add_to_container` | gc |
| 3.47% | `python` | `_PyObject_Malloc` | memory |
| 3.28% | `python` | `_PyGC_Collect` | gc |
| 2.69% | `python` | `gc_collect_region.isra.0` | gc |
...
| 0.27% | `python` | `_Py_NewReference` | memory |
| 0.27% | `python` | `_PyType_LookupRefAndVersion` | unknown |

## async_tree_memoization_tg

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 29.24% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 6.68% | `python` | `visit_add_to_container` | gc |
| 3.66% | `python` | `_PyObject_Malloc` | memory |
| 3.48% | `python` | `_PyGC_Collect` | gc |
...
| 0.42% | `python` | `_PyThreadState_PopFrame` | interpreter |
...
| 0.25% | `_asyncio.cpython-314-x86_64-linux-gnu.so` | `TaskStepMethWrapper_call` | library |
| 0.25% | `python` | `PyObject_VisitManagedDict` | dynamic |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 26.57% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 8.36% | `python` | `visit_add_to_container` | gc |
| 3.94% | `python` | `_PyObject_Malloc` | memory |
| 3.11% | `python` | `_PyGC_Collect` | gc |
| 2.62% | `python` | `_PyObject_Free` | memory |
| 2.26% | `python` | `gc_collect_region.isra.0` | gc |
...
| 0.50% | `[kernel.kallsyms]` | `rmqueue` | kernel |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 65.47% | `libz.so.1.2.11` | `crc32_combine64` | library |
| 20.75% | `libz.so.1.2.11` | `inflateBackEnd` | library |
| 2.64% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
...
| 5.31% | `python` | `_Py_dict_lookup` | lookup |
| 5.00% | `python` | `tuple_dealloc` | memory |
...
| 1.96% | `python` | `PyTuple_New` | memory |
| 1.92% | `python` | `listiter_next` | list |
| 1.84% | `python` | `PyObject_GC_UnTrack` | gc |
| 1.74% | `python` | `PyObject_RichCompareBool` | dynamic |
| 1.70% | `python` | `PyList_New` | memory |
| 1.55% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 1.50% | `python` | `zip_next` | unknown |
| 1.26% | `python` | `PySlice_AdjustIndices` | miscobj |
| 1.21% | `python` | `_Py_Dealloc` | memory |
| 1.09% | `python` | `tuple_richcompare` | tuple |
| 1.09% | `python` | `_PyGC_Collect` | gc |
| 1.06% | `python` | `tuple_hash` | tuple |
| 1.02% | `python` | `_PyObject_MakeTpCall` | dynamic |
| 0.89% | `python` | `list_slice_lock_held.isra.0` | list |
| 0.85% | `python` | `list_subscript` | list |
...
| 0.82% | `python` | `_PyLong_Subtract` | int |
| 0.79% | `python` | `list_traverse` | gc |
| 0.78% | `python` | `insertdict` | dict |
| 0.76% | `python` | `gc_collect_region.isra.0` | gc |
| 0.76% | `python` | `slot_mp_subscript` | unknown |
| 0.72% | `python` | `PyObject_GC_Del` | gc |
| 0.71% | `python` | `_PyTuple_FromStackRefSteal` | tuple |
...
| 0.57% | `python` | `zip_new` | memory |
| 0.52% | `python` | `dict_subscript` | dict |
| 0.52% | `python` | `visit_reachable` | gc |
| 0.48% | `python` | `visit_decref` | gc |
| 0.48% | `python` | `method_vectorcall_O` | calls |
| 0.47% | `python` | `_PyObject_GC_Link` | gc |
| 0.46% | `python` | `PySlice_Unpack` | miscobj |
| 0.46% | `python` | `slot_mp_ass_subscript` | unknown |
| 0.44% | `python` | `wrap_objobjargproc` | unknown |
...
| 0.37% | `python` | `PyArg_UnpackTuple` | calls |
| 0.36% | `python` | `dict_ass_sub` | dict |
| 0.36% | `python` | `_PyObject_Realloc` | memory |
| 0.36% | `python` | `dictiter_iternextkey` | dict |
...
| 1.09% | `python` | `PyLong_AsDouble` | int |
| 1.09% | `python` | `float_div` | float |
...
| 0.86% | `python` | `range_iter` | miscobj |
...
| 0.62% | `python` | `PyNumber_TrueDivide` | dynamic |
| 0.60% | `python` | `PyNumber_Subtract` | dynamic |
| 0.59% | `python` | `float_pow` | float |
...
| 0.40% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.40% | `python` | `PyObject_GC_Del` | gc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 38.20% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 7.12% | `python` | `_Py_dict_lookup` | lookup |
| 4.38% | `python` | `_PyObject_Malloc` | memory |
| 3.56% | `python` | `_PyObject_Free` | memory |
| 2.26% | `python` | `dict_get` | dict |
...
| 1.47% | `python` | `_PyObject_Realloc` | memory |
...
| 0.89% | `python` | `PyObject_Hash` | dynamic |
| 0.88% | `python` | `PyObject_GC_Del` | gc |
| 0.86% | `python` | `long_hash` | int |
| 0.86% | `python` | `unsafe_tuple_compare` | unknown |
| 0.86% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.85% | `python` | `tuple_dealloc` | memory |
| 0.84% | `python` | `_PyObject_GC_New` | gc |
| 0.75% | `python` | `_PyList_AppendTakeRefListResize` | list |
...
| 0.45% | `python` | `listiter_dealloc` | memory |
| 0.44% | `python` | `builtin_any` | unknown |
...
| 1.20% | `python` | `r_object` | import |
| 0.98% | `python` | `update_one_slot` | lookup |
| 0.97% | `python` | `find_name_in_mro` | lookup |
| 0.95% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 0.95% | `python` | `build_string` | unknown |
| 0.92% | `python` | `visit_add_to_container` | gc |
| 0.91% | `[kernel.kallsyms]` | `memset_erms` | kernel |
| 0.89% | `python` | `gc_collect_region.isra.0` | gc |
| 0.84% | `python` | `_PyCode_Quicken` | interpreter |
| 0.84% | `python` | `tuple_dealloc` | memory |
| 0.79% | `python` | `_Py_hashtable_get_entry_generic` | lookup |
| 0.78% | `python` | `visit_decref` | gc |
| 0.76% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.70% | `python` | `siphash13` | str |
| 0.67% | `python` | `_PyUnicode_FromUCS1.part.0` | str |
| 0.64% | `[kernel.kallsyms]` | `copy_page` | kernel |
| 0.63% | `[kernel.kallsyms]` | `psi_task_change` | kernel |
| 0.61% | `python` | `_PyType_LookupRef` | lookup |
| 0.59% | `python` | `_PyGC_Collect` | gc |
| 0.56% | `python` | `visit_reachable` | gc |
| 0.53% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.52% | `python` | `type_ready` | dynamic |
| 0.52% | `python` | `initialize_locals` | interpreter |
| 0.51% | `python` | `_PyDict_GetItemRef_KnownHash` | dict |
| 0.50% | `[kernel.kallsyms]` | `update_cfs_group` | kernel |
| 0.49% | `python` | `PyDict_GetItemRef` | dict |
| 0.48% | `python` | `intern_constants` | str |
| 0.45% | `[kernel.kallsyms]` | `update_load_avg` | kernel |
| 0.44% | `python` | `_Py_Dealloc` | memory |
| 0.38% | `[kernel.kallsyms]` | `__d_lookup_rcu` | kernel |
| 0.38% | `[kernel.kallsyms]` | `clear_bhb_loop` | kernel |
| 0.37% | `[kernel.kallsyms]` | `_raw_spin_lock` | kernel |
| 0.37% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.37% | `libc-2.31.so` | `_int_malloc` | libc |
| 0.37% | `[kernel.kallsyms]` | `copy_user_enhanced_fast_string` | kernel |
...
| 0.34% | `python` | `PyObject_GC_UnTrack` | gc |
| 0.34% | `libc-2.31.so` | `__strlen_avx2` | libc |
| 0.32% | `[kernel.kallsyms]` | `rmqueue` | kernel |
| 0.32% | `python` | `ThreadHandle_join` | unknown |
| 0.32% | `[kernel.kallsyms]` | `clear_page_erms` | kernel |
| 0.31% | `python` | `convertitem.constprop.0` | library |
| 0.31% | `python` | `list_dealloc` | memory |
| 0.30% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 0.29% | `libpthread-2.31.so` | `__pthread_mutex_lock` | library |
| 0.29% | `python` | `PyObject_Vectorcall` | dynamic |
| 0.28% | `python` | `insertdict` | dict |
| 0.28% | `python` | `vgetargs1_impl` | calls |
| 0.27% | `libpthread-2.31.so` | `pthread_mutex_unlock` | library |
| 0.27% | `python` | `PyObject_IS_GC` | gc |
| 0.26% | `[kernel.kallsyms]` | `free_pcppages_bulk` | kernel |
| 0.26% | `python` | `dict_setdefault_ref_lock_held` | dict |
| 0.26% | `python` | `_PyCode_New` | interpreter |
| 0.26% | `python` | `build_indices_unicode` | dict |
...
| 0.97% | `python` | `_Py_MakeCoro` | unknown |
| 0.84% | `python` | `_Py_dict_lookup` | lookup |
| 0.83% | `python` | `_PyCoro_GetAwaitableIter` | unknown |
| 0.79% | `python` | `_PyThreadState_PopFrame` | interpreter |
| 0.59% | `python` | `visit_decref` | gc |
| 0.49% | `python` | `r_object` | import |
| 0.44% | `python` | `_Py_NewReference` | memory |
| 0.43% | `python` | `_PyGen_Finalize` | miscobj |
...
| 6.59% | `tracer.cpython-314-x86_64-linux-gnu.so` | `CTracer_trace` | library |
| 6.10% | `python` | `call_instrumentation_vector.part.0` | interpreter |
| 5.51% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 3.95% | `python` | `_Py_dict_lookup` | lookup |
| 3.65% | `python` | `_Py_call_instrumentation_line` | interpreter |
| 3.23% | `python` | `_PyObject_Free` | memory |
| 3.13% | `python` | `_PyObject_Malloc` | memory |
| 2.68% | `python` | `siphash13` | str |
| 1.52% | `python` | `set_add_entry` | miscobj |
| 1.52% | `python` | `PyDict_GetItem` | dict |
| 1.17% | `python` | `_PyType_LookupRef` | lookup |
...
| 0.62% | `python` | `find_first_nonascii` | unknown |
| 0.61% | `python` | `sys_trace_start` | library |
| 0.61% | `python` | `_Py_Dealloc` | memory |
| 0.59% | `python` | `sys_trace_return` | library |
| 0.59% | `python` | `visit_reachable` | gc |
| 0.57% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.56% | `python` | `_PyDict_LoadGlobalStackRef` | dict |
| 0.53% | `python` | `r_object` | import |
| 0.52% | `python` | `PyEval_GetFrame` | interpreter |
| 0.49% | `python` | `_PyCode_GetCode` | interpreter |
| 0.45% | `python` | `long_hash` | int |
| 0.45% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
| 0.44% | `python` | `_Py_call_instrumentation_arg` | unknown |
| 0.43% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 0.43% | `tracer.cpython-314-x86_64-linux-gnu.so` | `CTracer_set_pdata_stack` | library |
| 0.43% | `python` | `_PyGC_Collect` | gc |
| 0.42% | `python` | `unicode_dealloc` | memory |
| 0.42% | `libc-2.31.so` | `__strlen_avx2` | libc |
| 0.41% | `python` | `PyObject_Hash` | dynamic |
| 0.40% | `python` | `PyFrame_GetCode` | exceptions |
| 0.39% | `python` | `_PyLong_Subtract` | int |
| 0.38% | `python` | `PyObject_SetAttr` | dynamic |
| 0.38% | `python` | `PyObject_SetAttrString` | dynamic |
| 0.37% | `python` | `update_one_slot` | lookup |
| 0.36% | `python` | `find_name_in_mro` | lookup |
| 0.36% | `python` | `_PyLong_Add` | int |
| 0.36% | `python` | `PyFrame_GetLineNumber` | exceptions |
| 0.36% | `python` | `_Py_CheckFunctionResult` | calls |
| 0.35% | `python` | `_Py_call_instrumentation` | unknown |
| 0.35% | `python` | `tuple_dealloc` | memory |
| 0.33% | `python` | `PyUnicode_InternFromString` | str |
...
| 6.11% | `python` | `long_bitwise` | int |
| 5.36% | `python` | `_PyObject_Malloc` | memory |
| 3.45% | `python` | `_PyLong_Rshift` | int |
| 3.02% | `python` | `l_mod` | int |
| 2.92% | `python` | `_PyLong_New` | memory |
| 2.08% | `python` | `long_and` | int |
| 1.87% | `python` | `long_dealloc` | memory |
| 1.50% | `python` | `PyNumber_And` | dynamic |
| 1.25% | `python` | `long_rshift` | int |
| 1.19% | `python` | `maybe_small_long` | unknown |
| 1.10% | `python` | `PyNumber_Xor` | dynamic |
| 1.10% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.06% | `python` | `_PyLong_Add` | int |
| 1.01% | `python` | `PyLong_FromLong` | int |
| 0.89% | `python` | `_PyLong_FromMedium` | int |
| 0.85% | `python` | `long_xor` | int |
| 0.83% | `python` | `PyNumber_Remainder` | dynamic |
| 0.71% | `python` | `gc_collect_region.isra.0` | gc |
| 0.68% | `python` | `_Py_NewReference` | memory |
| 0.67% | `python` | `PyNumber_Rshift` | dynamic |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 37.29% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.35% | `python` | `_Py_dict_lookup` | lookup |
| 3.99% | `python` | `initialize_locals` | interpreter |
| 3.94% | `python` | `_PyObject_Malloc` | memory |
| 3.56% | `python` | `_PyObject_Free` | memory |
| 2.80% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.84% | `python` | `_PyEvalFramePushAndInit` | interpreter |
...
| 0.67% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
...
| 0.59% | `python` | `_PyObject_Realloc` | memory |
| 0.59% | `python` | `long_richcompare` | int |
| 0.59% | `python` | `_PyThreadState_PushFrame` | interpreter |
| 0.58% | `python` | `_PyLong_New` | memory |
| 0.56% | `python` | `gc_collect_region.isra.0` | gc |
...
| 0.44% | `python` | `PyLong_FromVoidPtr` | int |
| 0.40% | `python` | `_PyThreadState_PopFrame` | interpreter |
...
| 0.31% | `python` | `PyList_New` | memory |
| 0.31% | `python` | `dict_merge` | dict |
| 0.30% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.30% | `python` | `r_object` | import |
| 0.29% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.28% | `python` | `PyType_GenericAlloc` | memory |
| 0.28% | `python` | `new_dict.isra.0` | unknown |
| 0.27% | `python` | `PyObject_GenericGetAttr` | dynamic |

## deltablue

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 54.89% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.73% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 2.38% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 32.64% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 0.59% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| 0.47% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
...
| 0.35% | `libz.so.1.2.11` | `inflateBackEnd` | library |
| 0.34% | `python` | `_PyObject_GC_Link` | gc |
| 0.34% | `python` | `visit_add_to_container` | gc |
| 0.34% | `python` | `_PyCode_Quicken` | interpreter |
...
| 0.30% | `python` | `unicode_replace` | str |
| 0.30% | `python` | `dict_traverse` | gc |
| 0.30% | `python` | `_Py_NewReference` | memory |
| 0.29% | `python` | `_PyUnicode_FromUCS1.part.0` | str |
| 0.29% | `python` | `PyObject_Vectorcall` | dynamic |
| 0.29% | `python` | `PyList_New` | memory |
| 0.27% | `python` | `new_dict.isra.0` | unknown |
...
| 0.35% | `libc-2.31.so` | `_int_malloc` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 29.10% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 1.59% | `libz.so.1.2.11` | `inflate` | library |
| 1.41% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.21% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 0.93% | `python` | `_Py_dict_lookup` | lookup |
| 0.91% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.79% | `python` | `gc_collect_region.isra.0` | gc |
| 0.78% | `python` | `tuple_dealloc` | memory |
| 0.62% | `[kernel.kallsyms]` | `copy_user_enhanced_fast_string` | kernel |
...
| 0.48% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.48% | `python` | `_PyType_LookupRef` | lookup |
| 0.47% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
...
| 0.37% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.34% | `python` | `PyLong_FromString` | int |
| 0.34% | `python` | `PyType_GenericAlloc` | memory |
| 0.33% | `python` | `find_name_in_mro` | lookup |
| 0.30% | `python` | `_PyLong_FromMedium` | int |
| 0.29% | `libpthread-2.31.so` | `__pthread_mutex_lock` | library |
| 0.29% | `[kernel.kallsyms]` | `link_path_walk.part.0` | kernel |
| 0.28% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
| 0.28% | `python` | `update_one_slot` | lookup |
| 0.28% | `python` | `PyObject_RichCompare` | dynamic |
| 0.28% | `libz.so.1.2.11` | `adler32_z` | library |
| 0.27% | `python` | `_PyGC_Collect` | gc |
...
| 9.41% | `python` | `PySlice_AdjustIndices` | miscobj |
| 5.29% | `python` | `list_ass_slice_lock_held` | list |
| 5.19% | `python` | `list_subscript` | list |
| 4.28% | `python` | `_PyObject_Free` | memory |
| 3.71% | `python` | `_PyObject_Malloc` | memory |
| 3.06% | `python` | `_PyEval_SliceIndex` | interpreter |
| 2.78% | `python` | `list_dealloc` | memory |
| 2.31% | `python` | `PyNumber_AsSsize_t` | dynamic |
| 2.25% | `python` | `list_ass_subscript` | list |
| 2.24% | `python` | `slice_dealloc` | memory |
| 2.21% | `python` | `PySlice_New` | memory |
| 2.11% | `python` | `_PyBuildSlice_ConsumeRefs` | miscobj |
| 2.04% | `python` | `_PyLong_Add` | int |
| 2.02% | `python` | `PySlice_Unpack` | miscobj |
| 1.97% | `python` | `PyList_New` | memory |
| 1.96% | `python` | `PyObject_GC_UnTrack` | gc |
| 1.52% | `python` | `PyLong_AsSsize_t` | int |
| 1.26% | `python` | `list_insert` | list |
| 1.00% | `python` | `PyObject_GetItem` | dynamic |
| 0.88% | `python` | `PySequence_Fast` | dynamic |
...
| 0.52% | `python` | `list_pop` | list |
| 0.38% | `python` | `list_slice_lock_held.isra.0` | list |
| 0.35% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 0.27% | `python` | `_PyNumber_Index` | dynamic |

## float

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 39.05% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.57% | `python` | `_PyObject_Malloc` | memory |
| 2.52% | `libm-2.31.so` | `__sin_fma` | library |
| 2.35% | `libm-2.31.so` | `__cos_fma` | library |
| 2.12% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
| 2.04% | `python` | `_PyObject_Free` | memory |
| 2.02% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.93% | `python` | `float_div` | float |
| 1.76% | `python` | `float_dealloc` | memory |
| 1.74% | `python` | `subtype_traverse` | gc |
| 1.56% | `python` | `visit_add_to_container` | gc |
...
| 1.15% | `python` | `PyFloat_FromDouble` | float |
...
| 0.68% | `python` | `PyNumber_InPlaceTrueDivide` | dynamic |
| 0.68% | `python` | `_PyEvalFramePushAndInit` | interpreter |
| 0.62% | `python` | `PyFloat_AsDouble.part.0` | float |
| 0.59% | `python` | `long_float` | int |
| 0.52% | `python` | `_Py_dict_lookup` | lookup |
| 0.51% | `python` | `list_dealloc` | memory |
| 0.51% | `python` | `float_mul` | float |
| 0.48% | `python` | `_PyThreadState_PopFrame` | interpreter |
| 0.42% | `math.cpython-314-x86_64-linux-gnu.so` | `math_sqrt` | library |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 23.29% | `python` | `gc_collect_region.isra.0` | gc |
| 15.75% | `python` | `visit_reachable` | gc |
| 15.10% | `python` | `visit_decref` | gc |
| 8.15% | `python` | `visit_add_to_container` | gc |
| 7.04% | `python` | `_PyGC_Collect` | gc |
| 6.02% | `python` | `dict_traverse` | gc |
| 3.85% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 2.22% | `python` | `func_traverse` | gc |
| 1.37% | `python` | `type_is_gc` | gc |
| 1.33% | `python` | `set_traverse` | gc |
| 1.18% | `python` | `subtype_traverse` | gc |
| 1.13% | `python` | `PyObject_VisitManagedDict` | dynamic |
| 1.01% | `python` | `tuple_traverse` | gc |
| 0.79% | `python` | `type_traverse` | gc |
| 0.72% | `python` | `PyObject_IS_GC` | gc |
| 0.68% | `python` | `list_traverse` | gc |
| 0.64% | `python` | `_PyObject_Malloc` | memory |
| 0.42% | `python` | `meth_traverse` | gc |
...
| 0.29% | `python` | `_PyTuple_MaybeUntrack` | gc |
...
| 21.45% | `python` | `visit_decref` | gc |
| 13.78% | `python` | `list_traverse` | gc |
| 11.52% | `python` | `gc_collect_region.isra.0` | gc |
| 5.30% | `python` | `_PyGC_Collect` | gc |
| 3.12% | `python` | `dict_traverse` | gc |
| 2.90% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 1.03% | `python` | `func_traverse` | gc |
| 0.66% | `python` | `set_traverse` | gc |
| 0.65% | `python` | `type_is_gc` | gc |
...
| 0.38% | `python` | `_PyThreadState_PopFrame` | interpreter |
| 0.38% | `python` | `PyType_GenericAlloc` | memory |
| 0.37% | `python` | `_PyThreadState_PushFrame` | interpreter |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 43.27% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 1.01% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.95% | `python` | `dict_dealloc` | memory |
| 0.85% | `python` | `insert_to_emptydict` | dict |
| 0.79% | `python` | `_PyDict_FromItems` | dict |
...
| 0.52% | `python` | `long_to_decimal_string_internal` | int |
| 0.49% | `python` | `method_dealloc` | memory |
| 0.48% | `python` | `pattern_subx` | library |
...
| 0.31% | `python` | `new_dict.isra.0` | unknown |
| 0.30% | `python` | `r_object` | import |
| 0.30% | `python` | `PyObject_GetAttr` | dynamic |
| 0.29% | `python` | `_PyGC_Collect` | gc |
| 0.29% | `python` | `dictiter_iternextvalue` | dict |
| 0.28% | `libc-2.31.so` | `_int_malloc` | libc |
| 0.28% | `python` | `list_dealloc` | memory |
| 0.27% | `python` | `PyEval_EvalCode` | interpreter |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 60.91% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 1.03% | `python` | `long_bitwise` | int |
| 0.91% | `python` | `_Py_dict_lookup` | lookup |
| 0.84% | `python` | `gc_collect_region.isra.0` | gc |
| 0.64% | `python` | `_PyThreadState_PopFrame` | interpreter |
...
| 0.45% | `python` | `_PyLong_Subtract` | int |
...
| 0.25% | `python` | `PyNumber_InPlaceXor` | dynamic |

## hexiom

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 51.43% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.54% | `python` | `PyObject_RichCompareBool` | dynamic |
| 2.42% | `python` | `list_contains` | list |
...
| 1.06% | `python` | `gen_iternext` | miscobj |
| 0.94% | `python` | `gc_collect_region.isra.0` | gc |
| 0.91% | `python` | `_Py_dict_lookup` | lookup |
| 0.67% | `python` | `builtin_sum` | unknown |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 35.44% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 6.66% | `python` | `sre_ucs2_charset.isra.0` | library |
| 3.85% | `python` | `gc_collect_region.isra.0` | gc |
...
| 0.32% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.32% | `python` | `list_contains` | list |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 12.56% | `_json.cpython-314-x86_64-linux-gnu.so` | `scanstring_unicode` | library |
| 7.30% | `python` | `_PyObject_Malloc` | memory |
| 7.13% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 5.72% | `_json.cpython-314-x86_64-linux-gnu.so` | `scan_once_unicode` | library |
| 5.41% | `python` | `_PyObject_Free` | memory |
| 5.14% | `python` | `siphash13` | str |
| 5.11% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 3.68% | `python` | `_Py_dict_lookup` | lookup |
| 2.91% | `python` | `dict_setdefault_ref_lock_held` | dict |
| 2.29% | `python` | `PyUnicode_Substring` | str |
| 2.26% | `python` | `PyLong_FromString` | int |
| 1.95% | `python` | `insertdict` | dict |
| 1.81% | `python` | `dict_dealloc` | memory |
| 1.75% | `python` | `PyUnicode_New.part.0` | memory |
| 1.40% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 1.39% | `python` | `build_indices_unicode` | dict |
| 1.22% | `python` | `find_empty_slot` | dict |
| 1.07% | `libc-2.31.so` | `_int_malloc` | libc |
...
| 0.56% | `python` | `gc_collect_region.isra.0` | gc |
| 0.53% | `libc-2.31.so` | `__libc_malloc` | libc |
| 0.50% | `python` | `_Py_NewReference` | memory |
| 0.49% | `python` | `_PyLong_New` | memory |
| 0.49% | `libc-2.31.so` | `_int_free` | libc |
| 0.46% | `python` | `dictresize` | dict |
| 0.44% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.44% | `python` | `tuple_dealloc` | memory |
| 0.42% | `python` | `pattern_new_match.isra.0.part.0` | memory |
| 0.40% | `python` | `unicode_hash` | str |
| 0.39% | `python` | `PyDict_GetItemRef` | dict |
| 0.39% | `python` | `resize_compact` | str |
| 0.37% | `python` | `maybe_small_long` | unknown |
| 0.36% | `python` | `new_keys_object.constprop.0` | unknown |
...
| 0.28% | `python` | `vgetargskeywords.constprop.0` | calls |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 12.10% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 6.74% | `python` | `_PyObject_Malloc` | memory |
| 6.26% | `_json.cpython-314-x86_64-linux-gnu.so` | `py_encode_basestring_ascii` | library |
| 4.92% | `python` | `_PyObject_Free` | memory |
| 3.42% | `python` | `PyUnicodeWriter_WriteStr` | str |
| 3.03% | `python` | `_Py_dict_lookup` | lookup |
| 2.98% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 2.59% | `python` | `_copy_characters.part.0.constprop.0` | str |
| 2.57% | `_json.cpython-314-x86_64-linux-gnu.so` | `encoder_listencode_obj` | library |
| 2.19% | `python` | `resize_compact` | str |
| 1.87% | `_json.cpython-314-x86_64-linux-gnu.so` | `encoder_encode_key_value` | library |
| 1.77% | `python` | `vgetargskeywords.constprop.0` | calls |
| 1.54% | `python` | `PyUnicode_New` | memory |
| 1.54% | `python` | `PyErr_CheckSignals` | exceptions |
| 1.39% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 1.26% | `python` | `convertitem.constprop.0` | library |
| 1.24% | `python` | `_PyObject_Realloc` | memory |
...
| 0.66% | `python` | `PyThread_get_thread_ident` | unknown |
| 0.62% | `python` | `visit_decref` | gc |
| 0.56% | `python` | `_PyTuple_FromArray.part.0` | tuple |
...
| 0.30% | `libc-2.31.so` | `__strchr_avx2` | libc |
| 0.30% | `python` | `delitem_common` | dynamic |
| 0.29% | `python` | `update_one_slot` | lookup |
| 0.28% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.27% | `python` | `_PyObject_MakeTpCall` | dynamic |
| 0.27% | `python` | `find_first_nonascii` | unknown |
| 0.27% | `python` | `_Py_hashtable_get_entry_generic` | lookup |
| 0.27% | `python` | `func_dealloc` | memory |
| 0.25% | `python` | `siphash13` | str |
| 0.25% | `libc-2.31.so` | `pthread_self` | libc |

## json_loads

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 13.82% | `_json.cpython-314-x86_64-linux-gnu.so` | `scanstring_unicode` | library |
| 7.85% | `python` | `_PyObject_Malloc` | memory |
| 6.63% | `_json.cpython-314-x86_64-linux-gnu.so` | `scan_once_unicode` | library |
| 6.33% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 5.97% | `python` | `siphash13` | str |
| 5.16% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 5.14% | `python` | `_PyObject_Free` | memory |
| 3.69% | `python` | `_Py_dict_lookup` | lookup |
| 3.34% | `python` | `PyUnicode_Substring` | str |
| 2.61% | `python` | `PyLong_FromString` | int |
| 2.50% | `python` | `PyUnicode_New.part.0` | memory |
| 2.50% | `python` | `dict_setdefault_ref_lock_held` | dict |
| 2.08% | `python` | `insertdict` | dict |
| 1.37% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 1.13% | `python` | `unicode_dealloc` | memory |
| 1.12% | `python` | `dict_dealloc` | memory |
| 1.08% | `python` | `find_empty_slot` | dict |
...
| 0.61% | `libc-2.31.so` | `_int_malloc` | libc |
| 0.53% | `python` | `_Py_NewReference` | memory |
| 0.48% | `python` | `unicode_hash` | str |
| 0.45% | `python` | `_PyLong_New` | memory |
| 0.44% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
| 0.43% | `python` | `_PyUnicodeWriter_Init` | str |
| 0.42% | `python` | `initialize_locals` | interpreter |
| 0.42% | `python` | `visit_decref` | gc |
| 0.38% | `python` | `_sre_SRE_Pattern_match` | library |
| 0.37% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 0.36% | `python` | `PyObject_Malloc` | dynamic |
| 0.35% | `libc-2.31.so` | `__libc_malloc` | libc |
| 0.35% | `python` | `tuple_dealloc` | memory |
...
| 0.30% | `libc-2.31.so` | `_int_free` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 42.95% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.73% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 32.60% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 6.60% | `python` | `replace` | str |
| 3.89% | `python` | `long_to_decimal_string_internal` | int |
| 3.65% | `python` | `_PyObject_Malloc` | memory |
| 3.43% | `python` | `_PyObject_Free` | memory |
| 3.00% | `python` | `_PyUnicode_JoinArray.part.0` | str |
| 2.08% | `python` | `deque_append` | miscobj |
| 2.08% | `python` | `unicode_replace` | str |
| 1.66% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 29.41% | `python` | `tuple_hash` | tuple |
| 14.43% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 13.78% | `python` | `PyObject_Hash` | dynamic |
| 11.22% | `python` | `long_hash` | int |
| 6.22% | `python` | `_Py_dict_lookup` | lookup |
| 2.94% | `python` | `PyObject_RichCompareBool` | dynamic |
| 1.80% | `python` | `tuple_richcompare` | tuple |
| 1.13% | `python` | `dict_subscript` | dict |
| 1.08% | `python` | `_PyObject_Free` | memory |
| 0.97% | `python` | `_PyObject_Malloc` | memory |
| 0.95% | `python` | `_PyLong_GCD` | int |
...
| 0.54% | `python` | `builtin_sum` | unknown |
...
| 0.33% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.33% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
| 0.31% | `python` | `tuple_dealloc` | memory |
| 0.30% | `python` | `_Py_Dealloc` | memory |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 21.16% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 7.86% | `python` | `set_issubset_impl` | miscobj |
| 7.51% | `python` | `set_lookkey` | miscobj |
| 6.53% | `python` | `setiter_iternext` | miscobj |
| 3.42% | `python` | `set_difference` | miscobj |
| 3.24% | `python` | `set_dealloc` | memory |
| 2.99% | `python` | `_PyObject_Malloc` | memory |
| 2.79% | `python` | `PyObject_RichCompareBool` | dynamic |
| 2.67% | `python` | `_PyObject_Free` | memory |
| 2.22% | `python` | `set_add_entry` | miscobj |
| 1.98% | `python` | `list_dealloc` | memory |
| 1.65% | `python` | `min_max` | unknown |
| 1.35% | `python` | `long_richcompare` | int |
| 1.28% | `python` | `list_slice_lock_held.isra.0` | list |
| 1.27% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.09% | `python` | `PyObject_RichCompare` | dynamic |
| 1.05% | `python` | `PyIter_Next` | dynamic |
| 0.98% | `python` | `set_intersection` | miscobj |
...
| 0.68% | `python` | `set_merge_lock_held.part.0` | miscobj |
| 0.65% | `python` | `PyType_GenericAlloc` | memory |
| 0.61% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 0.57% | `python` | `visit_decref` | gc |
| 0.53% | `python` | `PySlice_AdjustIndices` | miscobj |
| 0.50% | `python` | `set_richcompare` | miscobj |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 55.94% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 10.48% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
| 3.25% | `libm-2.31.so` | `__ieee754_pow_fma` | library |
| 2.07% | `python` | `float_dealloc` | memory |
| 1.64% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.33% | `python` | `_Py_NewReference` | memory |
...
| 0.36% | `python` | `find_name_in_mro` | lookup |
| 0.32% | `python` | `_PyGC_Collect` | gc |
| 0.31% | `libm-2.31.so` | `powf64` | library |
| 0.31% | `python` | `siphash13` | str |
| 0.31% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 15.41% | `python` | `gc_collect_region.isra.0` | gc |
| 14.29% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 12.50% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 5.62% | `python` | `dictiter_iternextkey` | dict |
| 5.29% | `python` | `set_lookkey` | miscobj |
| 3.51% | `python` | `_PyGC_Collect` | gc |
| 3.32% | `python` | `visit_add_to_container` | gc |
| 2.23% | `python` | `PyDict_GetItemRef` | dict |
| 2.17% | `python` | `dict_traverse` | gc |
| 1.95% | `python` | `build_indices_unicode` | dict |
| 1.91% | `python` | `visit_decref` | gc |
| 1.88% | `python` | `dict_dealloc` | memory |
| 1.60% | `python` | `_PyObject_Malloc` | memory |
| 1.60% | `python` | `_PyType_LookupRef` | lookup |
...
| 0.71% | `libz.so.1.2.11` | `inflateBackEnd` | library |
...
| 0.43% | `python` | `_PyTuple_FromArray.part.0` | tuple |
...
| 0.27% | `python` | `method_vectorcall_VARARGS_KEYWORDS` | calls |
| 0.26% | `python` | `PyUnicode_New.part.0` | memory |
| 0.26% | `python` | `unicode_dealloc` | memory |
| 0.25% | `python` | `PyUnicode_Decode.part.0` | str |

## networkx_connected_components

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 15.77% | `python` | `gc_collect_region.isra.0` | gc |
| 14.73% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 11.21% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 6.75% | `python` | `set_lookkey` | miscobj |
| 5.50% | `python` | `dictiter_iternextkey` | dict |
| 3.60% | `python` | `_PyGC_Collect` | gc |
| 3.38% | `python` | `visit_add_to_container` | gc |
| 2.28% | `python` | `PyDict_GetItemRef` | dict |
| 2.24% | `python` | `dict_traverse` | gc |
| 1.98% | `python` | `visit_decref` | gc |
| 1.74% | `python` | `dict_dealloc` | memory |
| 1.64% | `python` | `_PyObject_Malloc` | memory |
| 1.59% | `python` | `_PyType_LookupRef` | lookup |
| 1.56% | `python` | `_Py_dict_lookup` | lookup |
| 1.35% | `python` | `_PyObject_Free` | memory |
| 0.96% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 0.91% | `python` | `PyObject_GC_UnTrack` | gc |
| 0.88% | `python` | `insertdict` | dict |
| 0.72% | `python` | `_PySet_Contains` | miscobj |
| 0.72% | `libz.so.1.2.11` | `inflateBackEnd` | library |
| 0.72% | `python` | `visit_reachable` | gc |
| 0.68% | `python` | `build_indices_unicode` | dict |
...
| 0.48% | `python` | `set_dealloc` | memory |
| 0.46% | `python` | `siphash13` | str |
| 0.44% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
| 0.44% | `python` | `tuple_dealloc` | memory |
...
| 0.30% | `python` | `set_merge_lock_held.part.0` | miscobj |
| 0.29% | `python` | `PyList_New` | memory |
...
| 0.26% | `python` | `PyUnicode_New.part.0` | memory |
| 0.26% | `python` | `method_vectorcall_VARARGS_KEYWORDS` | calls |
| 0.26% | `python` | `PyUnicode_Decode.part.0` | str |
| 0.25% | `python` | `dict_update` | dict |

## networkx_k_core

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 23.41% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 15.94% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 8.77% | `python` | `gc_collect_region.isra.0` | gc |
| 4.89% | `python` | `PyDict_GetItemRef` | dict |
| 4.49% | `python` | `list_remove` | list |
| 4.18% | `python` | `visit_add_to_container` | gc |
| 3.27% | `python` | `_PyGC_Collect` | gc |
| 3.08% | `python` | `dictiter_iternextkey` | dict |
| 2.94% | `python` | `_Py_dict_lookup` | lookup |
| 1.65% | `python` | `dict_traverse` | gc |
| 1.50% | `python` | `visit_decref` | gc |
| 1.30% | `python` | `dict_dealloc` | memory |
| 1.21% | `python` | `build_indices_unicode` | dict |
| 1.11% | `python` | `_PyObject_Malloc` | memory |
| 1.08% | `python` | `list_dealloc` | memory |
| 1.01% | `python` | `PyUnicode_RichCompare` | str |
...
| 0.54% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 34.36% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.52% | `python` | `_PyObject_Free` | memory |
| 4.50% | `python` | `_PyObject_Malloc` | memory |
| 2.76% | `python` | `set_add_entry` | miscobj |
| 2.67% | `python` | `gen_iternext` | miscobj |
| 2.28% | `python` | `PySlice_AdjustIndices` | miscobj |
| 1.59% | `python` | `PyList_New` | memory |
| 1.56% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.41% | `python` | `_PyBuildSlice_ConsumeRefs` | miscobj |
| 1.21% | `python` | `set_dealloc` | memory |
...
| 0.73% | `python` | `PySequence_Tuple` | dynamic |
...
| 0.47% | `python` | `_PyObject_GC_New` | gc |
| 0.46% | `python` | `compute_range_length` | unknown |
| 0.46% | `python` | `list_slice_lock_held.isra.0` | list |
| 0.44% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 0.43% | `python` | `_PyDict_LoadBuiltinsFromGlobals` | dict |
| 0.42% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| 0.29% | `python` | `r_object` | import |
| 0.28% | `python` | `range_reverse` | miscobj |
| 0.28% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 12.57% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 1.28% | `libpthread-2.31.so` | `__pthread_mutex_lock` | library |
| 1.24% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 1.21% | `[kernel.kallsyms]` | `ext4_htree_store_dirent` | kernel |
| 1.17% | `[kernel.kallsyms]` | `__ext4fs_dirhash` | kernel |
| 1.16% | `libpthread-2.31.so` | `pthread_mutex_unlock` | library |
...
| 0.79% | `python` | `k_mul` | int |
| 0.75% | `[kernel.kallsyms]` | `filldir64` | kernel |
| 0.69% | `python` | `tuple_dealloc` | memory |
| 0.67% | `[kernel.kallsyms]` | `kmem_cache_alloc` | kernel |
| 0.66% | `python` | `_PyEval_Vector` | interpreter |
| 0.64% | `python` | `subtype_dealloc` | memory |
| 0.63% | `python` | `sre_ucs1_match` | library |
| 0.61% | `[kernel.kallsyms]` | `copy_user_enhanced_fast_string` | kernel |
| 0.61% | `python` | `_PyTuple_FromStackRefSteal` | tuple |
| 0.61% | `[kernel.kallsyms]` | `strncpy_from_user` | kernel |
| 0.60% | `[kernel.kallsyms]` | `link_path_walk.part.0` | kernel |
| 0.60% | `python` | `long_dealloc` | memory |
| 0.60% | `libc-2.31.so` | `_int_malloc` | libc |
| 0.59% | `python` | `fill_time` | unknown |
| 0.55% | `[kernel.kallsyms]` | `clear_bhb_loop` | kernel |
...
| 0.48% | `python` | `structseq_dealloc` | memory |
| 0.48% | `python` | `visit_decref` | gc |
| 0.47% | `python` | `find_first_nonascii` | unknown |
| 0.47% | `python` | `_Py_NewReference` | memory |
| 0.47% | `python` | `ScandirIterator_iternext` | unknown |
| 0.46% | `[kernel.kallsyms]` | `ext4_getattr` | kernel |
...
| 0.42% | `[kernel.kallsyms]` | `__ext4_check_dir_entry` | kernel |
| 0.42% | `[kernel.kallsyms]` | `str2hashbuf_signed` | kernel |
...
| 0.35% | `libc-2.31.so` | `__xstat64` | libc |
...
| 0.33% | `python` | `map_next` | unknown |
| 0.32% | `python` | `PyList_New` | memory |
| 0.30% | `[kernel.kallsyms]` | `lookup_fast` | kernel |
| 0.30% | `libc-2.31.so` | `__strcpy_avx2` | libc |
| 0.29% | `[kernel.kallsyms]` | `kmem_cache_free` | kernel |
| 0.29% | `python` | `method_vectorcall` | calls |
| 0.28% | `[kernel.kallsyms]` | `in_group_p` | kernel |
| 0.28% | `python` | `PyUnicode_EncodeFSDefault` | str |
| 0.28% | `[kernel.kallsyms]` | `generic_permission` | kernel |
| 0.27% | `[kernel.kallsyms]` | `call_filldir` | kernel |
| 0.27% | `python` | `_PyFunction_Vectorcall` | calls |
| 0.26% | `libc-2.31.so` | `_int_free` | libc |
| 0.26% | `python` | `PyLong_FromLongLong` | int |
| 0.26% | `[kernel.kallsyms]` | `walk_component` | kernel |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 39.92% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.94% | `python` | `_Py_dict_lookup` | lookup |
...
| 0.45% | `python` | `_PyThreadState_PopFrame` | interpreter |
| 0.42% | `python` | `PyLong_FromSsize_t` | int |
| 0.41% | `python` | `PyNumber_Add` | dynamic |
| 0.40% | `python` | `PyUnicode_AsEncodedString.part.0` | str |
| 0.39% | `python` | `PyObject_GetBuffer` | dynamic |
| 0.36% | `python` | `visit_reachable` | gc |
| 0.36% | `python` | `_PyObject_GenericGetAttrWithDict` | dynamic |
| 0.35% | `python` | `unicode_encode` | str |
| 0.33% | `_struct.cpython-314-x86_64-linux-gnu.so` | `pack` | library |
| 0.33% | `python` | `update_one_slot` | lookup |
| 0.33% | `python` | `_PyObject_Realloc` | memory |
| 0.32% | `python` | `find_name_in_mro` | lookup |
| 0.32% | `libc-2.31.so` | `_int_malloc` | libc |
| 0.31% | `python` | `PyObject_Hash` | dynamic |
| 0.30% | `python` | `PySys_Audit` | unknown |
| 0.30% | `_struct.cpython-314-x86_64-linux-gnu.so` | `s_pack_internal.isra.0` | library |
| 0.30% | `python` | `dictiter_iternextitem` | dict |
| 0.29% | `python` | `_PyGC_Collect` | gc |
| 0.29% | `python` | `_Py_NewReference` | memory |
| 0.29% | `python` | `PyLong_FromVoidPtr` | int |
| 0.28% | `_struct.cpython-314-x86_64-linux-gnu.so` | `s_pack` | library |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 33.11% | `python` | `x_divrem` | int |
| 22.90% | `python` | `k_mul` | int |
| 11.90% | `python` | `x_add` | int |
| 7.94% | `python` | `x_sub` | int |
| 4.01% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 1.46% | `libc-2.31.so` | `_int_malloc` | libc |
| 0.95% | `libc-2.31.so` | `__memset_avx2_erms` | libc |
...
| 0.51% | `libc-2.31.so` | `_int_free` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 43.53% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 0.56% | `python` | `PyObject_IsSubclass` | dynamic |
| 0.55% | `python` | `list_append` | list |
...
| 0.29% | `python` | `recursive_issubclass` | unknown |
| 0.29% | `python` | `_PySet_Contains` | miscobj |
| 0.29% | `python` | `builtin_getattr` | lookup |
| 0.28% | `python` | `PyObject_Hash` | dynamic |
| 0.26% | `python` | `PyCMethod_New` | memory |
| 0.25% | `python` | `PyObject_Repr` | dynamic |

## pycparser

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 33.05% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 14.07% | `python` | `sre_ucs1_match` | library |
| 3.11% | `python` | `gc_collect_region.isra.0` | gc |
...
| 0.55% | `libc-2.31.so` | `_int_free` | libc |
| 0.52% | `python` | `_PyEvalFramePushAndInit` | interpreter |
| 0.51% | `python` | `dict_get` | dict |
| 0.50% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| 0.38% | `python` | `visit_reachable` | gc |
| 0.38% | `libc-2.31.so` | `__libc_malloc` | libc |
| 0.37% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
...
| 0.30% | `libc-2.31.so` | `unlink_chunk.isra.0` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 42.56% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 6.69% | `python` | `list_dealloc` | memory |
| 5.05% | `python` | `list_ass_slice_lock_held` | list |
| 1.93% | `python` | `list_concat` | list |
| 1.74% | `python` | `list_slice_lock_held.isra.0` | list |
| 1.73% | `python` | `_PyObject_Free` | memory |
| 1.71% | `python` | `_PyObject_Malloc` | memory |
| 1.61% | `python` | `PySlice_AdjustIndices` | miscobj |
| 1.55% | `libc-2.31.so` | `_int_malloc` | libc |
| 1.47% | `python` | `_PyLong_FromMedium` | int |
| 1.38% | `python` | `PyNumber_AsSsize_t` | dynamic |
| 1.21% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.09% | `python` | `long_dealloc` | memory |
| 1.08% | `python` | `_PyLong_Subtract` | int |
| 0.98% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.92% | `python` | `long_lshift_int64` | int |
| 0.89% | `python` | `bytes_subscript` | str |
| 0.87% | `python` | `stringlib_bytes_join` | str |
| 0.82% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 0.82% | `python` | `list_sort_impl` | list |
| 0.82% | `python` | `PyLong_AsSsize_t` | int |
| 0.79% | `python` | `_PyLong_Add` | int |
| 0.67% | `python` | `unsafe_long_compare` | unknown |
| 0.62% | `python` | `long_lshift_method` | int |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 24.83% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 11.18% | `python` | `gc_collect_region.isra.0` | gc |
...
| 2.13% | `python` | `visit_add_to_container` | gc |
...
| 0.69% | `python` | `tuple_dealloc` | memory |
| 0.65% | `python` | `PyObject_VisitManagedDict` | dynamic |
...
| 5.62% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 3.23% | `python` | `_PyObject_Malloc` | memory |
| 2.97% | `python` | `_Py_dict_lookup` | lookup |
| 2.72% | `python` | `gc_collect_region.isra.0` | gc |
...
| 1.16% | `python` | `update_one_slot` | lookup |
| 1.05% | `python` | `_PyCode_Quicken` | interpreter |
| 1.05% | `python` | `dict_traverse` | gc |
| 0.98% | `python` | `_PyGC_Collect` | gc |
| 0.93% | `ld-2.31.so` | `do_lookup_x` | library |
| 0.91% | `python` | `tuple_dealloc` | memory |
| 0.87% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.80% | `python` | `visit_add_to_container` | gc |
| 0.80% | `python` | `_PyUnicode_FromUCS1.part.0` | str |
| 0.78% | `libc-2.31.so` | `__strlen_avx2` | libc |
| 0.67% | `python` | `_PyType_LookupRef` | lookup |
| 0.61% | `python` | `_PyDict_GetItemRef_KnownHash` | dict |
...
| 0.55% | `python` | `find_first_nonascii` | unknown |
| 0.53% | `python` | `insertdict` | dict |
| 0.50% | `[kernel.kallsyms]` | `filemap_map_pages` | kernel |
| 0.49% | `python` | `PyUnicode_New.part.0` | memory |
...
| 0.44% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.44% | `python` | `build_indices_unicode` | dict |
| 0.42% | `python` | `dict_dealloc` | memory |
| 0.42% | `[kernel.kallsyms]` | `sync_regs` | kernel |
| 0.41% | `libc-2.31.so` | `wcsrtombs` | libc |
| 0.38% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.37% | `python` | `initialize_locals` | interpreter |
| 0.37% | `python` | `code_dealloc` | memory |
| 0.36% | `ld-2.31.so` | `strcmp` | library |
| 0.35% | `[kernel.kallsyms]` | `clear_page_erms` | kernel |
| 0.35% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
| 0.34% | `libc-2.31.so` | `__gconv_transform_internal_utf8` | libc |
| 0.33% | `ld-2.31.so` | `_dl_lookup_symbol_x` | library |
| 0.33% | `python` | `find_empty_slot` | dict |
| 0.33% | `ld-2.31.so` | `_dl_relocate_object` | library |
...
| 0.30% | `[kernel.kallsyms]` | `__d_lookup_rcu` | kernel |
| 0.29% | `python` | `unicode_dealloc` | memory |
| 0.27% | `python` | `PyTuple_New` | memory |
| 0.26% | `libc-2.31.so` | `_int_free` | libc |
| 0.26% | `python` | `_PyUnicode_InternImmortal` | str |
| 0.26% | `[kernel.kallsyms]` | `ext4_htree_store_dirent` | kernel |
| 0.26% | `python` | `PyObject_GC_UnTrack` | gc |
| 0.25% | `libpthread-2.31.so` | `__pthread_mutex_lock` | library |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 7.53% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 2.05% | `python` | `visit_reachable` | gc |
| 1.74% | `python` | `_PyObject_Free` | memory |
| 1.52% | `python` | `siphash13` | str |
| 1.50% | `ld-2.31.so` | `do_lookup_x` | library |
| 1.41% | `python` | `type_ready` | dynamic |
| 1.33% | `python` | `r_object` | import |
| 1.32% | `python` | `_Py_hashtable_get_entry_generic` | lookup |
| 1.31% | `python` | `_PyGC_Collect` | gc |
| 1.16% | `python` | `find_name_in_mro` | lookup |
| 1.14% | `python` | `dict_traverse` | gc |
| 1.06% | `python` | `update_one_slot` | lookup |
| 0.95% | `ld-2.31.so` | `_dl_relocate_object` | library |
| 0.91% | `libc-2.31.so` | `wcsrtombs` | libc |
| 0.86% | `libc-2.31.so` | `__strlen_avx2` | libc |
| 0.83% | `python` | `tuple_dealloc` | memory |
| 0.83% | `python` | `_PyCode_Quicken` | interpreter |
| 0.76% | `python` | `find_first_nonascii` | unknown |
| 0.73% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.72% | `[kernel.kallsyms]` | `native_irq_return_iret` | kernel |
| 0.71% | `python` | `_PyUnicode_FromUCS1.part.0` | str |
| 0.71% | `[kernel.kallsyms]` | `filemap_map_pages` | kernel |
| 0.62% | `[kernel.kallsyms]` | `sync_regs` | kernel |
| 0.62% | `ld-2.31.so` | `strcmp` | library |
| 0.62% | `python` | `insertdict` | dict |
| 0.60% | `python` | `_PyDict_GetItemRef_KnownHash` | dict |
| 0.59% | `libc-2.31.so` | `__gconv_transform_internal_utf8` | libc |
| 0.58% | `python` | `dict_setdefault_ref_lock_held` | dict |
| 0.55% | `python` | `_PyType_LookupRef` | lookup |
...
| 0.46% | `ld-2.31.so` | `_dl_lookup_symbol_x` | library |
...
| 0.39% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.37% | `ld-2.31.so` | `check_match` | library |
| 0.36% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 49.41% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.88% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 3.54% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
...
| 1.32% | `python` | `PyType_IsSubtype` | dynamic |
| 1.23% | `python` | `PyType_GenericAlloc` | memory |
| 1.10% | `python` | `_Py_Dealloc` | memory |
| 1.03% | `python` | `_PyThreadState_PopFrame` | interpreter |
| 0.98% | `python` | `PyNumber_Subtract` | dynamic |
...
| 0.66% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.65% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 0.60% | `python` | `vectorcall_maybe.constprop.0` | unknown |
| 0.59% | `python` | `_PyEval_Vector` | interpreter |
| 0.57% | `python` | `PyObject_GC_Del` | gc |
| 0.51% | `python` | `float_richcompare` | float |
| 0.50% | `python` | `PyObject_ClearWeakRefs` | dynamic |
| 0.49% | `python` | `_PyThreadState_PushFrame` | interpreter |
| 0.48% | `python` | `tuple_dealloc` | memory |
| 0.44% | `python` | `PyObject_GC_UnTrack` | gc |
| 0.42% | `python` | `PyNumber_Multiply` | dynamic |
| 0.39% | `python` | `float_mul` | float |
| 0.35% | `python` | `gc_collect_region.isra.0` | gc |
...
| ---: | :--- | :--- | :--- |
| 43.53% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.22% | `python` | `sre_ucs1_match` | library |
...
| 0.99% | `python` | `bytearray_ass_subscript` | miscobj |
| 0.92% | `python` | `_PyLong_FromMedium` | int |
| 0.88% | `python` | `_PyType_LookupRef` | lookup |
| 0.84% | `python` | `tuple_dealloc` | memory |
| 0.82% | `python` | `_Py_dict_lookup` | lookup |
| 0.81% | `python` | `sre_ucs2_charset.isra.0` | library |
...
| 0.61% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 32.29% | `python` | `sre_ucs1_match` | library |
| 27.20% | `python` | `sre_ucs2_charset.isra.0` | library |
| 7.60% | `python` | `sre_search` | library |
| 6.51% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.33% | `libm-2.31.so` | `__fmod_finite@GLIBC_2.15` | library |
| 1.38% | `_bisect.cpython-314-x86_64-linux-gnu.so` | `_bisect_bisect_right` | library |
| 0.99% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.80% | `python` | `_PyObject_Malloc` | memory |
| 0.78% | `python` | `pattern_subx` | library |
| 0.76% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 0.62% | `python` | `float_rem` | float |
| 0.58% | `python` | `float_richcompare` | float |
| 0.54% | `python` | `list_item` | list |
| 0.50% | `python` | `gc_collect_region.isra.0` | gc |
| 0.48% | `python` | `_PyObject_Free` | memory |
| 0.48% | `python` | `float_dealloc` | memory |
| 0.42% | `python` | `stringlib_bytes_join` | str |
| 0.39% | `python` | `_Py_dict_lookup` | lookup |
| 0.39% | `python` | `bytearray_ass_subscript` | miscobj |
| 0.37% | `python` | `float_div` | float |
| 0.37% | `python` | `visit_decref` | gc |
| 0.37% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 47.93% | `python` | `sre_ucs1_match` | library |
| 15.75% | `python` | `sre_ucs2_charset.isra.0` | library |
| 7.60% | `python` | `sre_search` | library |
| 4.16% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 2.56% | `python` | `sre_ucs1_count` | library |
...
| 8.32% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 5.38% | `python` | `sre_search` | library |
| 4.30% | `python` | `sre_ucs1_count` | library |
| 3.59% | `python` | `PyCode_Addr2Line` | exceptions |
| 2.79% | `python` | `_PyObject_Malloc` | memory |
| 2.50% | `python` | `_PyObject_Free` | memory |
| 1.59% | `python` | `pattern_subx` | library |
| 1.42% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.17% | `libc-2.31.so` | `_int_malloc` | libc |
| 1.08% | `python` | `_Py_dict_lookup` | lookup |
| 1.00% | `python` | `_sre_SRE_Pattern_search` | library |
| 0.96% | `python` | `pattern_new_match.isra.0.part.0` | memory |
| 0.73% | `libc-2.31.so` | `_int_free` | libc |
| 0.73% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.71% | `python` | `gc_collect_region.isra.0` | gc |
| 0.57% | `libc-2.31.so` | `__libc_malloc` | libc |
| 0.51% | `python` | `_PyUnicode_IsAlpha` | str |
| 0.47% | `python` | `_PyUnicode_ToLowercase` | str |
| 0.46% | `python` | `visit_decref` | gc |
| 0.41% | `python` | `_PyUnicode_JoinArray.part.0` | str |
...
| 0.26% | `python` | `PyUnicode_Substring` | str |
| 0.26% | `python` | `PyObject_GC_UnTrack` | gc |
| 0.25% | `python` | `PyUnicode_New.part.0` | memory |
| 0.25% | `python` | `sre_ucs2_charset.isra.0` | library |

## richards

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 51.35% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 5.38% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 5.12% | `python` | `_PyType_LookupRef` | lookup |
| 3.33% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 2.65% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 2.46% | `python` | `_PyObject_TryGetInstanceAttribute` | dynamic |
...
| 0.84% | `python` | `gc_collect_region.isra.0` | gc |
| 0.80% | `python` | `_PyThreadState_PopFrame` | interpreter |
| 0.73% | `python` | `_Py_dict_lookup` | lookup |
| 0.62% | `python` | `_PyObject_Free` | memory |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 50.40% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 5.33% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 5.00% | `python` | `_PyType_LookupRef` | lookup |
| 3.36% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 2.32% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 2.12% | `python` | `_PyObject_TryGetInstanceAttribute` | dynamic |
| 2.01% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 1.66% | `python` | `_PyObject_GetMethod` | dynamic |
| 1.12% | `python` | `PyObject_GetAttr` | dynamic |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 41.03% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.11% | `array.cpython-314-x86_64-linux-gnu.so` | `array_subscr` | library |
| 3.93% | `python` | `PyFloat_FromDouble` | float |
| 3.07% | `python` | `PyNumber_AsSsize_t` | dynamic |
| 2.99% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
| 2.85% | `python` | `_PyLong_FromMedium` | int |
| 2.53% | `python` | `vgetargs1_impl` | calls |
| 2.47% | `python` | `PyObject_GetItem` | dynamic |
| 1.70% | `python` | `convertitem.constprop.0` | library |
| 1.62% | `python` | `PyLong_AsSsize_t` | int |
| 1.36% | `python` | `long_dealloc` | memory |
| 1.32% | `python` | `_Py_NewReference` | memory |
| 1.28% | `array.cpython-314-x86_64-linux-gnu.so` | `array_ass_subscr` | library |
| 1.26% | `python` | `float_dealloc` | memory |
| 1.13% | `array.cpython-314-x86_64-linux-gnu.so` | `d_setitem` | library |
| 1.10% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.07% | `python` | `_PyLong_Add` | int |
| 1.04% | `python` | `PyIndex_Check` | unknown |
| 0.99% | `python` | `PyType_GetModuleByDef` | dynamic |
| 0.82% | `python` | `PyArg_Parse` | calls |
| 0.79% | `python` | `PyObject_SetItem` | dynamic |
| 0.74% | `array.cpython-314-x86_64-linux-gnu.so` | `d_getitem` | library |
...
| 0.47% | `python` | `_PyLong_Multiply` | int |
| 0.45% | `python` | `PyType_IsSubtype` | dynamic |
| 0.42% | `python` | `_PyObject_Free` | memory |
| 0.38% | `python` | `_PyLong_Frexp` | int |
| 0.37% | `array.cpython-314-x86_64-linux-gnu.so` | `0x00000000000047e4` | library |
| 0.36% | `python` | `gc_collect_region.isra.0` | gc |
| 0.35% | `array.cpython-314-x86_64-linux-gnu.so` | `0x0000000000004644` | library |
...
| 0.26% | `python` | `float_richcompare` | float |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 36.25% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 6.18% | `python` | `_PyLong_Add` | int |
| 5.56% | `python` | `_PyLong_FromMedium` | int |
| 3.21% | `python` | `long_div` | int |
| 3.10% | `python` | `float_div` | float |
| 1.94% | `python` | `_PyLong_ExactDealloc` | memory |
| 1.88% | `python` | `long_dealloc` | memory |
| 1.84% | `python` | `PyType_IsSubtype` | dynamic |
| 1.81% | `python` | `listiter_next` | list |
| 1.79% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.63% | `python` | `enum_next` | miscobj |
| 1.59% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.56% | `python` | `PyLong_AsDouble` | int |
| 1.50% | `python` | `_Py_NewReference` | memory |
| 1.48% | `python` | `_PyLong_Multiply` | int |
| 1.45% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 1.32% | `python` | `PyNumber_TrueDivide` | dynamic |
| 1.17% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
| 1.04% | `python` | `gc_collect_region.isra.0` | gc |
| 0.96% | `python` | `_PyObject_Malloc` | memory |
| 0.93% | `python` | `PyNumber_FloorDivide` | dynamic |
...
| 0.50% | `python` | `float_dealloc` | memory |
| 0.48% | `python` | `r_object` | import |
| 0.36% | `python` | `visit_reachable` | gc |
| 0.31% | `python` | `tuple_dealloc` | memory |
| 0.29% | `python` | `update_one_slot` | lookup |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 23.60% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 6.34% | `python` | `sre_ucs1_match` | library |
| 3.69% | `python` | `gc_collect_region.isra.0` | gc |
| 3.09% | `python` | `_PyObject_Malloc` | memory |
| 3.06% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 2.68% | `python` | `_PyType_LookupRef` | lookup |
| 2.30% | `python` | `sre_ucs2_charset.isra.0` | library |
| 2.30% | `python` | `_PyObject_Free` | memory |
| 1.81% | `python` | `_Py_dict_lookup` | lookup |
| 1.68% | `python` | `visit_add_to_container` | gc |
| 1.55% | `_pickle.cpython-314-x86_64-linux-gnu.so` | `save` | library |
...
| 0.56% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| 0.32% | `python` | `_PyTuple_FromStackRefSteal` | tuple |
| 0.30% | `_pickle.cpython-314-x86_64-linux-gnu.so` | `PyMemoTable_Set` | library |
| 0.29% | `python` | `sre_ucs2_match` | library |
...
| 0.96% | `python` | `visit_decref` | gc |
| 0.88% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| 0.65% | `libpthread-2.31.so` | `__pthread_mutex_lock` | library |
| 0.64% | `python` | `visit_reachable` | gc |
| 0.62% | `python` | `PyObject_GC_UnTrack` | gc |
| 0.61% | `python` | `_Py_Dealloc` | memory |
| 0.61% | `libpthread-2.31.so` | `pthread_mutex_unlock` | library |
...
| 1.20% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 1.12% | `python` | `PyObject_GetAttr` | dynamic |
...
| 0.54% | `python` | `_Py_Dealloc` | memory |
| 0.52% | `libpthread-2.31.so` | `__pthread_mutex_lock` | library |
| 0.52% | `libpthread-2.31.so` | `pthread_mutex_unlock` | library |
| 0.51% | `python` | `_PyTuple_FromStackRefSteal` | tuple |
| 0.49% | `libsqlite3.so.0.8.6` | `sqlite3_reset` | library |
...
| 0.31% | `libsqlite3.so.0.8.6` | `sqlite3_exec` | library |
| 0.28% | `python` | `PyObject_Vectorcall` | dynamic |
| 0.27% | `python` | `PyList_New` | memory |
| 0.27% | `python` | `_PyUnicode_FromUCS1.part.0` | str |
| 0.27% | `libsqlite3.so.0.8.6` | `sqlite3_randomness` | library |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 31.40% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.07% | `python` | `_PyObject_Free` | memory |
| 4.02% | `python` | `_PyObject_Malloc` | memory |
| 2.30% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 2.28% | `python` | `_PyType_LookupRef` | lookup |
| 2.04% | `python` | `PyType_IsSubtype` | dynamic |
| 1.71% | `python` | `tuple_dealloc` | memory |
| 1.63% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.50% | `python` | `_PyType_LookupRefAndVersion` | unknown |
...
| 1.03% | `python` | `PyObject_GC_Del` | gc |
| 1.02% | `python` | `gc_collect_region.isra.0` | gc |
| 0.97% | `python` | `PyObject_IsInstance` | dynamic |
...
| 0.66% | `python` | `_Py_Dealloc` | memory |
| 0.65% | `python` | `object_isinstance` | dynamic |
| 0.63% | `python` | `visit_decref` | gc |
| 0.55% | `python` | `_PyObject_GC_Link` | gc |
| 0.55% | `python` | `PyCMethod_New` | memory |
| 0.53% | `python` | `siphash13` | str |
...
| 0.43% | `python` | `_PyObject_RealIsInstance` | dynamic |
| 0.42% | `python` | `r_object` | import |
...
| 0.26% | `python` | `new_dict.isra.0` | unknown |
| 0.26% | `python` | `gen_iternext` | miscobj |
| 0.26% | `python` | `dict_traverse` | gc |
| 0.26% | `python` | `_Py_hashtable_get_entry_generic` | lookup |
| 0.25% | `python` | `PyObject_GenericGetAttr` | dynamic |
...
| 2.63% | `python` | `_PyType_LookupRef` | lookup |
| 2.31% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 2.31% | `python` | `PyType_IsSubtype` | dynamic |
...
| 1.42% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 1.26% | `python` | `dictiter_iternextitem` | dict |
| 1.14% | `python` | `gc_collect_region.isra.0` | gc |
| 1.07% | `python` | `_PyTuple_FromStackRefSteal` | tuple |
| 1.02% | `python` | `PyObject_GC_Del` | gc |
| 0.98% | `python` | `PyObject_IsInstance` | dynamic |
...
| 0.68% | `python` | `object_isinstance` | dynamic |
| 0.65% | `python` | `visit_decref` | gc |
| 0.64% | `python` | `PyCMethod_New` | memory |
| 0.62% | `python` | `initialize_locals` | interpreter |
...
| 0.37% | `python` | `PyTuple_Pack` | tuple |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 44.19% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 2.06% | `python` | `_PyObject_Free` | memory |
| 1.88% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 1.81% | `python` | `gc_collect_region.isra.0` | gc |
| 1.77% | `python` | `initialize_locals` | interpreter |
| 1.29% | `python` | `_PyType_LookupRef` | lookup |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 10.70% | `libpthread-2.31.so` | `pthread_mutex_unlock` | library |
| 10.10% | `libpthread-2.31.so` | `__pthread_mutex_lock` | library |
| 9.20% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.39% | `python` | `take_gil` | gil |
| 4.04% | `libsqlite3.so.0.8.6` | `sqlite3_reset` | library |
| 2.40% | `python` | `_PyObject_Malloc` | memory |
| 1.97% | `python` | `_PyObject_Free` | memory |
| 1.92% | `libm-2.31.so` | `__cos_fma` | library |
| 1.49% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.36% | `libsqlite3.so.0.8.6` | `sqlite3_randomness` | library |
| 0.96% | `python` | `drop_gil` | gil |
| 0.91% | `_sqlite3.cpython-314-x86_64-linux-gnu.so` | `_pysqlite_query_execute` | library |
| 0.87% | `libpthread-2.31.so` | `pthread_cond_signal@@GLIBC_2.3.2` | library |
| 0.86% | `python` | `tuple_dealloc` | memory |
| 0.82% | `python` | `_Py_dict_lookup` | lookup |
| 0.81% | `libsqlite3.so.0.8.6` | `sqlite3_value_double` | library |
| 0.75% | `python` | `gc_collect_region.isra.0` | gc |
| 0.75% | `libsqlite3.so.0.8.6` | `sqlite3_value_int64` | library |
| 0.73% | `libsqlite3.so.0.8.6` | `sqlite3_preupdate_old` | library |
| 0.70% | `python` | `_Py_Dealloc` | memory |
| 0.68% | `libsqlite3.so.0.8.6` | `sqlite3_extended_errcode` | library |
| 0.67% | `python` | `long_to_decimal_string_internal` | int |
| 0.63% | `libsqlite3.so.0.8.6` | `sqlite3_vtab_config` | library |
| 0.60% | `python` | `_PyThreadState_MustExit` | interpreter |
| 0.57% | `libc-2.31.so` | `_int_free` | libc |
| 0.55% | `python` | `PyList_New` | memory |
| 0.53% | `libsqlite3.so.0.8.6` | `sqlite3_wal_checkpoint` | library |
| 0.52% | `python` | `visit_decref` | gc |
| 0.49% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.47% | `python` | `PyObject_GC_UnTrack` | gc |
| 0.47% | `python` | `long_dealloc` | memory |
| 0.46% | `python` | `_PyThreadState_Attach` | interpreter |
| 0.45% | `python` | `_Py_NewReference` | memory |
| 0.44% | `libsqlite3.so.0.8.6` | `sqlite3_step` | library |
| 0.43% | `python` | `PyFloat_FromDouble` | float |
| 0.42% | `python` | `PyType_GenericAlloc` | memory |
| 0.42% | `libc-2.31.so` | `__libc_malloc` | libc |
| 0.42% | `python` | `PyTuple_New` | memory |
| 0.42% | `libsqlite3.so.0.8.6` | `sqlite3_enable_shared_cache` | library |
| 0.41% | `python` | `r_object` | import |
| 0.40% | `python` | `list_dealloc` | memory |
| 0.39% | `python` | `_PyThreadState_Detach` | interpreter |
| 0.38% | `libsqlite3.so.0.8.6` | `sqlite3_mutex_try` | library |
| 0.37% | `python` | `PyThread_get_thread_ident` | unknown |
| 0.36% | `python` | `visit_reachable` | gc |
| 0.36% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.36% | `python` | `_PyTuple_FromArray.part.0` | tuple |
...
| 0.30% | `python` | `PyObject_GC_Del` | gc |
| 0.29% | `python` | `PyType_IsSubtype` | dynamic |
| 0.29% | `libsqlite3.so.0.8.6` | `sqlite3_str_value` | library |
| 0.29% | `_sqlite3.cpython-314-x86_64-linux-gnu.so` | `_pysqlite_fetch_one_row` | library |
| 0.29% | `_sqlite3.cpython-314-x86_64-linux-gnu.so` | `pysqlite_cursor_init` | library |
| 0.28% | `python` | `bounded_lru_cache_wrapper` | unknown |
| 0.28% | `libsqlite3.so.0.8.6` | `sqlite3_close_v2` | library |
| 0.28% | `python` | `pthread_mutex_lock@plt` | unknown |
| 0.27% | `python` | `PyObject_ClearWeakRefs` | dynamic |
| 0.27% | `python` | `initialize_locals` | interpreter |
| 0.26% | `libsqlite3.so.0.8.6` | `sqlite3_value_pointer` | library |
| 0.26% | `python` | `_PyGC_Collect` | gc |
| 0.26% | `python` | `PyObject_CallOneArg` | dynamic |
| 0.26% | `python` | `unicode_decode_utf8.part.0` | str |
| 0.26% | `libc-2.31.so` | `cfree@GLIBC_2.2.5` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 26.31% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.68% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 3.09% | `python` | `_PyObject_Malloc` | memory |
| 2.53% | `python` | `_Py_dict_lookup` | lookup |
| 2.46% | `python` | `_PyObject_Free` | memory |
| 2.06% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 1.78% | `python` | `tuple_dealloc` | memory |
| 1.63% | `python` | `gc_collect_region.isra.0` | gc |
| 1.56% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.43% | `python` | `_PyType_LookupRef` | lookup |
...
| 0.66% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 0.62% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
...
| 0.27% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
| 0.26% | `python` | `_PyObject_GC_Link` | gc |
| 0.26% | `python` | `_PyObject_MakeTpCall` | dynamic |
...
| 1.89% | `python` | `_PyObject_GC_New` | gc |
| 1.73% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `nm_mpd_qadd` | library |
| 1.67% | `python` | `PyContextVar_Get` | unknown |
| 1.50% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_check_exp` | library |
| 1.49% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_qaddsub` | library |
| 1.46% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_setdigits` | library |
| 1.42% | `python` | `_PyType_LookupRef` | lookup |
| 1.41% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_qmul` | library |
| 1.39% | `python` | `PyObject_GC_UnTrack` | gc |
| 1.33% | `python` | `PyObject_GC_Track` | gc |
| 1.30% | `python` | `tuple_dealloc` | memory |
| 1.16% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `nm_mpd_qmul` | library |
| 1.16% | `python` | `vgetargskeywords.constprop.0` | calls |
| 1.12% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.11% | `python` | `_Py_dict_lookup` | lookup |
| 1.02% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_baseshiftr` | library |
| 0.96% | `python` | `convertitem.constprop.0` | library |
| 0.96% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qquantize` | library |
| 0.94% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 0.92% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 0.87% | `python` | `_PyArg_UnpackKeywords` | calls |
| 0.87% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `PyDecType_New.isra.0` | library |
| 0.87% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `dec_addstatus` | library |
| 0.81% | `python` | `gc_collect_region.isra.0` | gc |
| 0.76% | `python` | `vgetargs1_impl` | calls |
| 0.73% | `python` | `_PyObject_GC_Link` | gc |
| 0.71% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `dec_dealloc` | library |
| 0.68% | `python` | `PyType_GetBaseByToken` | unknown |
| 0.66% | `python` | `PyCMethod_New` | memory |
| 0.64% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `dec_mpd_qquantize` | library |
| 0.64% | `python` | `PyDict_GetItemRef` | dict |
| 0.63% | `python` | `method_vectorcall_VARARGS_KEYWORDS` | calls |
| 0.63% | `libc-2.31.so` | `__strlen_avx2` | libc |
| 0.62% | `python` | `builtin_print` | unknown |
| 0.61% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qfinalize.part.0` | library |
| 0.59% | `python` | `_Py_NewReference` | memory |
| 0.58% | `python` | `_Py_Dealloc` | memory |
| 0.56% | `python` | `PyUnicode_AsUCS4` | str |
| 0.52% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qshiftr` | library |
| 0.50% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_baseadd` | library |
| 0.48% | `python` | `visit_decref` | gc |
| 0.48% | `python` | `PyObject_Vectorcall` | dynamic |
| 0.48% | `python` | `PyNumber_InPlaceAdd` | dynamic |
| 0.47% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qset_i64` | library |
| 0.44% | `python` | `PyNumber_Multiply` | dynamic |
| 0.44% | `python` | `PyType_IsSubtype` | dynamic |
| 0.44% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_to_string` | library |
| 0.42% | `libc-2.31.so` | `__strchr_avx2` | libc |
| 0.42% | `python` | `PyType_GetModuleByDef` | dynamic |
| 0.40% | `python` | `write_str` | unknown |
| 0.40% | `python` | `meth_dealloc` | memory |
| 0.38% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.38% | `python` | `PyObject_RichCompare` | dynamic |
| 0.38% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `ctx_mpd_qquantize` | library |
| 0.37% | `python` | `r_object` | import |
| 0.36% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `dec_str` | library |
| 0.35% | `python` | `PyFile_WriteObject` | unknown |
| 0.34% | `python` | `binary_op1` | unknown |
| 0.32% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_del` | library |
...
| 0.29% | `_struct.cpython-314-x86_64-linux-gnu.so` | `unpack` | library |
| 0.27% | `python` | `PyObject_CallOneArg` | dynamic |
| 0.27% | `python` | `PyNumber_Add` | dynamic |
| 0.27% | `python` | `PyUnicode_CompareWithASCIIString` | str |
| 0.27% | `python` | `method_get` | dynamic |
| 0.26% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qadd` | library |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 20.96% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 1.81% | `fastbinary.cpython-314-x86_64-linux-gnu.so` | `apache::thrift::py::ProtocolBase<apache::thrift::py::BinaryProtocol>::encodeValue` | library |
| 1.64% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.42% | `python` | `insert_to_emptydict` | dict |
| 1.36% | `python` | `_PyType_LookupRef` | lookup |
| 1.33% | `python` | `dict_dealloc` | memory |
...
| 0.88% | `fastbinary.cpython-314-x86_64-linux-gnu.so` | `apache::thrift::py::ProtocolBase<apache::thrift::py::BinaryProtocol>::decodeValue` | library |
...
| 0.59% | `fastbinary.cpython-314-x86_64-linux-gnu.so` | `apache::thrift::py::ProtocolBase<apache::thrift::py::BinaryProtocol>::readStruct` | library |
...
| 0.51% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 0.50% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 0.50% | `python` | `PyObject_Call` | dynamic |
| 0.48% | `python` | `PyDict_Next` | dict |
...
| 0.43% | `python` | `_PyObject_Call_Prepend` | dynamic |
| 0.43% | `python` | `_PyObject_Calloc` | memory |
| 0.43% | `python` | `unicode_from_format` | str |
| 0.41% | `python` | `PyTuple_New` | memory |
| 0.40% | `fastbinary.cpython-314-x86_64-linux-gnu.so` | `apache::thrift::py::BinaryProtocol::readFieldBegin` | library |
| 0.39% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 0.37% | `python` | `siphash13` | str |
| 0.37% | `python` | `visit_reachable` | gc |
...
| 0.31% | `fastbinary.cpython-314-x86_64-linux-gnu.so` | `apache::thrift::py::parse_struct_item_spec` | library |
| 0.31% | `python` | `PyUnicode_New.part.0` | memory |
| 0.31% | `python` | `PyUnicode_RichCompare` | str |
| 0.30% | `python` | `find_empty_slot` | dict |
| 0.29% | `python` | `_PyType_GetDict` | dynamic |
| 0.29% | `python` | `_PyDict_FromItems` | dict |
| 0.29% | `python` | `update_one_slot` | lookup |
| 0.29% | `python` | `find_first_nonascii` | unknown |
| 0.28% | `python` | `_PyGC_Collect` | gc |
| 0.28% | `python` | `resize_compact` | str |
| 0.27% | `python` | `PyObject_ClearWeakRefs` | dynamic |
| 0.27% | `python` | `list_dealloc` | memory |
| 0.26% | `python` | `_Py_hashtable_get_entry_generic` | lookup |
| 0.26% | `python` | `convertitem.constprop.0` | library |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 48.80% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 5.41% | `python` | `set_lookkey` | miscobj |
| 2.87% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 2.64% | `python` | `_PyUnicode_Equal` | str |
| 2.02% | `python` | `_Py_dict_lookup` | lookup |
| 1.90% | `python` | `_PySet_Contains` | miscobj |
| 1.82% | `python` | `_PyObject_Malloc` | memory |
| 1.61% | `python` | `_PyLong_Add` | int |
| 1.60% | `python` | `_PyLong_FromMedium` | int |
...
| 1.08% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
| 0.91% | `python` | `_PyTuple_FromStackRefSteal` | tuple |
| 0.83% | `python` | `tuple_dealloc` | memory |
| 0.80% | `python` | `replace` | str |
| 0.78% | `python` | `_PyIncrementalNewlineDecoder_decode` | memory |
| 0.77% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.72% | `python` | `_PyUnicode_FromUCS4.part.0` | str |
| 0.59% | `python` | `_Py_NewReference` | memory |
| 0.59% | `python` | `_PyType_LookupRef` | lookup |
| 0.58% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 27.06% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.24% | `python` | `_PyObject_Malloc` | memory |
| 3.11% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 2.87% | `python` | `_Py_dict_lookup` | lookup |
| 2.85% | `python` | `_PyObject_Free` | memory |
| 2.75% | `python` | `tuple_dealloc` | memory |
| 2.43% | `python` | `weakref___new__` | memory |
| 2.31% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.98% | `python` | `_PyObject_MakeTpCall` | dynamic |
| 1.76% | `python` | `_PyType_LookupRefAndVersion` | unknown |
| 1.58% | `python` | `PyArg_UnpackTuple` | calls |
...
| 0.75% | `python` | `set_lookkey` | miscobj |
| 0.69% | `python` | `type_call` | dynamic |
...
| 0.37% | `python` | `wrap_descr_get` | unknown |
| 0.36% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.35% | `python` | `PyObject_GetAttr` | dynamic |
| 0.35% | `python` | `find_name_in_mro` | lookup |
...
| 0.30% | `python` | `_PyGC_Collect` | gc |
| 0.30% | `python` | `weakref_richcompare` | unknown |
...
| 0.27% | `python` | `_PyCode_Quicken` | interpreter |
| 0.27% | `python` | `lru_cache_make_key` | unknown |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 48.62% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.32% | `python` | `_Py_dict_lookup` | lookup |
| 2.64% | `python` | `_PyObject_Malloc` | memory |
| 2.12% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 2.04% | `python` | `PyObject_IsTrue` | dynamic |
...
| 1.07% | `python` | `_io_BytesIO_read` | unknown |
...
| 0.78% | `python` | `find_first_nonascii` | unknown |
| 0.76% | `python` | `PyBytes_FromStringAndSize` | str |
| 0.73% | `python` | `PyLong_AsSsize_t` | int |
| 0.71% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.68% | `python` | `_PyEvalFramePushAndInit` | interpreter |
| 0.66% | `python` | `PyUnicode_Decode.part.0` | str |
| 0.65% | `python` | `_Py_convert_optional_to_ssize_t` | unknown |
| 0.61% | `python` | `siphash13` | str |
...
| 0.35% | `python` | `list_append` | list |
| 0.34% | `python` | `unicode_vectorcall` | str |
| 0.30% | `python` | `r_object` | import |
| 0.30% | `python` | `PyUnicode_FromEncodedObject` | str |
| 0.30% | `python` | `PyUnicode_New.part.0` | memory |
| 0.28% | `python` | `tuple_dealloc` | memory |
...
| 2.47% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `normal_contentTok` | library |
| 2.39% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `normal_updatePosition` | library |
| 1.81% | `python` | `_Py_dict_lookup` | lookup |
| 1.47% | `python` | `visit_add_to_container` | gc |
| 1.47% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `accountingDiffTolerated.part.0` | library |
| 1.46% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `sip24_update` | library |
| 1.29% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 1.22% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.19% | `python` | `_PyGC_Collect` | gc |
| 1.13% | `python` | `_io_TextIOWrapper_write` | unknown |
| 1.12% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `normal_nameLength` | library |
| 1.06% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `doContent` | library |
| 0.98% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.98% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `lookup.constprop.0` | library |
| 0.94% | `python` | `initialize_locals` | interpreter |
| 0.90% | `python` | `gc_collect_region.isra.0` | gc |
| 0.89% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 0.88% | `python` | `find_first_nonascii` | unknown |
...
| 0.64% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `normal_getAtts` | library |
| 0.62% | `python` | `_PyEvalFramePushAndInit` | interpreter |
| 0.62% | `python` | `_PyEval_Vector` | interpreter |
| 0.62% | `python` | `_Py_Dealloc` | memory |
| 0.61% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `treebuilder_handle_start` | library |
| 0.61% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `expat_end_handler` | library |
| 0.60% | `python` | `visit_decref` | gc |
| 0.60% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `elementiter_next` | library |
| 0.58% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `sip24_final` | library |
| 0.55% | `python` | `getset_get` | dynamic |
| 0.55% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `storeAtts` | library |
| 0.55% | `python` | `_copy_characters.part.0.constprop.0` | str |
...
| 0.44% | `python` | `_PyObject_GC_New` | gc |
| 0.44% | `python` | `PyObject_VectorcallMethod` | dynamic |
| 0.42% | `python` | `PyType_IsSubtype` | dynamic |
| 0.39% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `element_gc_traverse` | library |
...
| 0.30% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `element_getitem` | library |
| 0.29% | `python` | `_PyObject_GC_Link` | gc |
| 0.28% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `makeuniversal.isra.0` | library |
...
| 0.26% | `python` | `_PyObject_Realloc` | memory |
| 0.25% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `expat_start_handler` | library |
...
| ---: | :--- | :--- |
| 28.49% | python | _PyEval_EvalFrameDefault |
| 1.41% | python | _PyFrame_ClearExceptCode |
| 0.78% | python | initialize_locals |
| 0.67% | python | _PyEval_FrameClearAndPop |
| 0.42% | python | _PyEvalFramePushAndInit |
| 0.27% | python | _PyThreadState_PopFrame |
| 0.26% | python | _PyEval_Vector |
...
| 0.07% | python | _PyCode_New |
| 0.05% | python | _Py_call_instrumentation_line |
| 0.05% | python | _PyPegen_expect_token |
| 0.04% | python | _PyPegen_update_memo |
| 0.02% | python | _PyCode_Validate |
| 0.02% | python | _PyEval_GetAwaitable |
| 0.02% | python | _PyFrame_Traverse |
...
| 0.06% | python | context_tp_dealloc |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 2.26% | python | gc_collect_region.isra.0 |
| 1.26% | python | visit_decref |
| 1.21% | python | visit_add_to_container |
| 1.10% | python | visit_reachable |
| 0.97% | python | _PyGC_Collect |
| 0.56% | python | PyObject_GC_UnTrack |
| 0.42% | python | dict_traverse |
| 0.38% | python | PyObject_GC_Del |
| 0.27% | python | _PyObject_GC_New |
| 0.25% | python | list_traverse |
| 0.21% | python | _PyObject_GC_Link |
| 0.19% | python | subtype_traverse |
| 0.15% | python | _PyObject_GC_NewVar |
| 0.11% | python | func_traverse |
| 0.11% | python | PyObject_IS_GC |
| 0.07% | python | set_traverse |
| 0.06% | python | type_is_gc |
| 0.06% | python | tuple_traverse |
| 0.06% | python | _PyTuple_MaybeUntrack |
| 0.05% | python | type_traverse |
| 0.04% | python | PyObject_GC_Track |
...
| 0.83% | libz.so.1.2.11 | crc32_combine64 |
| 0.72% | python | sre_ucs2_charset.isra.0 |
| 0.34% | _json.cpython-314-x86_64-linux-gnu.so | scanstring_unicode |
...
| 0.16% | _json.cpython-314-x86_64-linux-gnu.so | scan_once_unicode |
| 0.14% | python | sre_ucs1_count |
| 0.08% | tracer.cpython-314-x86_64-linux-gnu.so | CTracer_trace |
| 0.08% | _json.cpython-314-x86_64-linux-gnu.so | py_encode_basestring_ascii |
| 0.07% | python | convertitem.constprop.0 |
| 0.06% | libsqlite3.so.0.8.6 | sqlite3_reset |
| 0.06% | ld-2.31.so | do_lookup_x |
| 0.05% | libm-2.31.so | __cos_fma |
| 0.05% | libm-2.31.so | __ieee754_pow_fma |
...
| 0.03% | _json.cpython-314-x86_64-linux-gnu.so | encoder_listencode_obj |
...
| 0.03% | _asyncio.cpython-314-x86_64-linux-gnu.so | TaskObj_traverse |
| 0.03% | _heapq.cpython-314-x86_64-linux-gnu.so | siftup |
...
| 0.02% | fastbinary.cpython-314-x86_64-linux-gnu.so | apache::thrift::py::ProtocolBase<apache::thrift::py::BinaryProtocol>::encodeValue |
...
| 0.02% | _asyncio.cpython-314-x86_64-linux-gnu.so | future_init |
| 0.01% | libpthread-2.31.so | __errno_location |
| 0.01% | _asyncio.cpython-314-x86_64-linux-gnu.so | _asyncio_Task___init__ |
| 0.01% | _decimal.cpython-314-x86_64-linux-gnu.so | nm_mpd_qmul |
| 0.01% | array.cpython-314-x86_64-linux-gnu.so | d_setitem |
| 0.01% | pyexpat.cpython-314-x86_64-linux-gnu.so | normal_nameLength |
...
| 0.01% | libpthread-2.31.so | __pthread_rwlock_unlock |
...
| 0.00% | _pickle.cpython-314-x86_64-linux-gnu.so | PyMemoTable_Set |
| 0.00% | _struct.cpython-314-x86_64-linux-gnu.so | s_pack_internal.isra.0 |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 2.64% | python | unicodekeys_lookup_unicode |
| 1.80% | python | _Py_dict_lookup |
| 0.88% | python | _PyType_LookupRef |
| 0.27% | python | find_name_in_mro |
| 0.25% | python | update_one_slot |
| 0.22% | python | _Py_hashtable_get_entry_generic |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.40% | python | PyObject_RichCompareBool |
| 0.35% | python | PyType_IsSubtype |
| 0.34% | python | PyObject_GenericGetAttr |
| 0.31% | python | PyObject_Hash |
| 0.26% | python | PyObject_GetAttr |
| 0.22% | python | _PyObject_GenericGetAttrWithDict |
| 0.17% | python | PyNumber_AsSsize_t |
| 0.17% | python | _PyObject_GetMethod |
| 0.17% | python | _PyObject_TryGetInstanceAttribute |
| 0.16% | python | type_ready |
| 0.16% | python | _PyObject_MakeTpCall |
| 0.15% | python | _PyType_GetDict |
| 0.13% | python | PyObject_IsTrue |
| 0.13% | python | PyObject_Malloc |
| 0.12% | python | PyObject_GetItem |
| 0.12% | python | PyObject_Vectorcall |
| 0.11% | python | PyObject_GetOptionalAttr |
| 0.11% | python | PyObject_ClearManagedDict |
| 0.10% | python | PyObject_GetIter |
| 0.10% | python | PyObject_VisitManagedDict |
| 0.09% | python | PyObject_Free |
...
| 0.04% | python | _PyObject_Call_Prepend |
...
| 0.03% | python | _PyObject_ClearFreeLists |
...
| 0.03% | python | _PyObject_InitInlineValues |
...
| 0.01% | python | PyObject_GenericGetDict |
...
| 0.00% | python | PyObject_LengthHint |
| 0.00% | python | PyObject_CallMethodObjArgs |
| 0.00% | python | PyObject_Repr |
| 0.00% | python | type_setattro |
| 0.00% | python | PyObject_DelItem |
| 0.00% | python | PyNumber_InPlaceXor |
...
| ---: | :--- | :--- |
| 0.85% | python | k_mul |
| 0.42% | python | x_divrem |
| 0.29% | python | _PyLong_Add |
| 0.28% | python | _PyLong_FromMedium |
...
| 0.00% | python | PyLong_FromDouble |
| 0.00% | python | _PyLong_FromByteArray.constprop.1 |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.47% | python | _PyType_LookupRefAndVersion |
| 0.10% | python | find_first_nonascii |
| 0.08% | python | new_dict.isra.0 |
...
| 0.01% | python | _Py_GetBaseCodeUnit |
...
| 0.01% | python | _Py_GetErrorHandler |
| 0.01% | python | _PyIO_find_line_ending |
...
| 0.01% | python | 0x0000000000082770 |
| 0.01% | python | setitem_take2_lock_held |
| 0.01% | python | slot_tp_iter |
| 0.01% | python | _PyCompile_EnsureArrayLargeEnough |
...
| 0.00% | python | _PyInterpreterState_GetConfig |
...
| 0.00% | python | do_strip |
| 0.00% | python | slot_sq_length |
| 0.00% | python | ThreadHandle_join |
...
| 0.00% | python | wrapperdescr_get |
| 0.00% | python | _PyCfg_ToInstructionSequence |
| 0.00% | python | _Py_SetImmortal |
| 0.00% | python | label_exception_targets |
| 0.00% | python | _Py_Specialize_ToBool |
| 0.00% | python | _Py_slot_tp_getattr_hook |
| 0.00% | python | gallop_left |
| 0.00% | python | _PyLexer_token_setup |
| 0.00% | python | gen_close |
| 0.00% | python | do_mktuple |
| 0.00% | python | cm_descr_get |
| 0.00% | python | _buffered_readline |
...
| 0.00% | python | simple_stmt_rule |
| 0.00% | python | insert_split_value.isra.0 |
| 0.00% | python | builtin_eval |
...
| 0.01% | [kernel.kallsyms] | memcg_kmem_get_cache |
...
| 0.01% | [kernel.kallsyms] | htree_dirblock_to_tree |
...
| 0.00% | [kernel.kallsyms] | _raw_spin_lock_irqsave |
...
| 0.00% | [kernel.kallsyms] | __alloc_file |
...
| 0.00% | [kernel.kallsyms] | perf_event_mmap |
...
| 0.00% | [kernel.kallsyms] | __sched_text_start |
...
| 0.20% | python | dictiter_iternextkey |
| 0.18% | python | dict_setdefault_ref_lock_held |
| 0.15% | python | build_indices_unicode |
| 0.15% | python | insert_to_emptydict |
| 0.14% | python | _PyDict_GetItemRef_KnownHash |
| 0.12% | python | find_empty_slot |
| 0.11% | python | dict_get |
| 0.07% | python | dictiter_iternextitem |
| 0.07% | python | PyDict_SetItem |
| 0.07% | python | _PyDict_FromItems |
| 0.07% | python | PyDict_Next |
| 0.04% | python | dictresize |
| 0.04% | python | _PyDict_SetItem_Take2 |
| 0.04% | python | dict_merge |
| 0.04% | python | PyDict_Contains |
| 0.04% | python | _PyDict_LoadGlobalStackRef |
| 0.03% | python | dict_subscript |
| 0.03% | python | clone_combined_dict_keys.isra.0 |
| 0.03% | python | _PyDict_LoadBuiltinsFromGlobals |
| 0.03% | python | PyDict_Clear |
| 0.02% | python | PyDict_GetItemWithError |
...
| 0.01% | python | _PyUnicodeWriter_WriteStr |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.50% | libc-2.31.so | __memcpy_avx_unaligned_erms |
| 0.42% | libc-2.31.so | __memset_avx2_unaligned_erms |
| 0.25% | libc-2.31.so | _int_malloc |
| 0.15% | libc-2.31.so | __memcmp_avx2_movbe |
| 0.14% | libc-2.31.so | __strlen_avx2 |
| 0.13% | libc-2.31.so | _int_free |
| 0.11% | libc-2.31.so | __libc_malloc |
...
| 0.02% | libc-2.31.so | __gconv_transform_utf8_internal |
...
| 0.01% | libc-2.31.so | __dcigettext |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.43% | python | set_lookkey |
| 0.26% | python | PySlice_AdjustIndices |
| 0.13% | python | set_add_entry |
| 0.10% | python | setiter_iternext |
| 0.10% | python | set_issubset_impl |
| 0.09% | python | make_gen |
| 0.09% | python | _PyBuildSlice_ConsumeRefs |
| 0.08% | python | gen_iternext |
| 0.07% | python | _PySet_Contains |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.43% | python | tuple_hash |
| 0.29% | python | _PyTuple_FromArray.part.0 |
| 0.28% | python | _PyTuple_FromStackRefSteal |
| 0.06% | python | tuple_richcompare |
...
| 0.01% | python | _PyTuple_FromArraySteal |
...
| 0.07% | python | list_iter |
| 0.06% | python | PyList_Append |
| 0.06% | python | list_remove |
...
| 0.02% | python | _PyList_FromStackRefSteal |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.29% | python | _PyFloat_FromDouble_ConsumeInputs |
| 0.09% | python | float_div |
| 0.08% | python | PyFloat_FromDouble |
...
| 0.06% | python | _PyFunction_Vectorcall |
