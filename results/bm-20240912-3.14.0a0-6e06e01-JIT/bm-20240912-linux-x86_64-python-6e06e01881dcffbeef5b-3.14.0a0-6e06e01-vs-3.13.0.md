...
Benchmark hidden because not significant (3): asyncio_websockets, async_tree_cpu_io_mixed, async_tree_io
...
| json_dumps                 | 10.4 ms                                                | 10.1 ms: 1.03x faster                                                 |
| pyflate                    | 460 ms                                                 | 448 ms: 1.02x faster                                                  |
| regex_effbot               | 3.88 ms                                                | 3.80 ms: 1.02x faster                                                 |
| regex_v8                   | 25.3 ms                                                | 24.7 ms: 1.02x faster                                                 |
| unpickle                   | 14.9 us                                                | 14.6 us: 1.02x faster                                                 |
| regex_dna                  | 220 ms                                                 | 216 ms: 1.02x faster                                                  |
...
| coroutines                 | 22.5 ms                                                | 22.9 ms: 1.02x slower                                                 |
| logging_simple             | 5.66 us                                                | 5.75 us: 1.02x slower                                                 |
...
Benchmark hidden because not significant (8): logging_format, html5lib, asyncio_websockets, bench_mp_pool, pickle, async_tree_cpu_io_mixed, pprint_safe_repr, async_tree_io
