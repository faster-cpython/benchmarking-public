...
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| 2to3           | 202 ms                                                 | 186 ms: 1.09x faster                                                  |
...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20221009-darwin-arm64-python-281a3f18cc2afac0fa92-3.12.0a0-281a3f1 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| nbody          | 94.1 ms                                                | 64.3 ms: 1.46x faster                                                 |
...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20221009-darwin-arm64-python-281a3f18cc2afac0fa92-3.12.0a0-281a3f1 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| regex_compile  | 96.6 ms                                                | 76.5 ms: 1.26x faster                                                 |
...
| json_dumps           | 8.38 ms                                                | 6.17 ms: 1.36x faster                                                 |
...
| xml_etree_iterparse  | 72.6 ms                                                | 64.6 ms: 1.12x faster                                                 |
...
| Benchmark              | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20221009-darwin-arm64-python-281a3f18cc2afac0fa92-3.12.0a0-281a3f1 |
|------------------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| python_startup         | 12.6 ms                                                | 9.38 ms: 1.34x faster                                                 |
| python_startup_no_site | 9.73 ms                                                | 7.41 ms: 1.31x faster                                                 |
...
| Benchmark               | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20221009-darwin-arm64-python-281a3f18cc2afac0fa92-3.12.0a0-281a3f1 |
|-------------------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| deltablue               | 5.15 ms                                                | 2.74 ms: 1.88x faster                                                 |
...
| spectral_norm           | 96.4 ms                                                | 72.5 ms: 1.33x faster                                                 |
| chaos                   | 66.8 ms                                                | 50.4 ms: 1.33x faster                                                 |
| tornado_http            | 91.9 ms                                                | 69.4 ms: 1.32x faster                                                 |
...
| regex_compile           | 96.6 ms                                                | 76.5 ms: 1.26x faster                                                 |
| sqlalchemy_imperative   | 9.03 ms                                                | 7.16 ms: 1.26x faster                                                 |
| django_template         | 27.3 ms                                                | 21.7 ms: 1.26x faster                                                 |
| unpickle_pure_python    | 203 us                                                 | 162 us: 1.26x faster                                                  |
...
| sqlalchemy_declarative  | 74.8 ms                                                | 61.0 ms: 1.23x faster                                                 |
| docutils                | 1.78 sec                                               | 1.47 sec: 1.21x faster                                                |
...
| unpack_sequence         | 38.7 ns                                                | 33.5 ns: 1.15x faster                                                 |
...
| telco                   | 3.68 ms                                                | 3.32 ms: 1.11x faster                                                 |
...
| unpickle_list           | 2.66 us                                                | 2.54 us: 1.05x faster                                                 |
| json_loads              | 16.9 us                                                | 16.3 us: 1.04x faster                                                 |
| meteor_contest          | 78.6 ms                                                | 76.2 ms: 1.03x faster                                                 |
...
Ignored benchmarks (13) of results/bm-20220323-3.10.4-9d38120/bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120.json: aiohttp, asyncio_tcp, asyncio_tcp_ssl, comprehensions, create_gc_cycles, dask, flaskblogging, gc_traversal, gunicorn, mypy2, richards_super, tomli_loads, typing_runtime_protocols
Ignored benchmarks (1) of results/bm-20221009-3.12.0a0-281a3f1/bm-20221009-darwin-arm64-python-281a3f18cc2afac0fa92-3.12.0a0-281a3f1.json: mypy
