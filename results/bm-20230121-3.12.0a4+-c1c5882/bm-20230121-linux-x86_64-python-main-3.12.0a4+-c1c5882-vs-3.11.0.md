...
Benchmark hidden because not significant (8): scimark_lu, django_template, async_tree_none, bench_mp_pool, xml_etree_parse, async_tree_cpu_io_mixed, meteor_contest, unpickle
