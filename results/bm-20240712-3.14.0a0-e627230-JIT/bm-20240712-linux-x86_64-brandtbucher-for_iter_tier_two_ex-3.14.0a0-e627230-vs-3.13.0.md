...
| Benchmark      | bm-20241007-linux-x86_64-python-v3.13.0-3.13.0-60403a5 | bm-20240712-linux-x86_64-brandtbucher-for_iter_tier_two_ex-3.14.0a0-e627230 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------------:|
...
| Benchmark                 | bm-20241007-linux-x86_64-python-v3.13.0-3.13.0-60403a5 | bm-20240712-linux-x86_64-brandtbucher-for_iter_tier_two_ex-3.14.0a0-e627230 |
|---------------------------|:------------------------------------------------------:|:---------------------------------------------------------------------------:|
| deepcopy_memo             | 38.0 us                                                | 28.5 us: 1.34x faster                                                       |
...
| richards_super            | 54.4 ms                                                | 48.3 ms: 1.13x faster                                                       |
| float                     | 78.5 ms                                                | 69.7 ms: 1.13x faster                                                       |
| tomli_loads               | 2.11 sec                                               | 1.90 sec: 1.11x faster                                                      |
...
| nqueens                   | 80.6 ms                                                | 86.7 ms: 1.07x slower                                                       |
...
Benchmark hidden because not significant (5): async_tree_cpu_io_mixed, async_tree_cpu_io_mixed_tg, bench_mp_pool, thrift, async_tree_io
...
- Reliability score: 58.76% likely to be faster
