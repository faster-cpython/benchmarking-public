...
- Geometric mean: 1.00x slower (HPT: reliability of 71.90%, 1.00x faster at 99th %ile)
- Memory usage: 1.07x
...
- Geometric mean: 1.00x slower (HPT: reliability of 91.93%, 1.00x slower at 99th %ile)
- Memory usage: 0.98x
...
- [📄table](bm-20240923-linux-x86_64-savannahostrowski-jit_inv_mem_1m-3.14.0a0-062c54f-vs-3.13.0b2.md)
- [📈time plot](bm-20240923-linux-x86_64-savannahostrowski-jit_inv_mem_1m-3.14.0a0-062c54f-vs-3.13.0b2.svg)
