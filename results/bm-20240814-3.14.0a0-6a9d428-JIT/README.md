...
- Geometric mean: 1.01x faster (HPT: reliability of 52.17%, 1.00x slower at 99th %ile)
- Memory usage: 1.06x
...
- [📄table](bm-20240814-linux-x86_64-savannahostrowski-jit_mem_2-3.14.0a0-6a9d428-vs-3.13.0.md)
- [📈time plot](bm-20240814-linux-x86_64-savannahostrowski-jit_mem_2-3.14.0a0-6a9d428-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x slower (HPT: reliability of 94.19%, 1.00x slower at 99th %ile)
- Memory usage: 0.98x
