...
| nbody          | 142 ms                                                 | 93.5 ms: 1.51x faster                                                      |
...
| xml_etree_generate   | 94.2 ms                                                | 78.2 ms: 1.21x faster                                                      |
...
| Benchmark              | bm-20220323-linux-x86_64-python-v3.10.4-3.10.4-9d38120 | bm-20230118-linux-x86_64-brandtbucher-quicken_at_runtime-3.12.0a4+-30a2b7d |
|------------------------|:------------------------------------------------------:|:--------------------------------------------------------------------------:|
| python_startup         | 14.2 ms                                                | 8.71 ms: 1.62x faster                                                      |
...
| telco                   | 6.54 ms                                                | 6.32 ms: 1.03x faster                                                      |
| regex_dna               | 222 ms                                                 | 216 ms: 1.03x faster                                                       |
