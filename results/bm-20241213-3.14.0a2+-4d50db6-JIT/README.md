...
- [GitHub Action run](https://github.com/faster-cpython/benchmarking/actions/runs/12303440056)
...
- Geometric mean: 1.031x faster (HPT: reliability of 93.32%, 1.00x faster at 99th %ile)
- Memory usage: 1.04x
