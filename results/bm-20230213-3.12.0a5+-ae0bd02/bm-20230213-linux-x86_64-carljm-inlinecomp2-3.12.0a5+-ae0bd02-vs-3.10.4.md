...
|----------------|:------------------------------------------------------:|:-------------------------------------------------------------:|
| 2to3           | 332 ms                                                 | 245 ms: 1.35x faster                                          |
...
| nbody          | 136 ms                                                 | 99.9 ms: 1.36x faster                                         |
...
| pickle_pure_python      | 453 us                                                 | 286 us: 1.59x faster                                          |
| spectral_norm           | 148 ms                                                 | 93.5 ms: 1.58x faster                                         |
| python_startup          | 13.9 ms                                                | 8.89 ms: 1.57x faster                                         |
...
| async_tree_none         | 713 ms                                                 | 507 ms: 1.40x faster                                          |
...
| genshi_xml              | 63.6 ms                                                | 46.8 ms: 1.36x faster                                         |
| 2to3                    | 332 ms                                                 | 245 ms: 1.35x faster                                          |
| sqlglot_normalize       | 135 ms                                                 | 99.7 ms: 1.35x faster                                         |
| tornado_http            | 128 ms                                                 | 94.9 ms: 1.35x faster                                         |
...
| docutils                | 3.18 sec                                               | 2.54 sec: 1.25x faster                                        |
| nqueens                 | 99.3 ms                                                | 79.7 ms: 1.25x faster                                         |
...
| unpickle                | 14.3 us                                                | 13.2 us: 1.08x faster                                         |
| regex_dna               | 214 ms                                                 | 200 ms: 1.07x faster                                          |
| telco                   | 6.68 ms                                                | 6.33 ms: 1.05x faster                                         |
| async_generators        | 428 ms                                                 | 414 ms: 1.03x faster                                          |
| pickle                  | 10.1 us                                                | 10.0 us: 1.01x faster                                         |
| pidigits                | 190 ms                                                 | 189 ms: 1.00x faster                                          |
| unpickle_list           | 4.99 us                                                | 5.04 us: 1.01x slower                                         |
| pickle_dict             | 28.3 us                                                | 30.7 us: 1.08x slower                                         |
