...
| pickle_list         | 5.01 us                                                | 5.05 us: 1.01x slower                                                 |
...
| unpack_sequence            | 42.4 ns                                                | 111 ns: 2.61x slower                                                  |
| Geometric mean             | (ref)                                                  | 1.00x faster                                                          |

Benchmark hidden because not significant (7): chaos, pickle, unpickle_pure_python, bench_mp_pool, unpickle, asyncio_websockets, async_tree_io
