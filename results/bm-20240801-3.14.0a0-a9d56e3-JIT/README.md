...
- Geometric mean: 1.01x faster (HPT: reliability of 52.49%, 1.00x faster at 99th %ile)
- Memory usage: 0.99x
- missing benchmarks: aiohttp, chameleon, dulwich_log, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlalchemy_declarative, sqlalchemy_imperative, sqlite_synth, unpack_sequence, unpickle, unpickle_list
- new benchmarks: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, thrift
...
- Geometric mean: 1.01x faster (HPT: reliability of 70.86%, 1.00x faster at 99th %ile)
- Memory usage: 1.07x
- missing benchmarks: aiohttp, chameleon, dulwich_log, flaskblogging, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlite_synth, unpickle, unpickle_list
...
- Geometric mean: 1.05x faster (HPT: reliability of 82.13%, 1.00x faster at 99th %ile)
- Memory usage: unknown
...
- Geometric mean: 1.04x faster (HPT: reliability of 88.97%, 1.00x slower at 99th %ile)
- Memory usage: unknown
