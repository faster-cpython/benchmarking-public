...
- Geometric mean: 1.36x faster (HPT: reliability of 100.00%, 1.18x faster at 99th %ile)
- Memory usage: 1.37x
...
- Geometric mean: 1.03x faster (HPT: reliability of 95.53%, 1.00x faster at 99th %ile)
- Memory usage: 1.18x
...
- Geometric mean: 1.04x slower (HPT: reliability of 96.99%, 1.00x slower at 99th %ile)
- Memory usage: 1.22x
...
- [📄table](bm-20240903-linux-x86_64-brandtbucher-ujb0_project-3.14.0a0-8b9b14d-vs-3.13.0b2.md)
- [📈time plot](bm-20240903-linux-x86_64-brandtbucher-ujb0_project-3.14.0a0-8b9b14d-vs-3.13.0b2.svg)
