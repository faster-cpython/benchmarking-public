...
- Geometric mean: 1.03x faster (HPT: reliability of 97.60%, 1.00x faster at 99th %ile)
- Memory usage: 0.93x
...
- Geometric mean: 1.03x faster (HPT: reliability of 92.31%, 1.00x faster at 99th %ile)
- Memory usage: 0.93x
- missing benchmarks: aiohttp, chameleon, dulwich_log, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlalchemy_declarative, sqlalchemy_imperative, sqlite_synth, unpack_sequence, unpickle, unpickle_list
- new benchmarks: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, thrift
...
- Geometric mean: 1.10x slower (HPT: reliability of 100.00%, 1.10x slower at 99th %ile)
- Memory usage: unknown
...
- Geometric mean: 1.10x faster (HPT: reliability of 98.99%, 1.00x faster at 99th %ile)
- Memory usage: unknown
- missing benchmarks: aiohttp, chameleon, dask, flaskblogging, mypy2, pickle, pickle_dict, pickle_list, sqlalchemy_declarative, sqlalchemy_imperative, sqlite_synth, unpack_sequence, unpickle, unpickle_list
- new benchmarks: async_tree_cpu_io_mixed_tg, async_tree_io_tg, async_tree_memoization_tg, async_tree_none_tg
...
- Geometric mean: 1.01x faster (HPT: reliability of 99.61%, 1.00x slower at 99th %ile)
- Memory usage: 0.47x
