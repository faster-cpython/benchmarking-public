...
- Geometric mean: 1.01x faster (HPT: reliability of 53.58%, 1.00x faster at 99th %ile)
- Memory usage: 1.08x
...
- [📄table](bm-20240725-linux-x86_64-brandtbucher-exit_if-3.14.0a0-b298d3a-vs-3.13.0.md)
- [📈time plot](bm-20240725-linux-x86_64-brandtbucher-exit_if-3.14.0a0-b298d3a-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x slower (HPT: reliability of 86.19%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
