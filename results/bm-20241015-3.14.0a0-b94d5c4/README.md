...
- [📄table](bm-20241015-linux-x86_64-efimov%252dmikhail-crash_fix_generators-3.14.0a0-b94d5c4-vs-3.13.0b2.md)
- [📈time plot](bm-20241015-linux-x86_64-efimov%252dmikhail-crash_fix_generators-3.14.0a0-b94d5c4-vs-3.13.0b2.svg)

### vs. base

- Geometric mean: 1.00x faster (HPT: reliability of 60.72%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
