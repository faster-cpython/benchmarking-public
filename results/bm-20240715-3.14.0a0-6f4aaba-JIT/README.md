...
- Geometric mean: 1.01x faster (HPT: reliability of 63.79%, 1.00x faster at 99th %ile)
- Memory usage: 1.07x
...
- [📄table](bm-20240715-linux-x86_64-brandtbucher-tier_two_improvement-3.14.0a0-6f4aaba-vs-3.13.0.md)
- [📈time plot](bm-20240715-linux-x86_64-brandtbucher-tier_two_improvement-3.14.0a0-6f4aaba-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.01x slower (HPT: reliability of 96.50%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
