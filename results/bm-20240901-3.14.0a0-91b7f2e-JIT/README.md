...
- Geometric mean: 1.01x faster (HPT: reliability of 87.87%, 1.00x faster at 99th %ile)
- Memory usage: 1.09x
...
- [📄table](bm-20240901-linux-x86_64-python-91b7f2e7f6593acefda4-3.14.0a0-91b7f2e-vs-3.13.0b2.md)
- [📈time plot](bm-20240901-linux-x86_64-python-91b7f2e7f6593acefda4-3.14.0a0-91b7f2e-vs-3.13.0b2.svg)
