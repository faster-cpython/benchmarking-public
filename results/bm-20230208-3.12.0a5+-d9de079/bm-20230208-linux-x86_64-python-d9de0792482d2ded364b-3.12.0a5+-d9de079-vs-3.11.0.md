...
| regex_effbot   | 3.46 ms                                                | 3.33 ms: 1.04x faster                                                  |
...
| python_startup_no_site | 6.04 ms                                                | 6.43 ms: 1.07x slower                                                  |
...
Benchmark hidden because not significant (9): unpickle, coverage, async_tree_none, chameleon, spectral_norm, djangocms, bench_mp_pool, thrift, unpickle_list
