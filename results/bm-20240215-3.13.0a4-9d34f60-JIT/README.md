...
- Geometric mean: 1.01x faster (HPT: reliability of 72.88%, 1.00x slower at 99th %ile)
- Memory usage: 0.97x
...
- Geometric mean: 1.02x slower (HPT: reliability of 96.43%, 1.00x slower at 99th %ile)
- Memory usage: 1.03x
...
- Geometric mean: 1.00x slower (HPT: reliability of 92.10%, 1.00x slower at 99th %ile)
- Memory usage: unknown
- missing benchmarks: 🔴 aiohttp, django_template, flaskblogging, genshi_text, genshi_xml, html5lib, pylint, thrift
- new benchmarks: dask, unpack_sequence
...
- Geometric mean: 1.09x faster (HPT: reliability of 99.93%, 1.03x faster at 99th %ile)
- Memory usage: unknown
...
- Geometric mean: 1.01x slower (HPT: reliability of 87.52%, 1.00x slower at 99th %ile)
- Memory usage: 1.14x
- missing benchmarks: aiohttp, django_template, gunicorn, sqlalchemy_declarative, sqlalchemy_imperative
...
- Geometric mean: 1.00x slower (HPT: reliability of 56.67%, 1.00x faster at 99th %ile)
- Memory usage: 5.78x
...
- Geometric mean: 1.00x slower (HPT: reliability of 89.19%, 1.00x slower at 99th %ile)
- Memory usage: 1.96x
- missing benchmarks: 🔴 aiohttp, async_tree_eager, async_tree_eager_cpu_io_mixed, async_tree_eager_cpu_io_mixed_tg, async_tree_eager_io, async_tree_eager_io_tg, async_tree_eager_memoization, async_tree_eager_memoization_tg, async_tree_eager_tg, bpe_tokeniser, django_template, flaskblogging, genshi_text, genshi_xml, gunicorn, html5lib, pylint, thrift
- new benchmarks: dask
