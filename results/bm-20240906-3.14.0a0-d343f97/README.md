...
- Geometric mean: 1.01x faster (HPT: reliability of 96.21%, 1.00x faster at 99th %ile)
- Memory usage: 1.01x
...
- [📄table](bm-20240906-linux-x86_64-python-main-3.14.0a0-d343f97-vs-3.13.0b2.md)
- [📈time plot](bm-20240906-linux-x86_64-python-main-3.14.0a0-d343f97-vs-3.13.0b2.svg)
