...
- Geometric mean: 1.01x faster (HPT: reliability of 91.12%, 1.00x faster at 99th %ile)
- Memory usage: 1.01x
...
- [📄table](bm-20240816-linux-x86_64-faster%252dcpython-specialize_shadowed_-3.14.0a0-b0f4953-vs-3.13.0.md)
- [📈time plot](bm-20240816-linux-x86_64-faster%252dcpython-specialize_shadowed_-3.14.0a0-b0f4953-vs-3.13.0.svg)
