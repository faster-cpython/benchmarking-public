...
| Benchmark      | bm-20241007-linux-x86_64-python-v3.13.0-3.13.0-60403a5 | bm-20240820-linux-x86_64-python-f88c14d412522587085a-3.14.0a0-f88c14d |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
Benchmark hidden because not significant (7): thrift, asyncio_websockets, chaos, bench_mp_pool, pickle_pure_python, unpickle_pure_python, pprint_safe_repr
...
- Reliability score: 67.35% likely to be faster
