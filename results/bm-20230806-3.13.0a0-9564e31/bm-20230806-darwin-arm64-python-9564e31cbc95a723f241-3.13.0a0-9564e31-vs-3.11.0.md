...
| Benchmark            | bm-20221024-darwin-arm64-python-v3.11.0-3.11.0-deaf509 | bm-20230806-darwin-arm64-python-9564e31cbc95a723f241-3.13.0a0-9564e31 |
|----------------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| json_dumps           | 7.63 ms                                                | 6.70 ms: 1.14x faster                                                 |
...
| xml_etree_iterparse  | 70.1 ms                                                | 76.6 ms: 1.09x slower                                                 |
...
| Benchmark              | bm-20221024-darwin-arm64-python-v3.11.0-3.11.0-deaf509 | bm-20230806-darwin-arm64-python-9564e31cbc95a723f241-3.13.0a0-9564e31 |
|------------------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| python_startup_no_site | 10.2 ms                                                | 9.12 ms: 1.11x faster                                                 |
...
| Benchmark                | bm-20221024-darwin-arm64-python-v3.11.0-3.11.0-deaf509 | bm-20230806-darwin-arm64-python-9564e31cbc95a723f241-3.13.0a0-9564e31 |
|--------------------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| typing_runtime_protocols | 336 us                                                 | 93.4 us: 3.60x faster                                                 |
...
| sqlglot_parse            | 959 us                                                 | 924 us: 1.04x faster                                                  |
| async_tree_io            | 704 ms                                                 | 680 ms: 1.04x faster                                                  |
| regex_v8                 | 16.1 ms                                                | 15.6 ms: 1.03x faster                                                 |
| regex_effbot             | 2.63 ms                                                | 2.54 ms: 1.03x faster                                                 |
...
| pickle_pure_python       | 201 us                                                 | 203 us: 1.01x slower                                                  |
| pickle_list              | 2.81 us                                                | 2.85 us: 1.01x slower                                                 |
| pycparser                | 698 ms                                                 | 709 ms: 1.02x slower                                                  |
| meteor_contest           | 73.5 ms                                                | 75.0 ms: 1.02x slower                                                 |
| spectral_norm            | 72.6 ms                                                | 74.1 ms: 1.02x slower                                                 |
| pickle                   | 7.15 us                                                | 7.38 us: 1.03x slower                                                 |
...
| xml_etree_parse          | 108 ms                                                 | 112 ms: 1.04x slower                                                  |
| scimark_lu               | 73.3 ms                                                | 76.3 ms: 1.04x slower                                                 |
...
| sqlglot_normalize        | 171 ms                                                 | 192 ms: 1.13x slower                                                  |
| float                    | 53.0 ms                                                | 59.7 ms: 1.13x slower                                                 |
| logging_silent           | 68.1 ns                                                | 76.8 ns: 1.13x slower                                                 |
| sqlglot_optimize         | 31.1 ms                                                | 35.4 ms: 1.14x slower                                                 |
| pathlib                  | 27.2 ms                                                | 31.2 ms: 1.14x slower                                                 |
| scimark_monte_carlo      | 46.5 ms                                                | 53.6 ms: 1.15x slower                                                 |
| richards                 | 32.2 ms                                                | 37.2 ms: 1.15x slower                                                 |
| pyflate                  | 310 ms                                                 | 359 ms: 1.16x slower                                                  |
| xml_etree_process        | 35.1 ms                                                | 40.8 ms: 1.16x slower                                                 |
| unpickle_list            | 2.65 us                                                | 3.16 us: 1.19x slower                                                 |
| xml_etree_generate       | 48.3 ms                                                | 58.9 ms: 1.22x slower                                                 |
...
Benchmark hidden because not significant (2): async_tree_cpu_io_mixed, tornado_http
