...
- Geometric mean: 1.20x faster (HPT: reliability of 100.00%, 1.06x faster at 99th %ile)
- Memory usage: 1.25x
...
- Geometric mean: 1.07x slower (HPT: reliability of 99.99%, 1.02x slower at 99th %ile)
- Memory usage: 1.01x
...
- Geometric mean: 1.00x slower (HPT: reliability of 76.02%, 1.00x slower at 99th %ile)
- Memory usage: 1.07x
...
- Geometric mean: 1.02x faster (HPT: reliability of 72.43%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
- missing benchmarks: aiohttp, chameleon, dask, dulwich_log, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlalchemy_declarative, sqlalchemy_imperative, sqlite_synth, unpack_sequence, unpickle, unpickle_list
- new benchmarks: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, thrift
...
- Geometric mean: 1.01x faster (HPT: reliability of 74.95%, 1.00x faster at 99th %ile)
- Memory usage: 1.08x
- missing benchmarks: aiohttp, chameleon, dask, dulwich_log, flaskblogging, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlite_synth, unpickle, unpickle_list
...
- Geometric mean: 1.02x slower (HPT: reliability of 92.43%, 1.00x slower at 99th %ile)
- Memory usage: 1.08x
...
- Geometric mean: 1.05x faster (HPT: reliability of 92.77%, 1.00x faster at 99th %ile)
- Memory usage: 0.60x
