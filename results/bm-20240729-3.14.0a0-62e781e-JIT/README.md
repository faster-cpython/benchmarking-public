...
- Geometric mean: 1.01x faster (HPT: reliability of 51.78%, 1.00x slower at 99th %ile)
- Memory usage: 1.09x
...
- [📄table](bm-20240729-linux-x86_64-brandtbucher-no_progress_needed-3.14.0a0-62e781e-vs-3.13.0.md)
- [📈time plot](bm-20240729-linux-x86_64-brandtbucher-no_progress_needed-3.14.0a0-62e781e-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x slower (HPT: reliability of 97.83%, 1.00x slower at 99th %ile)
- Memory usage: 1.02x
