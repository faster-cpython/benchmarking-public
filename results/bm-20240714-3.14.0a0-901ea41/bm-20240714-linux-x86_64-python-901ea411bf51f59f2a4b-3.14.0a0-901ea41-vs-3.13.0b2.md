...
| Benchmark      | bm-20240605-linux-x86_64-python-v3.13.0b2-3.13.0b2-3a83b17 | bm-20240714-linux-x86_64-python-901ea411bf51f59f2a4b-3.14.0a0-901ea41 |
|----------------|:----------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| async_tree_io              | 939 ms                                                     | 835 ms: 1.13x faster                                                  |
...
| hexiom                     | 6.30 ms                                                    | 6.05 ms: 1.04x faster                                                 |
...
| telco                      | 8.41 ms                                                    | 8.20 ms: 1.03x faster                                                 |
| django_template            | 34.8 ms                                                    | 33.9 ms: 1.03x faster                                                 |
...
Benchmark hidden because not significant (3): pylint, coverage, bench_mp_pool
