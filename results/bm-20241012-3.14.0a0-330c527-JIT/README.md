...
- Geometric mean: 1.08x faster (HPT: reliability of 99.92%, 1.02x faster at 99th %ile)
- Memory usage: 1.24x
...
- Geometric mean: 1.18x slower (HPT: reliability of 100.00%, 1.05x slower at 99th %ile)
- Memory usage: 0.98x
...
- Geometric mean: 1.03x faster (HPT: reliability of 97.96%, 1.00x faster at 99th %ile)
- Memory usage: 1.03x
- missing benchmarks: aiohttp, async_tree_cpu_io_mixed, async_tree_cpu_io_mixed_tg, async_tree_io, async_tree_io_tg, async_tree_memoization, async_tree_memoization_tg, async_tree_none, async_tree_none_tg, chameleon, dask, gunicorn, mypy2, sqlalchemy_declarative, sqlalchemy_imperative
...
- Geometric mean: 1.02x slower (HPT: reliability of 60.81%, 1.00x slower at 99th %ile)
- Memory usage: 1.07x
...
- Geometric mean: 1.02x slower (HPT: reliability of 69.41%, 1.00x slower at 99th %ile)
- Memory usage: 1.06x
...
- Geometric mean: 1.10x slower (HPT: reliability of 92.87%, 1.00x slower at 99th %ile)
- Memory usage: 0.98x
- missing benchmarks: aiohttp, async_tree_cpu_io_mixed, async_tree_cpu_io_mixed_tg, async_tree_io, async_tree_io_tg, async_tree_memoization, async_tree_memoization_tg, async_tree_none, async_tree_none_tg, chameleon, dask, gunicorn, mypy2, sqlalchemy_declarative, sqlalchemy_imperative
- new benchmarks: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, thrift
...
- Geometric mean: 1.08x slower (HPT: reliability of 78.89%, 1.00x slower at 99th %ile)
- Memory usage: 1.08x
- missing benchmarks: aiohttp, async_tree_cpu_io_mixed, async_tree_cpu_io_mixed_tg, async_tree_io, async_tree_io_tg, async_tree_memoization, async_tree_memoization_tg, async_tree_none, async_tree_none_tg, chameleon, dask, flaskblogging, gunicorn, mypy2
...
- Geometric mean: 1.03x slower (HPT: reliability of 89.58%, 1.00x slower at 99th %ile)
- Memory usage: 1.06x
...
- Geometric mean: 1.08x faster (HPT: reliability of 83.05%, 1.00x faster at 99th %ile)
- Memory usage: unknown
...
- Geometric mean: 1.07x faster (HPT: reliability of 99.81%, 1.00x faster at 99th %ile)
- Memory usage: unknown
...
- Geometric mean: 1.01x faster (HPT: reliability of 82.77%, 1.00x faster at 99th %ile)
- Memory usage: 0.73x
- missing benchmarks: aiohttp, async_tree_cpu_io_mixed, async_tree_cpu_io_mixed_tg, async_tree_io, async_tree_io_tg, async_tree_memoization, async_tree_memoization_tg, async_tree_none, async_tree_none_tg, chameleon, dask, gunicorn, mypy2, sqlalchemy_declarative, sqlalchemy_imperative
- new benchmarks: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, thrift
