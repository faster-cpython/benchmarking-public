...
- Geometric mean: 1.00x slower (HPT: reliability of 81.14%, 1.00x faster at 99th %ile)
- Memory usage: 1.09x
...
- Geometric mean: 1.00x slower (HPT: reliability of 60.89%, 1.00x slower at 99th %ile)
- Memory usage: 1.01x
...
- [📄table](bm-20240913-linux-x86_64-brandtbucher-deopt_tracing_32-3.14.0a0-a7a7e7f-vs-3.13.0b2.md)
- [📈time plot](bm-20240913-linux-x86_64-brandtbucher-deopt_tracing_32-3.14.0a0-a7a7e7f-vs-3.13.0b2.svg)
