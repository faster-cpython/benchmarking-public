...
- Geometric mean: 1.03x faster (HPT: reliability of 57.35%, 1.00x faster at 99th %ile)
- Memory usage: 0.93x
...
- [📄table](bm-20240819-pythonperf2-x86_64-faster%252dcpython-specialize_call_ex-3.14.0a0-852115b-vs-3.13.0.md)
- [📈time plot](bm-20240819-pythonperf2-x86_64-faster%252dcpython-specialize_call_ex-3.14.0a0-852115b-vs-3.13.0.svg)
