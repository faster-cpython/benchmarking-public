...
| django_template | 32.6 ms                                                | 32.8 ms: 1.00x slower                                  |
| Geometric mean  | (ref)                                                  | 1.04x faster                                           |
...
Benchmark hidden because not significant (7): djangocms, unpickle, chameleon, async_tree_none, sqlglot_transpile, bench_mp_pool, go
