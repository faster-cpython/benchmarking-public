...
- Geometric mean: 1.13x faster (HPT: reliability of 99.87%, 1.01x faster at 99th %ile)
- Memory usage: 1.15x
...
- [📄table](bm-20240814-pythonperf2-x86_64-faster%252dcpython-specialize_call_kw-3.14.0a0-6b9055c-vs-3.13.0.md)
- [📈time plot](bm-20240814-pythonperf2-x86_64-faster%252dcpython-specialize_call_kw-3.14.0a0-6b9055c-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x slower (HPT: reliability of 68.00%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
