...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230503-linux-x86_64-python-e95dd40aff35775efce4-3.12.0a7+-e95dd40 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| async_tree_io           | 1.30 sec                                               | 1.22 sec: 1.07x faster                                                 |
| nbody                   | 93.1 ms                                                | 87.5 ms: 1.06x faster                                                  |
...
Benchmark hidden because not significant (4): logging_silent, bench_mp_pool, create_gc_cycles, xml_etree_iterparse
