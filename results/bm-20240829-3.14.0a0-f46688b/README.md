...
- Geometric mean: 1.45x faster (HPT: reliability of 100.00%, 1.34x faster at 99th %ile)
- Memory usage: 1.22x
...
- [📄table](bm-20240829-linux-x86_64-mdboom-mimalloc-3.14.0a0-f46688b-vs-3.13.0b2.md)
- [📈time plot](bm-20240829-linux-x86_64-mdboom-mimalloc-3.14.0a0-f46688b-vs-3.13.0b2.svg)
