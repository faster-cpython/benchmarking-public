...
| async_tree_eager                 | 70.1 ms                                                | 60.0 ms: 1.17x faster                                                 |
...
| Benchmark      | bm-20241007-darwin-arm64-python-v3.13.0-3.13.0-60403a5 | bm-20240824-darwin-arm64-python-e38d0afe3548b856ccf0-3.14.0a0-e38d0af |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| nbody          | 74.0 ms                                                | 59.5 ms: 1.25x faster                                                 |
...
| json_dumps           | 6.52 ms                                                | 6.30 ms: 1.03x faster                                                 |
...
| regex_compile                    | 78.6 ms                                                | 67.5 ms: 1.16x faster                                                 |
| logging_simple                   | 3.60 us                                                | 3.09 us: 1.16x faster                                                 |
...
| sympy_sum                        | 75.4 ms                                                | 68.6 ms: 1.10x faster                                                 |
...
| xml_etree_generate               | 57.0 ms                                                | 53.1 ms: 1.07x faster                                                 |
| crypto_pyaes                     | 54.2 ms                                                | 50.8 ms: 1.07x faster                                                 |
| regex_effbot                     | 2.63 ms                                                | 2.46 ms: 1.07x faster                                                 |
| python_startup_no_site           | 14.5 ms                                                | 13.6 ms: 1.06x faster                                                 |
...
Benchmark hidden because not significant (6): async_tree_none_tg, async_tree_cpu_io_mixed, telco, pathlib, pylint, tornado_http
...
Ignored benchmarks (2) of results/bm-20240824-3.14.0a0-e38d0af/bm-20240824-darwin-arm64-python-e38d0afe3548b856ccf0-3.14.0a0-e38d0af.json: asyncio_tcp, asyncio_tcp_ssl
