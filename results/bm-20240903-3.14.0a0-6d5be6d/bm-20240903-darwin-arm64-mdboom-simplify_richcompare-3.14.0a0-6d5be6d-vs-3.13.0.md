...
| Benchmark      | bm-20241007-darwin-arm64-python-v3.13.0-3.13.0-60403a5 | bm-20240903-darwin-arm64-mdboom-simplify_richcompare-3.14.0a0-6d5be6d |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| async_tree_eager_tg              | 47.8 ms                                                | 41.5 ms: 1.15x faster                                                 |
...
| async_tree_io_tg                 | 497 ms                                                 | 582 ms: 1.17x slower                                                  |
...
| xml_etree_generate   | 57.0 ms                                                | 53.3 ms: 1.07x faster                                                 |
...
| async_tree_none                  | 215 ms                                                 | 193 ms: 1.12x faster                                                  |
| typing_runtime_protocols         | 101 us                                                 | 91.2 us: 1.11x faster                                                 |
...
| regex_effbot                     | 2.63 ms                                                | 2.46 ms: 1.07x faster                                                 |
| tomli_loads                      | 1.57 sec                                               | 1.48 sec: 1.06x faster                                                |
| dulwich_log                      | 28.5 ms                                                | 27.0 ms: 1.05x faster                                                 |
| python_startup_no_site           | 14.5 ms                                                | 13.8 ms: 1.05x faster                                                 |
...
Benchmark hidden because not significant (6): async_tree_cpu_io_mixed, xml_etree_iterparse, pylint, async_tree_none_tg, xml_etree_parse, tornado_http
...
Ignored benchmarks (2) of results/bm-20240903-3.14.0a0-6d5be6d/bm-20240903-darwin-arm64-mdboom-simplify_richcompare-3.14.0a0-6d5be6d.json: asyncio_tcp, asyncio_tcp_ssl
