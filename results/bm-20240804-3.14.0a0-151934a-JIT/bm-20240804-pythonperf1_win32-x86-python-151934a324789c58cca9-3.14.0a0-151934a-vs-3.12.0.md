...
| Benchmark      | bm-20231002-pythonperf1_win32-x86-python-v3.12.0-3.12.0-0fb18b0 | bm-20240804-pythonperf1_win32-x86-python-151934a324789c58cca9-3.14.0a0-151934a |
|----------------|:---------------------------------------------------------------:|:------------------------------------------------------------------------------:|
| nbody          | 127 ms                                                          | 56.0 ms: 2.27x faster                                                          |
...
| scimark_sor                | 130 ms                                                          | 68.3 ms: 1.90x faster                                                          |
| mako                       | 9.96 ms                                                         | 5.45 ms: 1.83x faster                                                          |
| float                      | 76.7 ms                                                         | 42.9 ms: 1.79x faster                                                          |
...
| scimark_monte_carlo        | 66.4 ms                                                         | 43.7 ms: 1.52x faster                                                          |
...
| richards_super             | 46.5 ms                                                         | 39.2 ms: 1.19x faster                                                          |
...
| mdp                        | 1.91 sec                                                        | 1.75 sec: 1.10x faster                                                         |
...
Ignored benchmarks (5) of results/bm-20240804-3.14.0a0-151934a-JIT/bm-20240804-pythonperf1_win32-x86-python-151934a324789c58cca9-3.14.0a0-151934a.json: genshi_text, genshi_xml, html5lib, pylint, thrift
