...
| Frees | 25,671 |  |
| New values | 1,100 |  |
| Interpreter increfs | 114,240 | 65.4% |
| Interpreter decrefs | 134,460 | 64.2% |
| Increfs | 60,306 | 34.6% |
| Decrefs | 74,850 | 35.8% |
...
| Method cache hits | 15,571 |  |
| Method cache misses | 1,769 |  |
| Method cache collisions | 2,127 |  |
| Method cache dunder hits | 6,387 |  |
| Method cache dunder misses | 953 |  |
