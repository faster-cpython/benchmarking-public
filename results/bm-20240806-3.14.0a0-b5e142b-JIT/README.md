...
- Geometric mean: 1.01x faster (HPT: reliability of 75.21%, 1.00x faster at 99th %ile)
- Memory usage: 1.08x
...
- [📄table](bm-20240806-linux-x86_64-python-b5e142ba7c2063efe9bb-3.14.0a0-b5e142b-vs-3.13.0.md)
- [📈time plot](bm-20240806-linux-x86_64-python-b5e142ba7c2063efe9bb-3.14.0a0-b5e142b-vs-3.13.0.svg)
