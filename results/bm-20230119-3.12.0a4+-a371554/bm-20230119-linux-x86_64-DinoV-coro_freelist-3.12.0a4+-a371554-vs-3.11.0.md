...
Benchmark hidden because not significant (11): async_tree_cpu_io_mixed, unpickle, async_tree_none, pathlib, xml_etree_iterparse, django_template, bench_mp_pool, thrift, regex_effbot, unpickle_list, scimark_lu
