...
| Benchmark      | bm-20220323-linux-x86_64-python-v3.10.4-3.10.4-9d38120 | bm-20230505-linux-x86_64-python-45a9e3834a6ed20ee250-3.12.0a7+-45a9e38 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| json_loads           | 28.8 us                                                | 26.3 us: 1.09x faster                                                  |
...
| logging_format          | 8.91 us                                                | 7.14 us: 1.25x faster                                                  |
| 2to3                    | 336 ms                                                 | 271 ms: 1.24x faster                                                   |
...
| create_gc_cycles        | 1.67 ms                                                | 1.48 ms: 1.12x faster                                                  |
