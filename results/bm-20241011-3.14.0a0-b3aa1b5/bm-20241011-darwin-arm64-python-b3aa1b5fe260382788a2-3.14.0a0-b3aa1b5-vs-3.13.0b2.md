...
| Benchmark      | bm-20240605-darwin-arm64-python-v3.13.0b2-3.13.0b2-3a83b17 | bm-20241011-darwin-arm64-python-b3aa1b5fe260382788a2-3.14.0a0-b3aa1b5 |
|----------------|:----------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| async_tree_eager                 | 60.3 ms                                                    | 59.8 ms: 1.01x faster                                                 |
...
Benchmark hidden because not significant (7): async_tree_memoization, async_tree_none_tg, async_tree_io_tg, async_tree_eager_memoization_tg, async_tree_cpu_io_mixed_tg, async_tree_memoization_tg, async_tree_eager_memoization
...
| regex_effbot   | 2.58 ms                                                    | 2.66 ms: 1.03x slower                                                 |
...
| json_dumps           | 6.23 ms                                                    | 7.19 ms: 1.16x slower                                                 |
| Geometric mean       | (ref)                                                      | 1.02x slower                                                          |
...
| mako            | 6.99 ms                                                    | 6.86 ms: 1.02x faster                                                 |
...
| thrift                           | 435 us                                                     | 413 us: 1.05x faster                                                  |
| mdp                              | 1.53 sec                                                   | 1.46 sec: 1.05x faster                                                |
| json                             | 2.93 ms                                                    | 2.83 ms: 1.04x faster                                                 |
...
| scimark_lu                       | 66.9 ms                                                    | 67.3 ms: 1.01x slower                                                 |
| sqlglot_transpile                | 891 us                                                     | 896 us: 1.01x slower                                                  |
| xml_etree_process                | 37.1 ms                                                    | 37.3 ms: 1.01x slower                                                 |
| pycparser                        | 632 ms                                                     | 637 ms: 1.01x slower                                                  |
...
| bench_mp_pool                    | 47.2 ms                                                    | 49.5 ms: 1.05x slower                                                 |
...
Benchmark hidden because not significant (18): async_tree_memoization, richards_super, asyncio_tcp_ssl, sympy_expand, unpickle, genshi_xml, telco, dulwich_log, sqlglot_normalize, async_tree_none_tg, async_tree_io_tg, sqlglot_optimize, async_tree_eager_memoization_tg, async_tree_cpu_io_mixed_tg, async_tree_memoization_tg, async_tree_eager_memoization, pylint, tornado_http
...
Ignored benchmarks (1) of results/bm-20241011-3.14.0a0-b3aa1b5/bm-20241011-darwin-arm64-python-b3aa1b5fe260382788a2-3.14.0a0-b3aa1b5.json: unpack_sequence
