...
- Geometric mean: 1.00x slower (HPT: reliability of 54.26%, 1.00x faster at 99th %ile)
- Memory usage: 1.64x
...
- [📄table](bm-20240920-linux-x86_64-Fidget%252dSpinner-partial_evaluator_un-3.14.0a0-aaab6a6-vs-3.13.0b2.md)
- [📈time plot](bm-20240920-linux-x86_64-Fidget%252dSpinner-partial_evaluator_un-3.14.0a0-aaab6a6-vs-3.13.0b2.svg)
