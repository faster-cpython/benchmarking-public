...
- Geometric mean: 1.00x faster (HPT: reliability of 76.09%, 1.00x faster at 99th %ile)
- Memory usage: 1.08x
...
- [📄table](bm-20240912-linux-x86_64-brandtbucher-deopt_tracing-3.14.0a0-282ab23-vs-3.13.0b2.md)
- [📈time plot](bm-20240912-linux-x86_64-brandtbucher-deopt_tracing-3.14.0a0-282ab23-vs-3.13.0b2.svg)
