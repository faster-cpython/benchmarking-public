...
- Geometric mean: 1.06x faster (HPT: reliability of 99.89%, 1.01x faster at 99th %ile)
- Memory usage: 1.08x
...
- Geometric mean: 1.01x slower (HPT: reliability of 57.78%, 1.00x slower at 99th %ile)
- Memory usage: 1.11x
...
- [📄table](bm-20240907-linux-x86_64-brandtbucher-underflow_known-3.14.0a0-8763a2d-vs-3.13.0b2.md)
- [📈time plot](bm-20240907-linux-x86_64-brandtbucher-underflow_known-3.14.0a0-8763a2d-vs-3.13.0b2.svg)
