...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230620-linux-x86_64-brandtbucher-to_bool-3.13.0a0-a0bd53a |
|----------------|:------------------------------------------------------:|:--------------------------------------------------------------:|
...
| Benchmark            | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230620-linux-x86_64-brandtbucher-to_bool-3.13.0a0-a0bd53a |
|----------------------|:------------------------------------------------------:|:--------------------------------------------------------------:|
| json_dumps           | 12.6 ms                                                | 10.2 ms: 1.23x faster                                          |
...
| async_tree_none          | 526 ms                                                 | 486 ms: 1.08x faster                                           |
| async_tree_io            | 1.30 sec                                               | 1.21 sec: 1.07x faster                                         |
| coverage                 | 100 ms                                                 | 93.5 ms: 1.07x faster                                          |
| async_tree_memoization   | 627 ms                                                 | 593 ms: 1.06x faster                                           |
...
Benchmark hidden because not significant (3): logging_simple, xml_etree_iterparse, bench_mp_pool
