...
| regex_effbot               | 3.88 ms                                                | 3.73 ms: 1.04x faster                                                 |
| pathlib                    | 17.1 ms                                                | 16.5 ms: 1.03x faster                                                 |
| xml_etree_iterparse        | 102 ms                                                 | 98.9 ms: 1.03x faster                                                 |
...
Benchmark hidden because not significant (6): async_tree_memoization, chaos, unpickle_pure_python, asyncio_websockets, bench_mp_pool, pickle_pure_python
