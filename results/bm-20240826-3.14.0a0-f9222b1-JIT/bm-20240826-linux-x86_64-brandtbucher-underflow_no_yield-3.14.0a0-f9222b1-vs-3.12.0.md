...
| Benchmark      | bm-20231002-linux-x86_64-python-v3.12.0-3.12.0-0fb18b0 | bm-20240826-linux-x86_64-brandtbucher-underflow_no_yield-3.14.0a0-f9222b1 |
|----------------|:------------------------------------------------------:|:-------------------------------------------------------------------------:|
...
| nbody                      | 97.0 ms                                                | 80.8 ms: 1.20x faster                                                     |
| richards                   | 45.8 ms                                                | 38.3 ms: 1.20x faster                                                     |
| float                      | 84.7 ms                                                | 71.2 ms: 1.19x faster                                                     |
...
Benchmark hidden because not significant (4): tornado_http, bench_mp_pool, json, regex_effbot
...
Ignored benchmarks (6) of results/bm-20240826-3.14.0a0-f9222b1-JIT/bm-20240826-linux-x86_64-brandtbucher-underflow_no_yield-3.14.0a0-f9222b1.json: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, thrift
