...
| Increfs | 227,001,132 | 97.8% |
| Decrefs | 239,248,113 | 96.9% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 3,235,926 |  |
| Method cache misses | 860,194 |  |
| Method cache collisions | 901,139 |  |
| Method cache dunder hits | 7,331,767 |  |
| Method cache dunder misses | 41,033 |  |
