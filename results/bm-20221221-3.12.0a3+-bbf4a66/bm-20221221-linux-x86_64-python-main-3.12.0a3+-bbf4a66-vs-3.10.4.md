...
| float                   | 108 ms                                                 | 71.9 ms: 1.50x faster                                  |
| generators              | 75.8 ms                                                | 78.3 ms: 1.03x slower                                  |
| genshi_text             | 30.6 ms                                                | 20.0 ms: 1.53x faster                                  |
| genshi_xml              | 63.6 ms                                                | 46.3 ms: 1.37x faster                                  |
...
| logging_silent          | 173 ns                                                 | 93.0 ns: 1.86x faster                                  |
| logging_simple          | 8.06 us                                                | 5.69 us: 1.41x faster                                  |
| mako                    | 14.3 ms                                                | 9.46 ms: 1.51x faster                                  |
...
| sympy_expand            | 537 ms                                                 | 447 ms: 1.20x faster                                   |
...
Benchmark hidden because not significant (3): bench_mp_pool, unpickle, unpickle_list
