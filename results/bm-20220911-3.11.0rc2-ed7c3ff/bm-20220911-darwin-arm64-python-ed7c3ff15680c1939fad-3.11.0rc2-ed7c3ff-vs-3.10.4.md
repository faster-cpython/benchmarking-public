...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20220911-darwin-arm64-python-ed7c3ff15680c1939fad-3.11.0rc2-ed7c3ff |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| nbody          | 94.1 ms                                                | 65.5 ms: 1.44x faster                                                  |
...
| pickle               | 7.36 us                                                | 7.17 us: 1.03x faster                                                  |
...
| scimark_sor             | 127 ms                                                 | 82.9 ms: 1.53x faster                                                  |
...
| pprint_safe_repr        | 609 ms                                                 | 463 ms: 1.31x faster                                                   |
| deepcopy_memo           | 34.5 us                                                | 26.3 us: 1.31x faster                                                  |
| pprint_pformat          | 1.24 sec                                               | 948 ms: 1.31x faster                                                   |
| django_template         | 27.3 ms                                                | 21.0 ms: 1.30x faster                                                  |
| tornado_http            | 91.9 ms                                                | 70.9 ms: 1.30x faster                                                  |
| xml_etree_process       | 45.1 ms                                                | 35.0 ms: 1.29x faster                                                  |
| unpickle_pure_python    | 203 us                                                 | 158 us: 1.29x faster                                                   |
...
| aiohttp                 | 1.29 ms                                                | 1.05 ms: 1.24x faster                                                  |
| mako                    | 10.5 ms                                                | 8.51 ms: 1.23x faster                                                  |
...
| genshi_text             | 18.4 ms                                                | 15.3 ms: 1.20x faster                                                  |
| sqlalchemy_declarative  | 74.8 ms                                                | 62.8 ms: 1.19x faster                                                  |
| async_generators        | 233 ms                                                 | 196 ms: 1.19x faster                                                   |
| gunicorn                | 1.34 ms                                                | 1.13 ms: 1.19x faster                                                  |
...
| nqueens                 | 68.1 ms                                                | 61.7 ms: 1.10x faster                                                  |
| sympy_sum               | 94.3 ms                                                | 85.8 ms: 1.10x faster                                                  |
...
| regex_dna               | 160 ms                                                 | 151 ms: 1.06x faster                                                   |
| json_loads              | 16.9 us                                                | 16.1 us: 1.05x faster                                                  |
| pathlib                 | 28.8 ms                                                | 27.6 ms: 1.05x faster                                                  |
