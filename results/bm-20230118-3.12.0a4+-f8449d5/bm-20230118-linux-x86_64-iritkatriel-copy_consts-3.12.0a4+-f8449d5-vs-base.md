...
Benchmark hidden because not significant (14): async_tree_none, async_tree_cpu_io_mixed, bench_mp_pool, coverage, djangocms, fannkuch, mypy, scimark_fft, scimark_sparse_mat_mult, sqlite_synth, telco, thrift, unpickle_list, xml_etree_parse
