...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230625-linux-x86_64-python-main-3.13.0a0-bef1c87 |
|----------------|:------------------------------------------------------:|:-----------------------------------------------------:|
...
| chaos                    | 69.2 ms                                                | 59.4 ms: 1.17x faster                                 |
| regex_effbot             | 3.99 ms                                                | 3.48 ms: 1.15x faster                                 |
...
| scimark_monte_carlo      | 68.1 ms                                                | 71.1 ms: 1.04x slower                                 |
...
Benchmark hidden because not significant (6): scimark_sor, scimark_lu, xml_etree_iterparse, pprint_pformat, deepcopy_memo, bench_mp_pool
