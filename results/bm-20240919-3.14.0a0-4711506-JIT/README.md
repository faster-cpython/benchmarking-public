...
- Geometric mean: 1.00x slower (HPT: reliability of 51.25%, 1.00x slower at 99th %ile)
- Memory usage: 1.09x
...
- Geometric mean: 1.00x slower (HPT: reliability of 97.57%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
...
- [📄table](bm-20240919-linux-x86_64-brandtbucher-decref_escapes-3.14.0a0-4711506-vs-3.13.0b2.md)
- [📈time plot](bm-20240919-linux-x86_64-brandtbucher-decref_escapes-3.14.0a0-4711506-vs-3.13.0b2.svg)
