...
- Geometric mean: 1.05x slower (HPT: reliability of 88.63%, 1.00x slower at 99th %ile)
- Memory usage: 1.09x
...
- [📄table](bm-20240713-linux-x86_64-brandtbucher-no_progress_needed-3.14.0a0-363fca1-vs-3.13.0.md)
- [📈time plot](bm-20240713-linux-x86_64-brandtbucher-no_progress_needed-3.14.0a0-363fca1-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.06x slower (HPT: reliability of 99.84%, 1.00x slower at 99th %ile)
- Memory usage: 1.03x
