...
| float          | 55.8 ms                                                | 57.4 ms: 1.03x slower                                                 |
...
| mako            | 7.75 ms                                                | 9.04 ms: 1.17x slower                                                 |
...
Benchmark hidden because not significant (4): xml_etree_iterparse, dask, asyncio_websockets, sympy_integrate
