...
| Benchmark      | bm-20221024-darwin-arm64-python-v3.11.0-3.11.0-deaf509 | bm-20230618-darwin-arm64-python-6baddd9fb25e03040c1c-3.12.0b2+-6baddd9 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
| Benchmark            | bm-20221024-darwin-arm64-python-v3.11.0-3.11.0-deaf509 | bm-20230618-darwin-arm64-python-6baddd9fb25e03040c1c-3.12.0b2+-6baddd9 |
|----------------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| json_dumps           | 7.63 ms                                                | 6.34 ms: 1.20x faster                                                  |
...
| Benchmark              | bm-20221024-darwin-arm64-python-v3.11.0-3.11.0-deaf509 | bm-20230618-darwin-arm64-python-6baddd9fb25e03040c1c-3.12.0b2+-6baddd9 |
|------------------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| python_startup_no_site | 10.2 ms                                                | 9.20 ms: 1.11x faster                                                  |
...
| pickle                   | 7.15 us                                                | 7.39 us: 1.03x slower                                                  |
| sqlalchemy_declarative   | 62.6 ms                                                | 64.8 ms: 1.03x slower                                                  |
...
| sqlglot_optimize         | 31.1 ms                                                | 34.4 ms: 1.10x slower                                                  |
| xml_etree_process        | 35.1 ms                                                | 38.9 ms: 1.11x slower                                                  |
| xml_etree_generate       | 48.3 ms                                                | 56.1 ms: 1.16x slower                                                  |
| unpickle_list            | 2.65 us                                                | 3.17 us: 1.20x slower                                                  |
| pathlib                  | 27.2 ms                                                | 33.4 ms: 1.23x slower                                                  |
...
Ignored benchmarks (1) of /home/runner/work/benchmarking/benchmarking/results/bm-20230618-3.12.0b2+-6baddd9/bm-20230618-darwin-arm64-python-6baddd9fb25e03040c1c-3.12.0b2+-6baddd9.json: dask
