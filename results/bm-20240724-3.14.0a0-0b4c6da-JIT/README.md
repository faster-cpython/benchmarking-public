...
- Geometric mean: 1.01x faster (HPT: reliability of 56.53%, 1.00x faster at 99th %ile)
- Memory usage: 1.08x
...
- [📄table](bm-20240724-linux-x86_64-brandtbucher-load_attr_property-3.14.0a0-0b4c6da-vs-3.13.0.md)
- [📈time plot](bm-20240724-linux-x86_64-brandtbucher-load_attr_property-3.14.0a0-0b4c6da-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x slower (HPT: reliability of 76.31%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
