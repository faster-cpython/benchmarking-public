...
| 0.60% | `python` | `_PyErr_SetObject.part.0` | exceptions |
...
| 0.42% | `python` | `PySlice_AdjustIndices` | miscobj |
...
| 0.35% | `python` | `PyLong_FromString` | int |
| 0.33% | `python` | `find_name_in_mro` | lookup |
| 0.32% | `python` | `PyType_GenericAlloc` | memory |
| 0.32% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
| 0.31% | `python` | `_PyType_LookupRefAndVersion` | lookup |
| 0.29% | `python` | `update_one_slot` | lookup |
...
| ---: | :--- | :--- | :--- |
| 29.00% | `[JIT]` | `jit` | jit |
| 9.40% | `python` | `PySlice_AdjustIndices` | miscobj |
| 5.38% | `python` | `list_subscript` | list |
| 5.11% | `python` | `list_ass_slice_lock_held` | list |
| 4.42% | `python` | `_PyObject_Free` | memory |
| 3.55% | `python` | `_PyObject_Malloc` | memory |
| 3.00% | `python` | `_PyEval_SliceIndex` | interpreter |
| 2.97% | `python` | `list_dealloc` | memory |
| 2.43% | `python` | `PyNumber_AsSsize_t` | dynamic |
| 2.39% | `python` | `PySlice_New` | memory |
| 2.31% | `python` | `_PyLong_Add` | int |
| 2.30% | `python` | `slice_dealloc` | memory |
| 2.12% | `python` | `list_ass_subscript` | list |
| 2.11% | `python` | `PySlice_Unpack` | miscobj |
| 2.08% | `python` | `_PyBuildSlice_ConsumeRefs` | miscobj |
...
| 0.68% | `python` | `_PyLong_Subtract` | int |
| 0.66% | `python` | `list_pop` | list |
...
| 3.95% | `python` | `_PyObject_Malloc` | memory |
| 2.90% | `libm-2.31.so` | `__sin_fma` | library |
| 2.57% | `libm-2.31.so` | `__cos_fma` | library |
| 2.35% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
| 2.01% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.90% | `python` | `subtype_dealloc` | memory |
| 1.89% | `python` | `_PyObject_Free` | memory |
| 1.86% | `python` | `subtype_traverse` | gc |
| 1.67% | `python` | `visit_add_to_container` | gc |
| 1.66% | `python` | `_Py_Dealloc` | memory |
| 1.63% | `python` | `PyFloat_FromDouble` | float |
| 1.60% | `python` | `_PyGC_Collect` | gc |
| 1.54% | `python` | `gc_collect_region.isra.0` | gc |
| 1.46% | `python` | `float_dealloc` | memory |
| 1.34% | `python` | `visit_decref` | gc |
| 1.31% | `python` | `PyNumber_InPlaceTrueDivide` | dynamic |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 22.80% | `python` | `gc_collect_region.isra.0` | gc |
| 15.40% | `python` | `visit_reachable` | gc |
| 14.82% | `python` | `visit_decref` | gc |
| 7.93% | `python` | `visit_add_to_container` | gc |
| 6.89% | `python` | `_PyGC_Collect` | gc |
| 6.34% | `python` | `dict_traverse` | gc |
| 4.10% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 2.16% | `python` | `func_traverse` | gc |
| 1.31% | `python` | `set_traverse` | gc |
| 1.29% | `python` | `type_is_gc` | gc |
| 1.23% | `python` | `subtype_traverse` | gc |
| 1.20% | `python` | `PyObject_VisitManagedDict` | dynamic |
| 0.93% | `python` | `tuple_traverse` | gc |
| 0.75% | `python` | `type_traverse` | gc |
| 0.68% | `python` | `list_traverse` | gc |
| 0.64% | `python` | `_PyObject_Malloc` | memory |
| 0.63% | `python` | `PyObject_IS_GC` | gc |
| 0.49% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 0.41% | `python` | `meth_traverse` | gc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 27.08% | `python` | `visit_reachable` | gc |
| 21.28% | `python` | `visit_decref` | gc |
| 15.38% | `python` | `list_traverse` | gc |
| 11.23% | `python` | `gc_collect_region.isra.0` | gc |
| 5.22% | `python` | `_PyGC_Collect` | gc |
| 3.21% | `python` | `dict_traverse` | gc |
| 1.59% | `[JIT]` | `jit` | jit |
| 1.31% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 1.02% | `python` | `func_traverse` | gc |
| 0.62% | `python` | `type_is_gc` | gc |
| 0.60% | `python` | `set_traverse` | gc |
| 0.55% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 0.52% | `python` | `tuple_traverse` | gc |
| 0.41% | `python` | `type_traverse` | gc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 50.36% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.19% | `python` | `_PyObject_Malloc` | memory |
| 2.62% | `python` | `_PyObject_Free` | memory |
| 1.74% | `python` | `gen_dealloc` | memory |
| 1.46% | `python` | `_PyLong_FromMedium` | int |
...
| 0.82% | `python` | `compute_range_length` | unknown |
| 0.81% | `python` | `make_gen` | miscobj |
| 0.78% | `python` | `_PyType_LookupRefAndVersion` | lookup |
| 0.76% | `python` | `_PyGC_Collect` | gc |
| 0.68% | `python` | `_PySlice_GetLongIndices` | miscobj |
| 0.67% | `python` | `PyNumber_Add` | dynamic |
| 0.67% | `python` | `_PyObject_GC_NewVar` | gc |
| 0.65% | `python` | `long_add_method` | int |
| 0.63% | `python` | `long_richcompare` | int |
| 0.55% | `python` | `_Py_Dealloc` | memory |
| 0.54% | `python` | `long_dealloc` | memory |
| 0.54% | `python` | `slot_tp_iter` | unknown |
...
| 0.50% | `python` | `PyLong_AsLongAndOverflow` | int |
| 0.48% | `python` | `visit_decref` | gc |
| 0.48% | `python` | `PyObject_GC_Del` | gc |
| 0.47% | `python` | `gc_collect_region.isra.0` | gc |
| 0.45% | `python` | `long_mul_method` | int |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 41.11% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 0.42% | `python` | `_PyType_LookupRef` | lookup |
...
| 0.32% | `python` | `dictiter_iternextvalue` | dict |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 47.36% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 17.35% | `[JIT]` | `jit` | jit |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 30.11% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 21.75% | `[JIT]` | `jit` | jit |
| 3.40% | `python` | `PyObject_RichCompareBool` | dynamic |
| 2.22% | `python` | `list_contains` | list |
| 2.03% | `python` | `long_richcompare` | int |
...
| 1.12% | `python` | `gen_iternext` | miscobj |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 36.08% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 6.73% | `python` | `sre_ucs2_charset.isra.0` | library |
| 3.76% | `python` | `gc_collect_region.isra.0` | gc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 10.82% | `_json.cpython-314-x86_64-linux-gnu.so` | `scanstring_unicode` | library |
| 7.49% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 6.30% | `python` | `_PyObject_Malloc` | memory |
| 5.53% | `_json.cpython-314-x86_64-linux-gnu.so` | `scan_once_unicode` | library |
| 5.35% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 5.00% | `python` | `siphash13` | str |
| 4.83% | `python` | `_PyObject_Free` | memory |
| 3.51% | `python` | `_Py_dict_lookup` | lookup |
| 2.56% | `python` | `dict_setdefault_ref_lock_held` | dict |
| 2.07% | `python` | `PyUnicodeWriter_Create` | str |
| 1.95% | `python` | `PyLong_FromString` | int |
| 1.84% | `python` | `PyUnicode_Substring` | str |
| 1.63% | `python` | `PyUnicode_New.part.0` | memory |
| 1.61% | `python` | `insertdict` | dict |
| 1.60% | `python` | `dict_dealloc` | memory |
| 1.38% | `python` | `build_indices_unicode` | dict |
| 1.36% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 1.24% | `python` | `find_empty_slot` | dict |
| 0.96% | `libc-2.31.so` | `_int_malloc` | libc |
| 0.86% | `python` | `unicode_dealloc` | memory |
| 0.85% | `python` | `_Py_Dealloc` | memory |
| 0.74% | `python` | `gc_collect_region.isra.0` | gc |
| 0.70% | `python` | `PyDict_SetItem` | dict |
| 0.67% | `python` | `PyUnicodeWriter_Discard` | str |
| 0.65% | `python` | `_sre_SRE_Pattern_match` | library |
...
| 0.38% | `python` | `PyDict_GetItemRef` | dict |
| 0.37% | `python` | `unicode_hash` | str |
| 0.34% | `python` | `pattern_new_match.isra.0.part.0` | memory |
| 0.34% | `python` | `PyUnicode_Splitlines` | str |
| 0.34% | `python` | `_PyObject_Realloc` | memory |
| 0.33% | `python` | `maybe_small_long` | unknown |
| 0.33% | `python` | `resize_compact` | str |
| 0.32% | `python` | `new_keys_object.constprop.0` | dict |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 11.78% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 6.91% | `python` | `_PyObject_Malloc` | memory |
| 6.57% | `_json.cpython-314-x86_64-linux-gnu.so` | `py_encode_basestring_ascii` | library |
| 4.81% | `python` | `_PyObject_Free` | memory |
| 3.67% | `python` | `PyUnicodeWriter_WriteStr` | str |
| 3.17% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 3.11% | `python` | `_Py_dict_lookup` | lookup |
| 2.68% | `python` | `_copy_characters.part.0.constprop.0` | str |
| 2.64% | `_json.cpython-314-x86_64-linux-gnu.so` | `encoder_listencode_obj` | library |
| 2.35% | `python` | `resize_compact` | str |
| 1.75% | `_json.cpython-314-x86_64-linux-gnu.so` | `encoder_encode_key_value` | library |
| 1.72% | `python` | `PyUnicode_New` | memory |
| 1.61% | `python` | `PyErr_CheckSignals` | exceptions |
| 1.61% | `python` | `vgetargskeywords.constprop.0` | unknown |
| 1.59% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 1.30% | `python` | `PyObject_Str` | dynamic |
| 1.19% | `python` | `convertitem.constprop.0` | unknown |
| 1.14% | `python` | `PyDict_Next` | dict |
| 1.14% | `python` | `_PyObject_Realloc` | memory |
...
| 0.28% | `python` | `PyUnicodeWriter_WriteUTF8` | str |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 12.37% | `_json.cpython-314-x86_64-linux-gnu.so` | `scanstring_unicode` | library |
| 7.78% | `python` | `_PyObject_Malloc` | memory |
| 6.34% | `_json.cpython-314-x86_64-linux-gnu.so` | `scan_once_unicode` | library |
| 6.28% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 5.82% | `python` | `siphash13` | str |
| 5.00% | `python` | `_PyObject_Free` | memory |
| 4.86% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.85% | `python` | `_Py_dict_lookup` | lookup |
| 3.40% | `python` | `PyUnicodeWriter_Create` | str |
| 3.23% | `python` | `PyUnicode_Substring` | str |
| 2.83% | `python` | `PyUnicode_New.part.0` | memory |
| 2.36% | `python` | `dict_setdefault_ref_lock_held` | dict |
| 2.27% | `python` | `PyLong_FromString` | int |
| 2.02% | `python` | `insertdict` | dict |
| 1.32% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 1.17% | `python` | `build_indices_unicode` | dict |
| 1.08% | `python` | `unicode_dealloc` | memory |
| 1.06% | `python` | `find_empty_slot` | dict |
| 1.05% | `python` | `PyUnicodeWriter_Discard` | str |
| 1.03% | `python` | `dict_dealloc` | memory |
| 0.98% | `python` | `_Py_Dealloc` | memory |
| 0.78% | `python` | `PyDict_SetItem` | dict |
| 0.65% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
...
| 0.36% | `python` | `_sre_SRE_Pattern_match` | library |
...
| 0.31% | `python` | `r_object` | import |
| 0.31% | `libc-2.31.so` | `_int_free` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 44.03% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 1.45% | `python` | `PyCode_Addr2Line` | exceptions |
...
| ---: | :--- | :--- | :--- |
| 28.62% | `[JIT]` | `jit` | jit |
| 8.33% | `python` | `replace` | str |
| 5.29% | `python` | `long_to_decimal_string_internal` | int |
| 5.07% | `python` | `_PyObject_Malloc` | memory |
| 4.76% | `python` | `_PyUnicode_JoinArray.part.0` | str |
| 3.68% | `python` | `_PyObject_Free` | memory |
| 3.15% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 2.75% | `python` | `unicode_replace` | str |
| 2.59% | `python` | `deque_append` | miscobj |
| 2.24% | `python` | `dequeiter_next` | miscobj |
| 1.88% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 1.24% | `python` | `_list_extend` | list |
| 1.19% | `python` | `list_dealloc` | memory |
| 1.19% | `python` | `PyUnicode_New` | memory |
| 1.12% | `python` | `PyErr_CheckSignals` | exceptions |
| 0.96% | `python` | `PyObject_Str` | dynamic |
| 0.92% | `python` | `deque_clear.part.0` | miscobj |
| 0.91% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 0.86% | `python` | `sre_ucs2_charset.isra.0` | library |
| 0.81% | `python` | `long_alloc` | memory |
...
| 0.54% | `python` | `_Py_dict_lookup` | lookup |
| 0.50% | `python` | `_Py_Dealloc` | memory |
| 0.47% | `python` | `long_to_decimal_string` | int |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 28.19% | `python` | `tuple_hash` | tuple |
| 14.67% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 13.50% | `python` | `PyObject_Hash` | dynamic |
| 11.20% | `python` | `long_hash` | int |
| 6.36% | `python` | `_Py_dict_lookup` | lookup |
| 2.97% | `python` | `PyObject_RichCompareBool` | dynamic |
| 1.84% | `python` | `tuple_richcompare` | tuple |
| 1.14% | `python` | `dict_subscript` | dict |
| 0.98% | `python` | `_PyLong_GCD` | int |
| 0.90% | `[JIT]` | `jit` | jit |
| 0.88% | `python` | `_PyObject_Malloc` | memory |
...
| 7.38% | `python` | `set_issubset_impl` | miscobj |
| 7.29% | `python` | `set_lookkey` | miscobj |
| 6.01% | `python` | `setiter_iternext` | miscobj |
| 3.17% | `python` | `set_difference` | miscobj |
| 2.99% | `python` | `set_dealloc` | memory |
| 2.64% | `python` | `_PyObject_Malloc` | memory |
| 2.50% | `python` | `PyObject_RichCompareBool` | dynamic |
...
| 0.26% | `python` | `list_ass_slice_lock_held` | list |
...
| ---: | :--- | :--- | :--- |
| 54.96% | `[JIT]` | `jit` | jit |
| 12.60% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
| 4.34% | `libm-2.31.so` | `__ieee754_pow_fma` | library |
| 3.42% | `python` | `_Py_Dealloc` | memory |
| 3.15% | `python` | `float_dealloc` | memory |
| 2.70% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 1.97% | `python` | `_Py_NewReference` | memory |
| 1.28% | `python` | `float_pow` | float |
...
| 0.37% | `libm-2.31.so` | `powf64` | library |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 15.61% | `python` | `gc_collect_region.isra.0` | gc |
| 12.65% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 12.51% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 5.41% | `python` | `dictiter_iternextkey` | dict |
| 5.30% | `python` | `set_lookkey` | miscobj |
| 3.58% | `python` | `_PyGC_Collect` | gc |
| 3.40% | `python` | `visit_add_to_container` | gc |
| 2.25% | `[JIT]` | `jit` | jit |
| 2.22% | `python` | `dict_traverse` | gc |
| 2.17% | `python` | `PyDict_GetItemRef` | dict |
| 1.91% | `python` | `visit_decref` | gc |
| 1.87% | `python` | `dict_dealloc` | memory |
| 1.82% | `python` | `build_indices_unicode` | dict |
...
| 0.68% | `python` | `_PySet_Contains` | miscobj |
...
| 0.40% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 15.93% | `python` | `gc_collect_region.isra.0` | gc |
| 12.38% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 11.48% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 6.40% | `python` | `set_lookkey` | miscobj |
| 4.96% | `python` | `dictiter_iternextkey` | dict |
| 3.69% | `python` | `_PyGC_Collect` | gc |
| 3.48% | `python` | `visit_add_to_container` | gc |
| 2.70% | `[JIT]` | `jit` | jit |
| 2.26% | `python` | `dict_traverse` | gc |
| 2.17% | `python` | `PyDict_GetItemRef` | dict |
| 1.97% | `python` | `visit_decref` | gc |
| 1.71% | `python` | `dict_dealloc` | memory |
| 1.66% | `python` | `_Py_dict_lookup` | lookup |
| 1.62% | `python` | `_PyType_LookupRef` | lookup |
...
| 0.77% | `python` | `_PySet_Contains` | miscobj |
...
| 0.49% | `python` | `_PyObject_GetMethod` | dynamic |
| 0.45% | `python` | `set_dealloc` | memory |
| 0.42% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 23.70% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 8.68% | `python` | `gc_collect_region.isra.0` | gc |
| 8.17% | `[JIT]` | `jit` | jit |
| 7.68% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.89% | `python` | `PyDict_GetItemRef` | dict |
| 4.51% | `python` | `list_remove` | list |
| 4.30% | `python` | `visit_add_to_container` | gc |
| 3.30% | `python` | `_PyGC_Collect` | gc |
| 3.12% | `python` | `dictiter_iternextkey` | dict |
| 3.03% | `python` | `_Py_dict_lookup` | lookup |
| 1.66% | `python` | `dict_traverse` | gc |
| 1.50% | `python` | `visit_decref` | gc |
| 1.21% | `python` | `dict_dealloc` | memory |
| 1.14% | `python` | `build_indices_unicode` | dict |
| 1.07% | `python` | `list_dealloc` | memory |
| 1.05% | `python` | `_PyObject_Malloc` | memory |
| 0.98% | `python` | `PyUnicode_RichCompare` | str |
| 0.90% | `python` | `insertdict` | dict |
| 0.85% | `python` | `_PyType_LookupRef` | lookup |
| 0.79% | `python` | `listiter_next` | list |
...
| 0.56% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
...
| 0.55% | `python` | `list_ass_slice_lock_held` | list |
| 0.54% | `python` | `PyLong_FromLong` | int |
| 0.53% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 0.53% | `python` | `_Py_NewReference` | memory |
| 0.52% | `python` | `r_object` | import |
| 0.51% | `python` | `PySequence_Tuple` | dynamic |
| 0.49% | `python` | `gen_dealloc` | memory |
| 0.49% | `python` | `PyObject_GetIter` | dynamic |
| 0.47% | `python` | `list_ass_subscript` | list |
| 0.46% | `python` | `_PyLong_Subtract` | int |
| 0.45% | `python` | `PySlice_Unpack` | miscobj |
| 0.43% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.43% | `python` | `_PyType_LookupRefAndVersion` | lookup |
| 0.43% | `python` | `slice_dealloc` | memory |
| 0.42% | `python` | `PyType_GenericAlloc` | memory |
| 0.42% | `python` | `set_update_iterable_lock_held` | miscobj |
| 0.42% | `python` | `visit_reachable` | gc |
| 0.42% | `python` | `compute_range_length` | unknown |
| 0.42% | `python` | `func_dealloc` | memory |
| 0.41% | `python` | `PyObject_GC_Del` | gc |
| 0.40% | `python` | `_PyDict_LoadBuiltinsFromGlobals` | dict |
| 0.40% | `python` | `list_slice_lock_held.isra.0` | list |
| 0.40% | `python` | `find_name_in_mro` | lookup |
| 0.39% | `python` | `range_iter` | miscobj |
...
| 0.30% | `python` | `PyObject_GetItem` | dynamic |
| 0.30% | `python` | `PyObject_Hash` | dynamic |
| 0.30% | `python` | `range_reverse` | miscobj |
| 0.30% | `python` | `_PyObject_GC_NewVar` | gc |
| 0.29% | `python` | `_Py_hashtable_get_entry_generic` | lookup |
...
| 1.53% | `[kernel.kallsyms]` | `__d_lookup_rcu` | kernel |
| 1.51% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.30% | `libpthread-2.31.so` | `__pthread_mutex_lock` | library |
| 1.27% | `[kernel.kallsyms]` | `ext4_htree_store_dirent` | kernel |
| 1.26% | `python` | `_Py_Dealloc` | memory |
| 1.26% | `libpthread-2.31.so` | `pthread_mutex_unlock` | library |
| 1.13% | `python` | `_PyType_LookupRefAndVersion` | lookup |
| 1.11% | `[kernel.kallsyms]` | `__ext4fs_dirhash` | kernel |
| 1.02% | `[kernel.kallsyms]` | `memset_erms` | kernel |
...
| 0.78% | `python` | `_PyEvalFramePushAndInit` | interpreter |
| 0.77% | `python` | `k_mul` | int |
| 0.73% | `[kernel.kallsyms]` | `clear_bhb_loop` | kernel |
| 0.73% | `python` | `_PyLong_FromMedium` | int |
| 0.73% | `python` | `long_dealloc` | memory |
| 0.71% | `[kernel.kallsyms]` | `strncpy_from_user` | kernel |
| 0.67% | `libc-2.31.so` | `_int_malloc` | libc |
| 0.63% | `python` | `_PyTuple_FromStackRefStealOnSuccess` | tuple |
| 0.60% | `python` | `fill_time` | unknown |
...
| 0.54% | `[kernel.kallsyms]` | `str2hashbuf_signed` | kernel |
| 0.53% | `[kernel.kallsyms]` | `syscall_return_via_sysret` | kernel |
...
| 0.26% | `python` | `update_one_slot` | lookup |
| 0.25% | `[kernel.kallsyms]` | `walk_component` | kernel |
| 0.25% | `python` | `_PyThreadState_PushFrame` | threading |
| 0.25% | `python` | `find_name_in_mro` | lookup |
| 0.25% | `python` | `path_converter` | unknown |

## pickle_pure_python

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 30.24% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 9.60% | `[JIT]` | `jit` | jit |
...
| 0.28% | `python` | `_Py_NewReference` | memory |
| 0.28% | `_struct.cpython-314-x86_64-linux-gnu.so` | `s_pack_internal.isra.0` | library |
...
| 0.25% | `libc-2.31.so` | `__memset_avx2_erms` | libc |

## pidigits

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 32.46% | `python` | `x_divrem` | int |
| 22.63% | `python` | `k_mul` | int |
| 12.60% | `python` | `x_add` | int |
| 7.91% | `python` | `x_sub` | int |
| 4.11% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 1.49% | `libc-2.31.so` | `_int_malloc` | libc |
| 0.92% | `libc-2.31.so` | `__memset_avx2_erms` | libc |
...
| 0.56% | `libc-2.31.so` | `_int_free` | libc |
| 0.51% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
...
| 0.67% | `python` | `list_sort_impl` | list |
| 0.59% | `python` | `initialize_locals` | interpreter |
| 0.58% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 0.58% | `python` | `_PyType_LookupRef` | lookup |
| 0.56% | `python` | `_copy_characters.part.0.constprop.0` | str |
| 0.54% | `python` | `PyObject_IsSubclass` | dynamic |
...
| 0.49% | `python` | `PyUnicode_New` | memory |
...
| 0.36% | `python` | `PyObject_GetAttr` | dynamic |
| 0.34% | `python` | `recursive_issubclass` | unknown |
...
| ---: | :--- | :--- | :--- |
| 25.38% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 13.74% | `python` | `sre_ucs1_match` | library |
| 7.94% | `[JIT]` | `jit` | jit |
| 3.07% | `python` | `gc_collect_region.isra.0` | gc |
...
| 1.36% | `python` | `PySlice_AdjustIndices` | miscobj |
| 1.24% | `libc-2.31.so` | `_int_malloc` | libc |
...
| 0.88% | `python` | `pattern_new_match.isra.0.part.0` | memory |
...
| 0.54% | `libc-2.31.so` | `_int_free` | libc |
...
| 0.47% | `python` | `sre_ucs2_charset.isra.0` | library |
...
| 0.35% | `python` | `list_dealloc` | memory |
| 0.34% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.33% | `python` | `list_ass_subscript` | list |
| 0.32% | `python` | `PyList_New` | memory |
| 0.31% | `python` | `_PyObject_TryGetInstanceAttribute` | dynamic |
| 0.31% | `python` | `slot_mp_ass_subscript` | unknown |
| 0.30% | `python` | `_Py_Dealloc` | memory |
| 0.29% | `python` | `PyObject_GC_Del` | gc |
| 0.28% | `libc-2.31.so` | `unlink_chunk.isra.0` | libc |
...
| 20.58% | `[JIT]` | `jit` | jit |
| 6.70% | `python` | `list_dealloc` | memory |
| 5.40% | `python` | `list_ass_slice_lock_held` | list |
| 1.95% | `python` | `list_concat` | list |
| 1.80% | `libc-2.31.so` | `_int_malloc` | libc |
| 1.76% | `python` | `list_slice_lock_held.isra.0` | list |
| 1.60% | `python` | `_PyObject_Free` | memory |
| 1.59% | `python` | `PySlice_AdjustIndices` | miscobj |
| 1.56% | `python` | `_PyObject_Malloc` | memory |
| 1.45% | `python` | `PyNumber_AsSsize_t` | dynamic |
| 1.33% | `python` | `_PyLong_FromMedium` | int |
| 1.29% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.24% | `python` | `_PyLong_Subtract` | int |
| 1.04% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.95% | `python` | `bytes_subscript` | str |
| 0.95% | `python` | `_PyLong_Add` | int |
| 0.95% | `python` | `long_dealloc` | memory |
| 0.89% | `python` | `stringlib_bytes_join` | str |
| 0.87% | `python` | `PyLong_AsSsize_t` | int |
| 0.83% | `python` | `long_lshift_int64` | int |
| 0.82% | `python` | `list_sort_impl` | list |
| 0.76% | `python` | `PyLong_FromSsize_t` | int |
| 0.73% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 0.68% | `python` | `long_lshift_method` | int |
| 0.66% | `python` | `unsafe_long_compare` | unknown |
...
| 11.01% | `python` | `gc_collect_region.isra.0` | gc |
...
| 2.02% | `python` | `_PyType_LookupRef` | lookup |
| 1.92% | `[JIT]` | `jit` | jit |
...
| 2.83% | `python` | `gc_collect_region.isra.0` | gc |
...
| 1.33% | `python` | `update_one_slot` | lookup |
...
| 0.86% | `ld-2.31.so` | `do_lookup_x` | library |
| 0.83% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.78% | `python` | `_PyUnicode_FromUCS1.part.0` | str |
| 0.77% | `python` | `visit_add_to_container` | gc |
| 0.72% | `libc-2.31.so` | `__strlen_avx2` | libc |
| 0.63% | `[kernel.kallsyms]` | `native_irq_return_iret` | kernel |
| 0.58% | `libc-2.31.so` | `_int_malloc` | libc |
| 0.56% | `python` | `_PyType_LookupRef` | lookup |
| 0.56% | `python` | `intern_constants` | str |
| 0.55% | `python` | `_PyDict_GetItemRef_KnownHash` | dict |
| 0.54% | `python` | `_Py_Dealloc` | memory |
| 0.54% | `python` | `insertdict` | dict |
| 0.52% | `[kernel.kallsyms]` | `filemap_map_pages` | kernel |
...
| 0.47% | `libc-2.31.so` | `wcsrtombs` | libc |
| 0.47% | `python` | `PyDict_GetItemRef` | dict |
| 0.47% | `python` | `build_indices_unicode` | dict |
| 0.46% | `python` | `_PyPegen_is_memoized` | interpreter |
| 0.44% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.43% | `[kernel.kallsyms]` | `sync_regs` | kernel |
| 0.41% | `python` | `dict_setdefault_ref_lock_held` | dict |
| 0.39% | `ld-2.31.so` | `_dl_relocate_object` | library |
| 0.39% | `libc-2.31.so` | `__gconv_transform_internal_utf8` | libc |
...
| 0.33% | `ld-2.31.so` | `strcmp` | library |
...
| 0.29% | `ld-2.31.so` | `_dl_lookup_symbol_x` | library |
...
| 0.27% | `[kernel.kallsyms]` | `ext4_htree_store_dirent` | kernel |
| 0.27% | `python` | `code_dealloc` | memory |
| 0.27% | `python` | `intern_common.part.0` | str |
| 0.26% | `python` | `PyObject_IS_GC` | gc |
...
| 1.37% | `ld-2.31.so` | `do_lookup_x` | library |
| 1.35% | `python` | `r_object` | import |
| 1.30% | `python` | `_PyGC_Collect` | gc |
...
| 1.10% | `ld-2.31.so` | `_dl_relocate_object` | library |
| 0.85% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.82% | `python` | `_PyCode_Quicken` | interpreter |
| 0.81% | `libc-2.31.so` | `__strlen_avx2` | libc |
| 0.81% | `[kernel.kallsyms]` | `native_irq_return_iret` | kernel |
| 0.81% | `[kernel.kallsyms]` | `filemap_map_pages` | kernel |
| 0.80% | `libc-2.31.so` | `wcsrtombs` | libc |
| 0.75% | `python` | `tuple_dealloc` | memory |
| 0.70% | `python` | `find_first_nonascii` | str |
| 0.70% | `python` | `_PyUnicode_FromUCS1.part.0` | str |
| 0.66% | `libc-2.31.so` | `__gconv_transform_internal_utf8` | libc |
| 0.64% | `[kernel.kallsyms]` | `sync_regs` | kernel |
| 0.59% | `ld-2.31.so` | `strcmp` | library |
| 0.57% | `python` | `insertdict` | dict |
| 0.56% | `python` | `_PyType_LookupRef` | lookup |
| 0.53% | `python` | `_PyDict_GetItemRef_KnownHash` | dict |
...
| 0.43% | `[kernel.kallsyms]` | `zap_pte_range.isra.0` | kernel |
| 0.42% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 0.42% | `python` | `dict_dealloc` | memory |
| 0.39% | `ld-2.31.so` | `_dl_lookup_symbol_x` | library |
| 0.39% | `python` | `PyDict_GetItemRef` | dict |
| 0.37% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
...
| 0.32% | `ld-2.31.so` | `check_match` | library |
...
| 0.27% | `[kernel.kallsyms]` | `release_pages` | kernel |
| 0.25% | `[kernel.kallsyms]` | `rmqueue` | kernel |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 46.06% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 5.27% | `[JIT]` | `jit` | jit |
| 4.02% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 3.23% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
...
| 1.29% | `python` | `PyType_GenericAlloc` | memory |
| 1.18% | `python` | `PyObject_ClearManagedDict` | dynamic |
...
| 0.76% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
...
| 0.50% | `python` | `float_sub` | float |
| 0.47% | `python` | `PyObject_ClearWeakRefs` | dynamic |
| 0.46% | `python` | `vectorcall_maybe.constprop.0` | unknown |
| 0.46% | `python` | `PyObject_GC_UnTrack` | gc |
| 0.45% | `python` | `_PyThreadState_PushFrame` | threading |
| 0.38% | `python` | `_PyTuple_FromStackRefStealOnSuccess` | tuple |
...
| 0.32% | `python` | `PyFloat_AsDouble` | float |
| 0.29% | `python` | `_Py_dict_lookup` | lookup |
| 0.26% | `python` | `PyNumber_Add` | dynamic |
| 0.25% | `python` | `PyNumber_Multiply` | dynamic |
...
| 0.67% | `python` | `PyNumber_AsSsize_t` | dynamic |
...
| 0.26% | `python` | `update_one_slot` | lookup |
| 0.26% | `python` | `_PyType_GetDict` | dynamic |
| 0.26% | `libc-2.31.so` | `_int_malloc` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 31.34% | `python` | `sre_ucs1_match` | library |
| 25.89% | `python` | `sre_ucs2_charset.isra.0` | library |
| 8.93% | `python` | `sre_search` | library |
| 4.04% | `[JIT]` | `jit` | jit |
| 3.48% | `libm-2.31.so` | `__fmod_finite@GLIBC_2.15` | library |
| 2.25% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 1.42% | `_bisect.cpython-314-x86_64-linux-gnu.so` | `_bisect_bisect_right` | library |
| 1.00% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.87% | `python` | `pattern_subx` | library |
| 0.80% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 0.70% | `python` | `float_richcompare` | float |
| 0.70% | `python` | `_PyObject_Malloc` | memory |
| 0.65% | `python` | `float_rem` | float |
| 0.56% | `python` | `float_dealloc` | memory |
| 0.49% | `python` | `_PyObject_Free` | memory |
| 0.48% | `python` | `gc_collect_region.isra.0` | gc |
| 0.46% | `python` | `list_item` | list |
| 0.43% | `python` | `_Py_dict_lookup` | lookup |
| 0.43% | `python` | `stringlib_bytes_join` | str |
| 0.42% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
| 0.40% | `python` | `_Py_Dealloc` | memory |
| 0.38% | `python` | `visit_decref` | gc |
| 0.33% | `python` | `bytearray_ass_subscript` | miscobj |
| 0.32% | `python` | `float_div` | float |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 47.25% | `python` | `sre_ucs1_match` | library |
| 15.42% | `python` | `sre_ucs2_charset.isra.0` | library |
| 7.71% | `python` | `sre_search` | library |
| 4.08% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 2.50% | `python` | `sre_ucs1_count` | library |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 35.27% | `python` | `sre_ucs1_match` | library |
| 6.80% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.31% | `python` | `sre_search` | library |
| 3.98% | `python` | `sre_ucs1_count` | library |
| 3.69% | `python` | `PyCode_Addr2Line` | exceptions |
| 2.81% | `python` | `_PyObject_Malloc` | memory |
| 2.48% | `python` | `_PyObject_Free` | memory |
| 1.63% | `python` | `pattern_subx` | library |
| 1.52% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.28% | `[JIT]` | `jit` | jit |
| 1.19% | `libc-2.31.so` | `_int_malloc` | libc |
| 1.14% | `python` | `_sre_SRE_Pattern_search` | library |
...
| 0.50% | `python` | `_PyUnicode_ToLowercase` | str |
...
| 0.27% | `python` | `sre_ucs2_charset.isra.0` | library |
| 0.27% | `python` | `PyUnicode_New.part.0` | memory |
| 0.27% | `python` | `PyUnicode_Substring` | str |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 51.29% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 5.12% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 4.69% | `python` | `_PyType_LookupRef` | lookup |
| 3.18% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 2.68% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 2.37% | `python` | `_PyObject_TryGetInstanceAttribute` | dynamic |
| 1.91% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 1.74% | `python` | `_PyObject_GetMethod` | dynamic |
...
| 0.60% | `[JIT]` | `jit` | jit |
| 0.53% | `python` | `visit_decref` | gc |
| 0.53% | `python` | `_PyObject_Free` | memory |
| 0.43% | `python` | `r_object` | import |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 49.66% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 5.21% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 4.81% | `python` | `_PyType_LookupRef` | lookup |
| 3.25% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 2.21% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 2.04% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 1.85% | `python` | `_PyObject_TryGetInstanceAttribute` | dynamic |
| 1.48% | `python` | `_PyObject_GetMethod` | dynamic |
| 1.12% | `python` | `_Py_dict_lookup` | lookup |
...
| 0.54% | `python` | `PyObject_GenericSetAttr` | dynamic |
| 0.53% | `[JIT]` | `jit` | jit |
| 0.51% | `python` | `initialize_locals` | interpreter |
| 0.48% | `python` | `PyObject_SetAttr` | dynamic |
| 0.42% | `python` | `do_super_lookup` | dynamic |
| 0.42% | `python` | `_PySuper_Lookup` | dynamic |
| 0.42% | `python` | `r_object` | import |
...
| 14.83% | `[JIT]` | `jit` | jit |
| 4.06% | `array.cpython-314-x86_64-linux-gnu.so` | `array_subscr` | library |
| 3.32% | `python` | `PyFloat_FromDouble` | float |
| 3.12% | `python` | `PyNumber_AsSsize_t` | dynamic |
| 3.08% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
| 2.74% | `python` | `_PyLong_FromMedium` | int |
| 2.53% | `python` | `PyObject_GetItem` | dynamic |
| 2.48% | `python` | `vgetargs1_impl` | calls |
| 1.89% | `python` | `convertitem.constprop.0` | unknown |
| 1.59% | `python` | `long_dealloc` | memory |
| 1.59% | `python` | `_Py_Dealloc` | memory |
| 1.54% | `python` | `PyLong_AsSsize_t` | int |
| 1.45% | `python` | `_PyLong_Add` | int |
| 1.36% | `python` | `_Py_NewReference` | memory |
| 1.33% | `python` | `float_dealloc` | memory |
| 1.31% | `array.cpython-314-x86_64-linux-gnu.so` | `array_ass_subscr` | library |
| 1.19% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.01% | `python` | `PyType_GetModuleByDef` | dynamic |
| 0.98% | `python` | `PyIndex_Check` | unknown |
| 0.88% | `array.cpython-314-x86_64-linux-gnu.so` | `d_setitem` | library |
| 0.84% | `python` | `PyArg_Parse` | calls |
| 0.77% | `python` | `PyLong_FromLong` | int |
| 0.76% | `python` | `PyObject_SetItem` | dynamic |
| 0.69% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 0.61% | `array.cpython-314-x86_64-linux-gnu.so` | `d_getitem` | library |
| 0.60% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 0.59% | `python` | `_PyObject_Malloc` | memory |
| 0.52% | `python` | `tuple_dealloc` | memory |
| 0.51% | `python` | `PyType_IsSubtype` | dynamic |
| 0.51% | `python` | `_PyLong_Multiply` | int |
...
| 0.43% | `python` | `_PyType_LookupRef` | lookup |
...
| 0.32% | `python` | `float_richcompare` | float |
| 0.30% | `python` | `_PyLong_Subtract` | int |
| 0.29% | `array.cpython-314-x86_64-linux-gnu.so` | `0x00000000000049c4` | library |
| 0.28% | `python` | `PyFloat_AsDouble` | float |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 39.35% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 7.11% | `python` | `_PyLong_Add` | int |
| 4.58% | `python` | `_PyLong_FromMedium` | int |
| 2.77% | `python` | `long_div` | int |
| 2.30% | `python` | `float_compactlong_true_div` | float |
| 1.83% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.61% | `python` | `_PyLong_Multiply` | int |
| 1.59% | `python` | `_PyFloat_FromDouble_ConsumeInputs` | float |
| 1.56% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.55% | `python` | `enum_next` | miscobj |
| 1.41% | `python` | `_PyLong_ExactDealloc` | memory |
| 1.31% | `python` | `listiter_next` | list |
| 1.30% | `python` | `_Py_NewReference` | memory |
| 1.20% | `python` | `long_dealloc` | memory |
| 1.02% | `python` | `gc_collect_region.isra.0` | gc |
| 1.01% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 0.99% | `python` | `PyNumber_FloorDivide` | dynamic |
...
| 0.73% | `python` | `nonzero_float_compactlong_guard` | unknown |
...
| 6.30% | `python` | `sre_ucs1_match` | library |
| 3.70% | `python` | `gc_collect_region.isra.0` | gc |
| 3.09% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 2.57% | `python` | `_PyObject_Malloc` | memory |
| 2.47% | `python` | `_PyType_LookupRef` | lookup |
| 2.28% | `python` | `sre_ucs2_charset.isra.0` | library |
| 1.90% | `python` | `_PyObject_Free` | memory |
| 1.78% | `python` | `_Py_dict_lookup` | lookup |
| 1.67% | `python` | `visit_add_to_container` | gc |
| 1.53% | `_pickle.cpython-314-x86_64-linux-gnu.so` | `save` | library |
| 1.40% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.34% | `[JIT]` | `jit` | jit |
| 1.29% | `python` | `visit_decref` | gc |
| 1.18% | `python` | `_PyGC_Collect` | gc |
...
| 0.50% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
| 0.49% | `python` | `sre_search` | library |
| 0.46% | `python` | `PyObject_GC_UnTrack` | gc |
| 0.44% | `python` | `gen_dealloc` | memory |
...
| 0.32% | `python` | `_PyTuple_FromStackRefStealOnSuccess` | tuple |
| 0.30% | `python` | `PyObject_GC_Del` | gc |
| 0.30% | `python` | `sre_ucs2_match` | library |
| 0.29% | `_pickle.cpython-314-x86_64-linux-gnu.so` | `PyMemoTable_Set` | library |
| 0.28% | `python` | `_PyObject_GC_NewVar` | gc |
| 0.28% | `python` | `_PyType_GetDict` | dynamic |
| 0.26% | `python` | `sre_ucs1_count` | library |
| 0.26% | `python` | `pattern_subx` | library |
...
| 1.84% | `python` | `_PyType_LookupRef` | lookup |
| 1.62% | `[JIT]` | `jit` | jit |
...
| 0.78% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 0.68% | `libpthread-2.31.so` | `__pthread_mutex_lock` | library |
...
| 0.58% | `libpthread-2.31.so` | `pthread_mutex_unlock` | library |
...
| 0.49% | `python` | `subtype_dealloc` | memory |
| 0.49% | `python` | `_PyDict_GetItemRef_KnownHash` | dict |
...
| 0.45% | `python` | `_PyTuple_FromArray.part.0` | tuple |
...
| 0.31% | `libc-2.31.so` | `_int_malloc` | libc |
...
| 0.52% | `python` | `subtype_dealloc` | memory |
| 0.51% | `libsqlite3.so.0.8.6` | `sqlite3_reset` | library |
| 0.50% | `python` | `r_object` | import |
| 0.47% | `libpthread-2.31.so` | `pthread_mutex_unlock` | library |
| 0.47% | `python` | `_PyTuple_FromStackRefStealOnSuccess` | tuple |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 31.21% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
...
| 1.98% | `python` | `PyType_IsSubtype` | dynamic |
| 1.72% | `python` | `tuple_dealloc` | memory |
| 1.66% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 1.45% | `python` | `dictiter_iternextitem` | dict |
| 1.44% | `python` | `_PyType_LookupRefAndVersion` | lookup |
...
| 0.58% | `python` | `PyTuple_Pack` | tuple |
...
| 0.46% | `python` | `_PyObject_LookupSpecial` | dynamic |
| 0.45% | `python` | `gen_dealloc` | memory |
| 0.44% | `python` | `r_object` | import |
| 0.43% | `python` | `find_name_in_mro` | lookup |
| 0.41% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.39% | `python` | `meth_dealloc` | memory |
| 0.38% | `python` | `_PyObject_RealIsInstance` | dynamic |
| 0.38% | `python` | `dict_dealloc` | memory |
| 0.37% | `python` | `_PyObject_Calloc` | memory |
| 0.36% | `python` | `visit_reachable` | gc |
...
| 0.66% | `python` | `object_isinstance` | dynamic |
...
| 2.18% | `python` | `_PyType_LookupRefAndVersion` | lookup |
...
| 30.11% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 11.03% | `[JIT]` | `jit` | jit |
| 3.22% | `python` | `unicodekeys_lookup_unicode` | lookup |
...
| 1.86% | `python` | `_PyType_LookupRefAndVersion` | lookup |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 11.18% | `libpthread-2.31.so` | `__pthread_mutex_lock` | library |
| 11.15% | `libpthread-2.31.so` | `pthread_mutex_unlock` | library |
| 4.92% | `python` | `take_gil` | gil |
| 4.72% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 4.53% | `libsqlite3.so.0.8.6` | `sqlite3_reset` | library |
| 2.34% | `libm-2.31.so` | `__cos_fma` | library |
| 2.16% | `[JIT]` | `jit` | jit |
| 2.11% | `python` | `_PyObject_Malloc` | memory |
| 1.99% | `python` | `_PyObject_Free` | memory |
| 1.52% | `libsqlite3.so.0.8.6` | `sqlite3_randomness` | library |
| 1.20% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.18% | `python` | `drop_gil` | gil |
| 1.01% | `python` | `_Py_Dealloc` | memory |
| 1.01% | `_sqlite3.cpython-314-x86_64-linux-gnu.so` | `_pysqlite_query_execute` | library |
| 0.98% | `libsqlite3.so.0.8.6` | `sqlite3_preupdate_old` | library |
| 0.88% | `libpthread-2.31.so` | `pthread_cond_signal@@GLIBC_2.3.2` | library |
...
| 0.66% | `libsqlite3.so.0.8.6` | `sqlite3_wal_checkpoint` | library |
| 0.65% | `libsqlite3.so.0.8.6` | `sqlite3_vtab_config` | library |
| 0.64% | `python` | `_Py_dict_lookup` | lookup |
| 0.62% | `libsqlite3.so.0.8.6` | `sqlite3_extended_errcode` | library |
| 0.60% | `python` | `_PyThreadState_MustExit` | threading |
| 0.59% | `python` | `gc_collect_region.isra.0` | gc |
| 0.58% | `python` | `PyFloat_FromDouble` | float |
| 0.58% | `libc-2.31.so` | `_int_free` | libc |
| 0.55% | `libsqlite3.so.0.8.6` | `sqlite3_enable_shared_cache` | library |
| 0.53% | `python` | `PyType_GenericAlloc` | memory |
| 0.50% | `python` | `_PyThreadState_Attach` | threading |
...
| 0.42% | `libsqlite3.so.0.8.6` | `sqlite3_step` | library |
| 0.42% | `python` | `PyList_New` | memory |
| 0.41% | `libc-2.31.so` | `__libc_malloc` | libc |
| 0.41% | `python` | `_PyLong_FromMedium` | int |
| 0.41% | `python` | `_PyThreadState_Detach` | threading |
| 0.40% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 0.39% | `libsqlite3.so.0.8.6` | `sqlite3_str_value` | library |
| 0.38% | `python` | `list_dealloc` | memory |
| 0.38% | `python` | `visit_decref` | gc |
| 0.38% | `python` | `float_dealloc` | memory |
| 0.37% | `python` | `long_dealloc` | memory |
| 0.34% | `libsqlite3.so.0.8.6` | `sqlite3_mutex_try` | library |
...
| 0.32% | `_sqlite3.cpython-314-x86_64-linux-gnu.so` | `_pysqlite_fetch_one_row` | library |
| 0.32% | `math.cpython-314-x86_64-linux-gnu.so` | `math_cos` | library |
| 0.32% | `python` | `pthread_mutex_unlock@plt` | unknown |
| 0.32% | `python` | `PyFloat_AsDouble.part.0` | float |
...
| 0.31% | `_sqlite3.cpython-314-x86_64-linux-gnu.so` | `pysqlite_cursor_init` | library |
| 0.30% | `python` | `initialize_locals` | interpreter |
| 0.30% | `libsqlite3.so.0.8.6` | `sqlite3_close_v2` | library |
| 0.29% | `libsqlite3.so.0.8.6` | `sqlite3_value_pointer` | library |
| 0.29% | `python` | `r_object` | import |
| 0.28% | `python` | `PyType_IsSubtype` | dynamic |
| 0.28% | `libc-2.31.so` | `cfree@GLIBC_2.2.5` | libc |
| 0.27% | `_sqlite3.cpython-314-x86_64-linux-gnu.so` | `bind_param.isra.0` | library |
| 0.27% | `python` | `visit_reachable` | gc |
| 0.27% | `python` | `pthread_mutex_lock@plt` | unknown |
| 0.27% | `python` | `_PyFrame_ClearExceptCode` | interpreter |
| 0.26% | `python` | `PyList_Append` | list |
| 0.26% | `libsqlite3.so.0.8.6` | `sqlite3_sourceid` | library |
...
| 0.68% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 0.67% | `python` | `visit_reachable` | gc |
| 0.62% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.62% | `python` | `_Py_Dealloc` | memory |
...
| 0.41% | `python` | `setiter_iternext` | miscobj |
| 0.41% | `python` | `visit_add_to_container` | gc |
...
| 1.88% | `python` | `_PyObject_GC_New` | gc |
| 1.63% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `nm_mpd_qadd` | library |
| 1.62% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_check_exp` | library |
| 1.46% | `python` | `_PyType_LookupRef` | lookup |
| 1.46% | `python` | `tuple_dealloc` | memory |
| 1.46% | `python` | `PyObject_GC_Track` | gc |
| 1.45% | `python` | `PyContextVar_Get` | unknown |
| 1.44% | `python` | `_Py_Dealloc` | memory |
| 1.43% | `python` | `PyObject_GC_UnTrack` | gc |
| 1.41% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_qaddsub` | library |
| 1.28% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_qmul` | library |
| 1.20% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `nm_mpd_qmul` | library |
| 1.18% | `python` | `vgetargskeywords.constprop.0` | unknown |
| 1.16% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.15% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_setdigits` | library |
| 1.12% | `python` | `_PyArg_UnpackKeywords` | calls |
| 1.03% | `python` | `_Py_dict_lookup` | lookup |
| 1.01% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_baseshiftr` | library |
| 0.96% | `python` | `convertitem.constprop.0` | unknown |
| 0.92% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `PyDecType_New.isra.0` | library |
| 0.90% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 0.87% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qquantize` | library |
| 0.78% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `dec_addstatus` | library |
| 0.76% | `python` | `gc_collect_region.isra.0` | gc |
| 0.75% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `dec_dealloc` | library |
| 0.74% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 0.70% | `python` | `PyType_IsSubtype` | dynamic |
| 0.69% | `python` | `PyCMethod_New` | memory |
| 0.68% | `python` | `vgetargs1_impl` | calls |
| 0.66% | `python` | `PyUnicode_AsUCS4` | str |
| 0.64% | `python` | `_PyObject_GC_Link` | gc |
| 0.60% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qshiftr` | library |
| 0.60% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `dec_mpd_qquantize` | library |
| 0.58% | `libc-2.31.so` | `__strlen_avx2` | libc |
| 0.55% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_baseadd` | library |
| 0.54% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qfinalize.part.0` | library |
| 0.54% | `python` | `PyDict_GetItemRef` | dict |
| 0.53% | `python` | `PyObject_Vectorcall` | dynamic |
| 0.53% | `python` | `_Py_NewReference` | memory |
| 0.52% | `python` | `visit_decref` | gc |
| 0.52% | `python` | `PyType_GetBaseByToken` | unknown |
| 0.50% | `python` | `PyNumber_InPlaceAdd` | dynamic |
| 0.50% | `libc-2.31.so` | `__strchr_avx2` | libc |
| 0.46% | `python` | `write_str` | unknown |
| 0.45% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `_mpd_to_string` | library |
| 0.43% | `python` | `PyObject_GetAttr` | dynamic |
| 0.42% | `python` | `PyNumber_Multiply` | dynamic |
| 0.42% | `python` | `PyObject_RichCompare` | dynamic |
| 0.42% | `python` | `PyType_GetModuleByDef` | dynamic |
| 0.41% | `python` | `PyFile_WriteObject` | unknown |
| 0.41% | `python` | `builtin_print` | unknown |
| 0.41% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.41% | `python` | `PyTuple_New` | memory |
| 0.41% | `python` | `meth_dealloc` | memory |
| 0.40% | `python` | `r_object` | import |
| 0.37% | `python` | `method_vectorcall_VARARGS_KEYWORDS` | calls |
| 0.36% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_del` | library |
| 0.35% | `python` | `visit_reachable` | gc |
| 0.35% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qset_i64` | library |
| 0.35% | `python` | `PyObject_CallOneArg` | dynamic |
| 0.33% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `ctx_mpd_qquantize` | library |
| 0.33% | `python` | `binary_op1` | unknown |
| 0.33% | `python` | `_PyObject_MakeTpCall` | dynamic |
| 0.33% | `python` | `_PyLong_FromMedium` | int |
| 0.32% | `python` | `cfunction_vectorcall_O` | calls |
| 0.30% | `python` | `PyUnicode_CompareWithASCIIString` | str |
| 0.29% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `dec_str` | library |
| 0.29% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qadd` | library |
| 0.29% | `python` | `_PyObject_GetMethod` | dynamic |
...
| 0.27% | `python` | `_PyGC_Collect` | gc |
| 0.26% | `_struct.cpython-314-x86_64-linux-gnu.so` | `bu_ulonglong` | library |
| 0.26% | `python` | `compactlongs_guard` | unknown |
| 0.26% | `_struct.cpython-314-x86_64-linux-gnu.so` | `unpack` | library |
| 0.25% | `python` | `_io_StringIO_write` | unknown |
| 0.25% | `_decimal.cpython-314-x86_64-linux-gnu.so` | `mpd_qmul` | library |

## thrift

| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 21.05% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 3.90% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 3.66% | `python` | `_PyObject_Malloc` | memory |
| 3.00% | `python` | `_PyObject_Free` | memory |
| 2.31% | `python` | `_Py_dict_lookup` | lookup |
| 2.29% | `python` | `initialize_locals` | interpreter |
| 1.84% | `fastbinary.cpython-314-x86_64-linux-gnu.so` | `apache::thrift::py::ProtocolBase<apache::thrift::py::BinaryProtocol>::encodeValue` | library |
...
| 1.12% | `python` | `PyType_GenericAlloc` | memory |
...
| 0.78% | `python` | `_PyEvalFramePushAndInit` | interpreter |
| 0.74% | `fastbinary.cpython-314-x86_64-linux-gnu.so` | `apache::thrift::py::ProtocolBase<apache::thrift::py::BinaryProtocol>::decodeValue` | library |
| 0.72% | `python` | `_PyEval_FrameClearAndPop` | interpreter |
...
| 0.59% | `python` | `PyTuple_Size` | tuple |
| 0.58% | `python` | `_PyEval_Vector` | interpreter |
| 0.56% | `python` | `_PyStack_UnpackDict` | interpreter |
| 0.54% | `fastbinary.cpython-314-x86_64-linux-gnu.so` | `apache::thrift::py::ProtocolBase<apache::thrift::py::BinaryProtocol>::readBytes` | library |
...
| 0.41% | `fastbinary.cpython-314-x86_64-linux-gnu.so` | `apache::thrift::py::BinaryProtocol::readFieldBegin` | library |
| 0.40% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 0.40% | `python` | `PyDict_New` | memory |
| 0.40% | `python` | `_PyObject_Call_Prepend` | dynamic |
| 0.39% | `python` | `_PyObject_Calloc` | memory |
| 0.39% | `python` | `visit_reachable` | gc |
...
| 0.37% | `python` | `unicode_from_format` | str |
| 0.35% | `python` | `list_dealloc` | memory |
...
| 0.33% | `fastbinary.cpython-314-x86_64-linux-gnu.so` | `apache::thrift::py::parse_struct_item_spec` | library |
| 0.32% | `python` | `PyUnicode_New.part.0` | memory |
| 0.32% | `python` | `PyUnicode_RichCompare` | str |
| 0.32% | `python` | `type_call` | dynamic |
| 0.32% | `libc-2.31.so` | `__libc_malloc` | libc |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 24.27% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 20.31% | `[JIT]` | `jit` | jit |
| 5.79% | `python` | `set_lookkey` | miscobj |
| 2.97% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 2.85% | `python` | `_PyUnicode_Equal` | str |
| 2.27% | `python` | `_PyLong_FromMedium` | int |
| 2.05% | `python` | `_Py_dict_lookup` | lookup |
| 2.00% | `python` | `_PySet_Contains` | miscobj |
| 1.81% | `python` | `_PyLong_Add` | int |
| 1.74% | `python` | `_PyObject_Malloc` | memory |
| 1.68% | `python` | `long_dealloc` | memory |
...
| 0.46% | `python` | `tuple_subscript` | tuple |
...
| 6.80% | `[JIT]` | `jit` | jit |
| 3.55% | `python` | `_PyObject_Malloc` | memory |
| 3.32% | `python` | `_PyTuple_FromArray.part.0` | tuple |
| 3.00% | `python` | `tuple_dealloc` | memory |
| 2.57% | `python` | `_Py_dict_lookup` | lookup |
| 2.55% | `python` | `weakref___new__` | memory |
| 2.21% | `python` | `_PyObject_Free` | memory |
| 2.13% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.96% | `python` | `_PyObject_MakeTpCall` | dynamic |
| 1.69% | `python` | `_PyType_LookupRefAndVersion` | lookup |
| 1.61% | `python` | `PyArg_UnpackTuple` | calls |
| 1.42% | `python` | `PyObject_RichCompareBool` | dynamic |
...
| 0.32% | `python` | `update_one_slot` | lookup |
| 0.31% | `libc-2.31.so` | `__memcpy_avx_unaligned_erms` | libc |
| 0.30% | `python` | `setiter_iternext` | miscobj |
| 0.28% | `python` | `siphash13` | str |
...
| 1.62% | `python` | `PyNumber_AsSsize_t` | dynamic |
| 1.41% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.14% | `python` | `PyObject_Size` | dynamic |
| 1.11% | `python` | `_io_BytesIO_read` | unknown |
| 1.01% | `python` | `bytes_subscript` | str |
...
| 0.38% | `python` | `PyUnicode_FromEncodedObject` | str |
| 0.36% | `python` | `unicode_decode_utf8.part.0` | str |
| 0.35% | `python` | `unicode_vectorcall` | str |
...
| percentage | object | symbol | category |
| ---: | :--- | :--- | :--- |
| 9.98% | `python` | `_PyEval_EvalFrameDefault` | interpreter |
| 7.35% | `[JIT]` | `jit` | jit |
| 4.72% | `python` | `_PyObject_Malloc` | memory |
| 3.07% | `python` | `_PyObject_Free` | memory |
| 2.85% | `python` | `_PyType_LookupRef` | lookup |
| 2.54% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `normal_contentTok` | library |
| 2.45% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `normal_updatePosition` | library |
| 1.96% | `python` | `_Py_dict_lookup` | lookup |
| 1.53% | `python` | `visit_add_to_container` | gc |
| 1.51% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `accountingDiffTolerated.part.0` | library |
| 1.44% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `sip24_update` | library |
| 1.36% | `python` | `PyObject_GenericGetAttr` | dynamic |
| 1.26% | `python` | `unicodekeys_lookup_unicode` | lookup |
| 1.22% | `python` | `_PyGC_Collect` | gc |
| 1.16% | `python` | `_io_TextIOWrapper_write` | unknown |
| 1.15% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `normal_nameLength` | library |
| 1.08% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `doContent` | library |
| 1.05% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `lookup.constprop.0` | library |
...
| 0.71% | `python` | `PyObject_GetAttr` | dynamic |
| 0.69% | `python` | `PyObject_GC_UnTrack` | gc |
| 0.66% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `expat_end_handler` | library |
| 0.65% | `python` | `_PyEvalFramePushAndInit` | interpreter |
| 0.65% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `elementiter_next` | library |
| 0.63% | `python` | `_PyEval_Vector` | interpreter |
| 0.63% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `normal_getAtts` | library |
| 0.63% | `pyexpat.cpython-314-x86_64-linux-gnu.so` | `sip24_final` | library |
...
| 0.51% | `python` | `_copy_characters.part.0.constprop.0` | str |
| 0.49% | `python` | `_PyObject_GetMethod` | dynamic |
...
| 0.42% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `element_gc_traverse` | library |
...
| 0.35% | `python` | `PyUnicode_Format` | str |
| 0.35% | `libc-2.31.so` | `__strlen_avx2` | libc |
...
| 0.27% | `python` | `r_object` | import |
| 0.27% | `libc-2.31.so` | `__memset_avx2_unaligned_erms` | libc |
| 0.27% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `expat_start_handler` | library |
| 0.27% | `python` | `PyTuple_Pack` | tuple |
| 0.26% | `_elementtree.cpython-314-x86_64-linux-gnu.so` | `makeuniversal.isra.0` | library |
| 0.26% | `libc-2.31.so` | `__memcmp_avx2_movbe` | libc |
...
| ---: | :--- | :--- |
| 16.92% | python | _PyEval_EvalFrameDefault |
| 1.21% | python | _PyFrame_ClearExceptCode |
...
| 0.11% | python | _PyCode_Quicken |
| 0.06% | python | _PyPegen_is_memoized |
| 0.04% | python | call_instrumentation_vector.part.0 |
| 0.04% | python | _PyCode_New |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 2.48% | python | _PyObject_Malloc |
| 1.98% | python | _PyObject_Free |
| 1.16% | python | tuple_dealloc |
| 0.77% | python | list_dealloc |
| 0.69% | python | _Py_Dealloc |
| 0.48% | python | dict_dealloc |
| 0.40% | python | _Py_NewReference |
| 0.39% | python | PyList_New |
| 0.28% | python | PyType_GenericAlloc |
| 0.25% | python | PyTuple_New |
| 0.22% | python | _PyObject_Realloc |
| 0.22% | python | long_dealloc |
...
| 0.11% | python | long_alloc |
| 0.09% | python | _PyObject_Calloc |
| 0.08% | python | float_dealloc |
...
| 0.02% | python | _PyType_AllocNoTrack |
...
| 0.01% | python | _PyFloat_ExactDealloc |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 3.58% | python | gc_collect_region.isra.0 |
| 1.72% | python | visit_add_to_container |
| 1.36% | python | _PyGC_Collect |
| 1.16% | python | visit_decref |
| 0.85% | python | visit_reachable |
| 0.73% | python | PyObject_GC_UnTrack |
| 0.60% | python | dict_traverse |
| 0.28% | python | PyObject_GC_Del |
| 0.28% | python | list_traverse |
| 0.17% | python | _PyObject_GC_New |
| 0.15% | python | _PyObject_GC_Link |
| 0.15% | python | subtype_traverse |
| 0.10% | python | _PyObject_GC_NewVar |
| 0.08% | python | PyObject_IS_GC |
| 0.07% | python | func_traverse |
| 0.05% | python | _PyTuple_MaybeUntrack |
| 0.05% | python | set_traverse |
| 0.05% | python | tuple_traverse |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 4.41% | python | unicodekeys_lookup_unicode |
| 2.47% | python | _Py_dict_lookup |
| 0.90% | python | _PyType_LookupRef |
| 0.59% | python | _PyType_LookupRefAndVersion |
| 0.18% | python | find_name_in_mro |
| 0.14% | python | update_one_slot |
| 0.12% | python | _Py_hashtable_get_entry_generic |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 1.10% | python | PyObject_Hash |
| 0.63% | python | PyObject_RichCompareBool |
| 0.43% | python | PyObject_GenericGetAttr |
| 0.32% | python | PyObject_GetAttr |
| 0.30% | python | PyType_IsSubtype |
| 0.22% | python | PyObject_GetItem |
| 0.22% | python | _PyObject_GenericGetAttrWithDict |
| 0.21% | python | PyNumber_AsSsize_t |
| 0.21% | python | _PyObject_MakeTpCall |
| 0.20% | python | _PyObject_TryGetInstanceAttribute |
| 0.18% | python | _PyObject_GetMethod |
| 0.16% | python | PyObject_GetIter |
| 0.15% | python | PyObject_Vectorcall |
| 0.13% | python | _PyType_GetDict |
| 0.12% | python | PyObject_GetOptionalAttr |
| 0.12% | python | PyObject_IsTrue |
| 0.12% | python | PyObject_Size |
| 0.09% | python | PyObject_Malloc |
| 0.09% | python | type_ready |
...
| 0.05% | python | PyObject_GenericSetAttr |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 1.42% | python | sre_ucs1_match |
| 0.77% | libz.so.1.2.11 | crc32_combine64 |
| 0.40% | python | sre_ucs2_charset.isra.0 |
| 0.35% | libz.so.1.2.11 | inflateBackEnd |
| 0.12% | python | sre_search |
| 0.09% | python | sre_ucs1_count |
| 0.09% | array.cpython-314-x86_64-linux-gnu.so | array_subscr |
| 0.08% | _json.cpython-314-x86_64-linux-gnu.so | scanstring_unicode |
| 0.08% | libpthread-2.31.so | __pthread_mutex_lock |
| 0.08% | libpthread-2.31.so | pthread_mutex_unlock |
| 0.05% | python | _sre_SRE_Pattern_match |
| 0.04% | _json.cpython-314-x86_64-linux-gnu.so | scan_once_unicode |
| 0.04% | _pickle.cpython-314-x86_64-linux-gnu.so | save |
| 0.04% | tracer.cpython-314-x86_64-linux-gnu.so | CTracer_trace |
| 0.03% | pyexpat.cpython-314-x86_64-linux-gnu.so | normal_contentTok |
| 0.03% | ld-2.31.so | do_lookup_x |
...
| 0.03% | array.cpython-314-x86_64-linux-gnu.so | array_ass_subscr |
| 0.03% | _heapq.cpython-314-x86_64-linux-gnu.so | siftup |
| 0.03% | python | sre_ucs4_match |
| 0.03% | libsqlite3.so.0.8.6 | sqlite3_reset |
| 0.02% | python | pattern_subx |
| 0.02% | _asyncio.cpython-314-x86_64-linux-gnu.so | TaskObj_traverse |
| 0.02% | libm-2.31.so | __ieee754_pow_fma |
| 0.02% | libz.so.1.2.11 | adler32_combine64 |
| 0.02% | ld-2.31.so | _dl_relocate_object |
...
| 0.02% | _json.cpython-314-x86_64-linux-gnu.so | py_encode_basestring_ascii |
| 0.02% | libm-2.31.so | __cos_fma |
| 0.02% | pyexpat.cpython-314-x86_64-linux-gnu.so | sip24_update |
| 0.02% | ld-2.31.so | strcmp |
| 0.02% | libm-2.31.so | __fmod_finite@GLIBC_2.15 |
| 0.02% | array.cpython-314-x86_64-linux-gnu.so | d_setitem |
| 0.02% | libz.so.1.2.11 | inflateCodesUsed |
...
| 0.01% | _asyncio.cpython-314-x86_64-linux-gnu.so | TaskStepMethWrapper_call |
| 0.01% | array.cpython-314-x86_64-linux-gnu.so | d_getitem |
| 0.01% | libz.so.1.2.11 | inflate |
| 0.01% | _asyncio.cpython-314-x86_64-linux-gnu.so | _asyncio_Task___init__ |
| 0.01% | ld-2.31.so | _dl_lookup_symbol_x |
| 0.01% | python | sre_ucs2_match |
| 0.01% | ld-2.31.so | check_match |
| 0.01% | libm-2.31.so | __sin_fma |
...
| 0.01% | _bisect.cpython-314-x86_64-linux-gnu.so | _bisect_bisect_right |
| 0.01% | _json.cpython-314-x86_64-linux-gnu.so | encoder_listencode_obj |
| 0.01% | array.cpython-314-x86_64-linux-gnu.so | 0x00000000000047e4 |
| 0.01% | _asyncio.cpython-314-x86_64-linux-gnu.so | task_wakeup |
| 0.01% | _pickle.cpython-314-x86_64-linux-gnu.so | PyMemoTable_Set |
| 0.01% | array.cpython-314-x86_64-linux-gnu.so | 0x0000000000004644 |
...
| 0.01% | _pickle.cpython-314-x86_64-linux-gnu.so | Pickler_clear |
| 0.01% | fastbinary.cpython-314-x86_64-linux-gnu.so | apache::thrift::py::ProtocolBase<apache::thrift::py::BinaryProtocol>::encodeValue |
| 0.01% | array.cpython-314-x86_64-linux-gnu.so | 0x00000000000049c4 |
| 0.01% | _decimal.cpython-314-x86_64-linux-gnu.so | nm_mpd_qadd |
| 0.01% | _decimal.cpython-314-x86_64-linux-gnu.so | _mpd_check_exp |
...
| 0.01% | _json.cpython-314-x86_64-linux-gnu.so | encoder_encode_key_value |
| 0.01% | _elementtree.cpython-314-x86_64-linux-gnu.so | element_gc_clear |
| 0.01% | _decimal.cpython-314-x86_64-linux-gnu.so | _mpd_qaddsub |
| 0.01% | libsqlite3.so.0.8.6 | sqlite3_preupdate_old |
| 0.01% | _asyncio.cpython-314-x86_64-linux-gnu.so | TaskStepMethWrapper_traverse |
| 0.00% | libsqlite3.so.0.8.6 | sqlite3_value_double |
| 0.00% | _pickle.cpython-314-x86_64-linux-gnu.so | _Pickler_Write |
| 0.00% | _decimal.cpython-314-x86_64-linux-gnu.so | _mpd_qmul |
| 0.00% | _asyncio.cpython-314-x86_64-linux-gnu.so | TaskObj_dealloc |
| 0.00% | math.cpython-314-x86_64-linux-gnu.so | math_sqrt |
| 0.00% | math.cpython-314-x86_64-linux-gnu.so | math_factorial |
| 0.00% | python | sre_ucs4_count |
| 0.00% | _decimal.cpython-314-x86_64-linux-gnu.so | nm_mpd_qmul |
| 0.00% | libsqlite3.so.0.8.6 | sqlite3_wal_checkpoint |
| 0.00% | libsqlite3.so.0.8.6 | sqlite3_value_int64 |
| 0.00% | _decimal.cpython-314-x86_64-linux-gnu.so | mpd_setdigits |
| 0.00% | _heapq.cpython-314-x86_64-linux-gnu.so | siftdown |
| 0.00% | _asyncio.cpython-314-x86_64-linux-gnu.so | _asyncio_future_discard_from_awaited_by |
...
| 0.00% | _heapq.cpython-314-x86_64-linux-gnu.so | _heapq_heappop |
| 0.00% | _decimal.cpython-314-x86_64-linux-gnu.so | _mpd_baseshiftr |
...
| 0.00% | _asyncio.cpython-314-x86_64-linux-gnu.so | TaskObj_finalize |
| 0.00% | unicodedata.cpython-314-x86_64-linux-gnu.so | unicodedata_UCD_combining |
| 0.00% | python | _sre_SRE_Pattern_sub |
| 0.00% | libsqlite3.so.0.8.6 | sqlite3_vtab_config |
| 0.00% | _asyncio.cpython-314-x86_64-linux-gnu.so | _asyncio_Future_add_done_callback |
| 0.00% | python | sys_trace_start |
| 0.00% | _decimal.cpython-314-x86_64-linux-gnu.so | PyDecType_New.isra.0 |
| 0.00% | libsqlite3.so.0.8.6 | sqlite3_extended_errcode |
| 0.00% | pyexpat.cpython-314-x86_64-linux-gnu.so | utf8_toUtf8 |
| 0.00% | _elementtree.cpython-314-x86_64-linux-gnu.so | treebuilder_extend_element_text_or_tail.isra.0 |
| 0.00% | _decimal.cpython-314-x86_64-linux-gnu.so | mpd_qquantize |
| 0.00% | _elementtree.cpython-314-x86_64-linux-gnu.so | element_dealloc |
| 0.00% | array.cpython-314-x86_64-linux-gnu.so | 0x0000000000004854 |
| 0.00% | _pickle.cpython-314-x86_64-linux-gnu.so | memo_get.isra.0 |
| 0.00% | _elementtree.cpython-314-x86_64-linux-gnu.so | create_new_element.isra.0 |
| 0.00% | _decimal.cpython-314-x86_64-linux-gnu.so | dec_addstatus |
| 0.00% | libsqlite3.so.0.8.6 | sqlite3_enable_shared_cache |
| 0.00% | math.cpython-314-x86_64-linux-gnu.so | math_gcd |
...
| 0.00% | _decimal.cpython-314-x86_64-linux-gnu.so | dec_dealloc |
| 0.00% | libsqlite3.so.0.8.6 | sqlite3_step |
| 0.00% | _asyncio.cpython-314-x86_64-linux-gnu.so | _asyncio_future_add_to_awaited_by |
| 0.00% | math.cpython-314-x86_64-linux-gnu.so | math_cos |
| 0.00% | _pickle.cpython-314-x86_64-linux-gnu.so | Pickler_traverse |
| 0.00% | tracer.cpython-314-x86_64-linux-gnu.so | CTracer_set_pdata_stack |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.95% | python | PyDict_GetItemRef |
| 0.74% | python | dictiter_iternextkey |
| 0.43% | python | insertdict |
| 0.25% | python | build_indices_unicode |
| 0.14% | python | dict_subscript |
| 0.12% | python | insert_to_emptydict |
| 0.09% | python | find_empty_slot |
| 0.09% | python | _PyDict_GetItemRef_KnownHash |
| 0.09% | python | dict_get |
| 0.08% | python | dict_setdefault_ref_lock_held |
| 0.07% | python | PyDict_Contains |
| 0.07% | python | new_dict.isra.0 |
| 0.06% | python | _PyDict_SetItem_Take2 |
| 0.06% | python | dictiter_iternextitem |
| 0.05% | python | dict_merge |
| 0.05% | python | _PyDict_FromItems |
| 0.05% | python | dict_ass_sub |
| 0.04% | python | PyDict_Next |
| 0.04% | python | dictresize |
| 0.04% | python | PyDict_SetItem |
| 0.03% | python | dict_update |
| 0.03% | python | _PyDict_LoadBuiltinsFromGlobals |
| 0.02% | python | _PyDict_Next |
| 0.02% | python | _PyDict_LoadGlobalStackRef |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.81% | python | long_hash |
| 0.64% | python | k_mul |
| 0.33% | python | _PyLong_Add |
| 0.27% | python | _PyLong_FromMedium |
| 0.16% | python | _PyLong_Subtract |
| 0.16% | python | x_divrem |
| 0.13% | python | long_to_decimal_string_internal |
| 0.12% | python | PyLong_AsSsize_t |
| 0.12% | python | PyLong_FromSsize_t |
| 0.08% | python | PyLong_FromLong |
| 0.07% | python | _PyLong_GCD |
| 0.06% | python | x_add |
| 0.05% | python | long_richcompare |
| 0.04% | python | x_sub |
| 0.03% | python | _PyLong_Multiply |
| 0.03% | python | long_div |
| 0.03% | python | long_bitwise |
| 0.03% | python | PyLong_AsLongAndOverflow |
| 0.02% | python | PyLong_FromString |
| 0.02% | python | long_mul_method |
| 0.02% | python | long_lshift_int64 |
| 0.02% | python | _PyLong_Rshift |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 2.01% | python | tuple_hash |
| 0.46% | python | _PyTuple_FromArray.part.0 |
| 0.39% | python | _PyTuple_FromStackRefStealOnSuccess |
| 0.26% | python | tuple_richcompare |
| 0.05% | python | tuple_iter |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.32% | python | siphash13 |
| 0.15% | python | _PyUnicode_JoinArray.part.0 |
| 0.14% | python | _PyUnicode_Equal |
| 0.14% | python | PyUnicode_Format |
| 0.13% | python | PyUnicode_RichCompare |
| 0.09% | python | replace |
| 0.09% | python | _PyUnicode_FromUCS1.part.0 |
| 0.08% | python | _copy_characters.part.0.constprop.0 |
| 0.08% | python | split |
| 0.08% | python | resize_compact |
| 0.07% | python | find_first_nonascii |
| 0.07% | python | intern_constants |
...
| 0.03% | python | _PyUnicode_InternImmortal |
| 0.03% | python | unicode_rstrip |
| 0.03% | python | intern_common.part.0 |
| 0.03% | python | _PyUnicode_InternMortal |
| 0.02% | python | unicode_repr |
| 0.02% | python | PyUnicode_Decode.part.0 |
| 0.02% | python | unicode_from_format |
| 0.02% | python | PyUnicodeWriter_Create |
...
| 0.02% | python | bytes_decode |
| 0.02% | python | bytes_hash |
| 0.02% | python | unicode_replace |
| 0.02% | python | PyUnicode_FromEncodedObject |
...
| 0.01% | python | PyUnicodeWriter_Discard |
...
| 0.00% | python | unicode_rpartition |
...
| 0.00% | python | _PyUnicode_ToDecimalDigit |
| 0.00% | python | PyUnicode_Append |
| 0.00% | python | _PyUnicode_EqualToASCIIString |
...
| 0.00% | python | _PyUnicode_IsLowercase |
...
| 0.02% | python | _Py_convert_optional_to_ssize_t |
...
| 0.01% | python | code_hash |
| 0.01% | python | tailmatch |
| 0.01% | python | _buffered_readline |
...
| 0.01% | python | _io__Buffered_readline |
...
| 0.00% | python | bitwise_xor_rule |
| 0.00% | python | sm_descr_get |
| 0.00% | python | gallop_right |
| 0.00% | python | 0x0000000000086770 |
| 0.00% | python | bitwise_or_rule |
| 0.00% | python | _PyInstructionSequence_Addop |
...
| 0.00% | python | _PyIO_find_line_ending |
| 0.00% | python | builtin___build_class__ |
| 0.00% | python | _io_FileIO___init__ |
| 0.00% | python | slot_nb_bool |
| 0.00% | python | _PyObjectDict_SetItem |
| 0.00% | python | os_stat |
| 0.00% | python | 0x0000000000086778 |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.91% | python | set_lookkey |
| 0.33% | python | PySlice_AdjustIndices |
| 0.18% | python | _PySet_Contains |
| 0.10% | python | PySlice_Unpack |
| 0.07% | python | _PyBuildSlice_ConsumeRefs |
| 0.06% | python | gen_iternext |
| 0.05% | python | make_gen |
| 0.05% | python | set_add_entry |
...
| 0.01% | python | bytearray_ass_subscript |
...
| 0.03% | [kernel.kallsyms] | clear_bhb_loop |
...
| 0.02% | [kernel.kallsyms] | link_path_walk.part.0 |
...
| 0.01% | [kernel.kallsyms] | copy_page |
| 0.01% | [kernel.kallsyms] | smp_call_function_single |
| 0.01% | [kernel.kallsyms] | __ext4fs_dirhash |
| 0.01% | [kernel.kallsyms] | __count_memcg_events |
| 0.01% | [kernel.kallsyms] | find_get_entry |
...
| 0.01% | [kernel.kallsyms] | lookup_fast |
...
| 0.01% | [kernel.kallsyms] | entry_SYSCALL_64 |
...
| 0.00% | [kernel.kallsyms] | _cond_resched |
| 0.00% | [kernel.kallsyms] | __follow_mount_rcu.isra.0 |
| 0.00% | [kernel.kallsyms] | set_root |
| 0.00% | [kernel.kallsyms] | format_decode |
| 0.00% | [kernel.kallsyms] | xas_load |
| 0.00% | [kernel.kallsyms] | kthread_blkcg |
| 0.00% | [kernel.kallsyms] | page_add_file_rmap |
| 0.00% | [kernel.kallsyms] | fpregs_assert_state_consistent |
| 0.00% | [kernel.kallsyms] | vsnprintf |
| 0.00% | [kernel.kallsyms] | free_unref_page_commit |
| 0.00% | [kernel.kallsyms] | page_counter_try_charge |
| 0.00% | [kernel.kallsyms] | free_pages_and_swap_cache |
| 0.00% | [kernel.kallsyms] | show_cpuinfo |
| 0.00% | [kernel.kallsyms] | security_inode_getattr |
| 0.00% | [kernel.kallsyms] | _raw_spin_lock_irqsave |
| 0.00% | [kernel.kallsyms] | in_group_p |
| 0.00% | [kernel.kallsyms] | __kmalloc |
| 0.00% | [kernel.kallsyms] | __fget_light |
| 0.00% | [kernel.kallsyms] | __vma_adjust |
| 0.00% | [kernel.kallsyms] | fsnotify |
| 0.00% | [kernel.kallsyms] | alloc_set_pte |
| 0.00% | [kernel.kallsyms] | rcu_all_qs |
| 0.00% | [kernel.kallsyms] | pmd_devmap_trans_unstable |
| 0.00% | [kernel.kallsyms] | update_load_avg |
| 0.00% | [kernel.kallsyms] | __legitimize_mnt |
| 0.00% | [kernel.kallsyms] | page_add_new_anon_rmap |
| 0.00% | [kernel.kallsyms] | security_inode_permission |
| 0.00% | [kernel.kallsyms] | string_nocheck |
| 0.00% | [kernel.kallsyms] | update_curr |
| 0.00% | [kernel.kallsyms] | unlock_page |
| 0.00% | [kernel.kallsyms] | mem_cgroup_update_lru_size |
| 0.00% | [kernel.kallsyms] | native_write_msr |
| 0.00% | [kernel.kallsyms] | __ext4_check_dir_entry |
| 0.00% | [kernel.kallsyms] | uncharge_page |
| 0.00% | [kernel.kallsyms] | memchr |
| 0.00% | [kernel.kallsyms] | __do_page_fault |
| 0.00% | [kernel.kallsyms] | memcg_kmem_put_cache |
...
| 0.00% | [kernel.kallsyms] | call_filldir |
| 0.00% | [kernel.kallsyms] | reweight_entity |
| 0.00% | [kernel.kallsyms] | __check_object_size |
...
| 0.00% | [kernel.kallsyms] | ___slab_alloc |
...
| 0.00% | [kernel.kallsyms] | __check_heap_object |
...
| 0.21% | libc-2.31.so | __memcmp_avx2_movbe |
| 0.18% | libc-2.31.so | _int_malloc |
| 0.09% | libc-2.31.so | _int_free |
| 0.08% | libc-2.31.so | __strlen_avx2 |
| 0.07% | libc-2.31.so | __libc_malloc |
| 0.05% | libc-2.31.so | __memset_avx2_erms |
| 0.04% | libc-2.31.so | unlink_chunk.isra.0 |
| 0.03% | libc-2.31.so | pthread_self |
| 0.03% | libc-2.31.so | __memchr_avx2 |
| 0.02% | libc-2.31.so | cfree@GLIBC_2.2.5 |
| 0.02% | libc-2.31.so | __strchr_avx2 |
| 0.01% | libc-2.31.so | wcsrtombs |
| 0.01% | libc-2.31.so | __gconv_transform_internal_utf8 |
...
| 0.00% | libc-2.31.so | __mbsrtowcs_l |
| 0.00% | libc-2.31.so | clock_gettime@@GLIBC_2.17 |
| 0.00% | libc-2.31.so | __memrchr_avx2 |
| 0.00% | libc-2.31.so | __xstat64 |
| 0.00% | libc-2.31.so | __dcigettext |
| 0.00% | libcrypto.so.1.1 | EVP_DecodeUpdate |
...
| 0.18% | python | list_subscript |
| 0.17% | python | list_slice_lock_held.isra.0 |
...
| 0.06% | python | method_vectorcall_O |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.21% | python | _PyThreadState_PopFrame |
| 0.12% | python | _PyThreadState_PushFrame |
| 0.08% | python | PyThreadState_Get |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.19% | python | _PyFloat_FromDouble_ConsumeInputs |
| 0.09% | python | PyFloat_FromDouble |
...
| 0.00% | python | PyFloat_AsDouble.part.0 |
...
| percentage | object | symbol |
| ---: | :--- | :--- |
| 0.18% | python | r_object |
| 0.02% | python | r_string |
