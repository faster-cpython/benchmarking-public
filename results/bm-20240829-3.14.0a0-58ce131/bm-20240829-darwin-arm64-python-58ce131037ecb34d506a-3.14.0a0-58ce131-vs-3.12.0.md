...
| tornado_http   | 69.3 ms                                                | 86.4 ms: 1.25x slower                                                 |
...
| Benchmark                  | bm-20231002-darwin-arm64-python-v3.12.0-3.12.0-0fb18b0 | bm-20240829-darwin-arm64-python-58ce131037ecb34d506a-3.14.0a0-58ce131 |
|----------------------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
| async_tree_none            | 266 ms                                                 | 195 ms: 1.37x faster                                                  |
...
| sympy_sum                  | 77.6 ms                                                | 68.6 ms: 1.13x faster                                                 |
| django_template            | 22.3 ms                                                | 19.8 ms: 1.13x faster                                                 |
...
| pprint_pformat             | 1.01 sec                                               | 925 ms: 1.09x faster                                                  |
| mako                       | 7.71 ms                                                | 7.10 ms: 1.09x faster                                                 |
