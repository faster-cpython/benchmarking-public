...
| pickle_pure_python   | 455 us                                                       | 319 us: 1.42x faster                                                        |
...
| bench_thread_pool        | 1.14 ms                                                      | 881 us: 1.30x faster                                                        |
| xml_etree_process        | 75.9 ms                                                      | 59.1 ms: 1.29x faster                                                       |
| json_dumps               | 14.5 ms                                                      | 11.4 ms: 1.28x faster                                                       |
...
| async_generators         | 421 ms                                                       | 352 ms: 1.20x faster                                                        |
...
| bench_mp_pool            | 6.37 ms                                                      | 2.09 sec: 328.33x slower                                                    |
...
Ignored benchmarks (1) of results/bm-20241012-3.14.0a0-330c527/bm-20241012-pythonperf2-x86_64-python-330c527299a5380f39c6-3.14.0a0-330c527.json: bpe_tokeniser
