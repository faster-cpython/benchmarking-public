...
- Geometric mean: 1.367x faster (HPT: reliability of 100.00%, 1.18x faster at 99th %ile)
- Memory usage: 1.37x
...
- Geometric mean: 1.043x faster (HPT: reliability of 97.57%, 1.00x faster at 99th %ile)
- Memory usage: 1.18x
...
- Geometric mean: 1.015x slower (HPT: reliability of 80.83%, 1.00x slower at 99th %ile)
- Memory usage: 1.11x
...
- [📄table](bm-20240904-linux-x86_64-brandtbucher-ujb0_project_confide-3.14.0a0-d467f6c-vs-3.13.0.md)
- [📈time plot](bm-20240904-linux-x86_64-brandtbucher-ujb0_project_confide-3.14.0a0-d467f6c-vs-3.13.0.svg)
