...
- [📄table](bm-20240824-arminc-aarch64-PeterYang12-accelerate_DJBX33A-3.14.0a0-bf9cfa8-vs-3.13.0.md)
- [📈time plot](bm-20240824-arminc-aarch64-PeterYang12-accelerate_DJBX33A-3.14.0a0-bf9cfa8-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x slower (HPT: reliability of 89.82%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
...
- Geometric mean: 1.44x faster (HPT: reliability of 100.00%, 1.33x faster at 99th %ile)
- Memory usage: 1.13x
...
- [📄table](bm-20240824-linux-x86_64-PeterYang12-accelerate_DJBX33A-3.14.0a0-bf9cfa8-vs-3.13.0.md)
- [📈time plot](bm-20240824-linux-x86_64-PeterYang12-accelerate_DJBX33A-3.14.0a0-bf9cfa8-vs-3.13.0.svg)
...
- Geometric mean: 1.02x faster (HPT: reliability of 68.43%, 1.00x faster at 99th %ile)
- Memory usage: 0.93x
- missing benchmarks: aiohttp, chameleon, dask, dulwich_log, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlalchemy_declarative, sqlalchemy_imperative, sqlite_synth, unpack_sequence, unpickle, unpickle_list
- new benchmarks: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, thrift
...
- [📄table](bm-20240824-pythonperf2-x86_64-PeterYang12-accelerate_DJBX33A-3.14.0a0-bf9cfa8-vs-3.13.0.md)
- [📈time plot](bm-20240824-pythonperf2-x86_64-PeterYang12-accelerate_DJBX33A-3.14.0a0-bf9cfa8-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x faster (HPT: reliability of 68.16%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
...
- Memory usage: 0.99x
- missing benchmarks: aiohttp, chameleon, dask, flaskblogging, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlite_synth, unpack_sequence, unpickle, unpickle_list
- [📄table](bm-20240824-darwin-arm64-PeterYang12-accelerate_DJBX33A-3.14.0a0-bf9cfa8-vs-3.13.0.md)
- [📈time plot](bm-20240824-darwin-arm64-PeterYang12-accelerate_DJBX33A-3.14.0a0-bf9cfa8-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x faster (HPT: reliability of 58.33%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
