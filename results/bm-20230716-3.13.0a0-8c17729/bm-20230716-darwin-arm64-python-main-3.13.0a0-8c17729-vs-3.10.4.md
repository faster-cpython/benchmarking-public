...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230716-darwin-arm64-python-main-3.13.0a0-8c17729 |
|----------------|:------------------------------------------------------:|:-----------------------------------------------------:|
...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230716-darwin-arm64-python-main-3.13.0a0-8c17729 |
|----------------|:------------------------------------------------------:|:-----------------------------------------------------:|
| nbody          | 94.1 ms                                                | 73.0 ms: 1.29x faster                                 |
| float          | 72.3 ms                                                | 60.6 ms: 1.19x faster                                 |
...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230716-darwin-arm64-python-main-3.13.0a0-8c17729 |
|----------------|:------------------------------------------------------:|:-----------------------------------------------------:|
| regex_compile  | 96.6 ms                                                | 81.7 ms: 1.18x faster                                 |
...
| json_dumps           | 8.38 ms                                                | 6.80 ms: 1.23x faster                                 |
| unpickle_pure_python | 203 us                                                 | 166 us: 1.22x faster                                  |
| xml_etree_process    | 45.1 ms                                                | 41.6 ms: 1.08x faster                                 |
...
| xml_etree_iterparse  | 72.6 ms                                                | 78.1 ms: 1.07x slower                                 |
| xml_etree_generate   | 54.3 ms                                                | 59.4 ms: 1.09x slower                                 |
...
| Benchmark | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230716-darwin-arm64-python-main-3.13.0a0-8c17729 |
|-----------|:------------------------------------------------------:|:-----------------------------------------------------:|
| mako      | 10.5 ms                                                | 7.84 ms: 1.34x faster                                 |
...
| Benchmark                | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230716-darwin-arm64-python-main-3.13.0a0-8c17729 |
|--------------------------|:------------------------------------------------------:|:-----------------------------------------------------:|
| typing_runtime_protocols | 344 us                                                 | 96.3 us: 3.57x faster                                 |
| deltablue                | 5.15 ms                                                | 2.91 ms: 1.77x faster                                 |
| crypto_pyaes             | 78.0 ms                                                | 48.6 ms: 1.61x faster                                 |
| chaos                    | 66.8 ms                                                | 43.2 ms: 1.55x faster                                 |
...
| go                       | 165 ms                                                 | 123 ms: 1.34x faster                                  |
| mako                     | 10.5 ms                                                | 7.84 ms: 1.34x faster                                 |
| scimark_monte_carlo      | 72.2 ms                                                | 54.3 ms: 1.33x faster                                 |
| hexiom                   | 6.32 ms                                                | 4.80 ms: 1.32x faster                                 |
| asyncio_tcp_ssl          | 1.64 sec                                               | 1.26 sec: 1.31x faster                                |
| nbody                    | 94.1 ms                                                | 73.0 ms: 1.29x faster                                 |
| pycparser                | 915 ms                                                 | 718 ms: 1.28x faster                                  |
| deepcopy_memo            | 34.5 us                                                | 27.1 us: 1.27x faster                                 |
...
| regex_compile            | 96.6 ms                                                | 81.7 ms: 1.18x faster                                 |
| mypy2                    | 308 ms                                                 | 267 ms: 1.15x faster                                  |
...
| bench_thread_pool        | 548 us                                                 | 505 us: 1.09x faster                                  |
...
| unpickle                 | 9.77 us                                                | 9.30 us: 1.05x faster                                 |
| sqlglot_optimize         | 38.0 ms                                                | 36.3 ms: 1.05x faster                                 |
