...
- Geometric mean: 1.01x faster (HPT: reliability of 65.19%, 1.00x faster at 99th %ile)
- Memory usage: 1.08x
...
- [📄table](bm-20240813-linux-x86_64-python-325e9b8ef400b86fb077-3.14.0a0-325e9b8-vs-3.13.0.md)
- [📈time plot](bm-20240813-linux-x86_64-python-325e9b8ef400b86fb077-3.14.0a0-325e9b8-vs-3.13.0.svg)
