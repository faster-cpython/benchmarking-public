...
- Geometric mean: 1.01x faster (HPT: reliability of 58.76%, 1.00x faster at 99th %ile)
- Memory usage: 1.07x
...
- [📄table](bm-20240712-linux-x86_64-brandtbucher-for_iter_tier_two_ex-3.14.0a0-e627230-vs-3.13.0.md)
- [📈time plot](bm-20240712-linux-x86_64-brandtbucher-for_iter_tier_two_ex-3.14.0a0-e627230-vs-3.13.0.svg)
