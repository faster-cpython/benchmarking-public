...
| xml_etree_process      | 53.9 ms                                                | 55.0 ms: 1.02x slower                                                     |
| django_template        | 32.6 ms                                                | 33.3 ms: 1.02x slower                                                     |
| chaos                  | 69.2 ms                                                | 70.8 ms: 1.02x slower                                                     |
...
Benchmark hidden because not significant (13): async_tree_none, async_tree_io, coverage, mako, sqlalchemy_imperative, go, chameleon, djangocms, bench_mp_pool, deepcopy_reduce, pickle, async_tree_cpu_io_mixed, scimark_sparse_mat_mult
