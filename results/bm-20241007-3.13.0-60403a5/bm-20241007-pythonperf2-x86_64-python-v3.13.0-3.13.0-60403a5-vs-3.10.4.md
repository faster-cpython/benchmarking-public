...
| genshi_xml      | 63.3 ms                                                      | 57.3 ms: 1.10x faster                                        |
...
| richards                 | 75.1 ms                                                      | 52.7 ms: 1.42x faster                                        |
| mako                     | 14.7 ms                                                      | 10.4 ms: 1.41x faster                                        |
...
| json_loads               | 30.3 us                                                      | 24.0 us: 1.26x faster                                        |
| deepcopy_memo            | 49.8 us                                                      | 39.5 us: 1.26x faster                                        |
...
| pidigits                 | 271 ms                                                       | 253 ms: 1.07x faster                                         |
| regex_dna                | 261 ms                                                       | 244 ms: 1.07x faster                                         |
| unpack_sequence          | 59.9 ns                                                      | 56.8 ns: 1.05x faster                                        |
| regex_v8                 | 27.2 ms                                                      | 26.2 ms: 1.04x faster                                        |
...
Benchmark hidden because not significant (2): unpickle_list, create_gc_cycles
