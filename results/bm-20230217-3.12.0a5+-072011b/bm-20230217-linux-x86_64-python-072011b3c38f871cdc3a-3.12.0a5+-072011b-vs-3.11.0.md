...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230217-linux-x86_64-python-072011b3c38f871cdc3a-3.12.0a5+-072011b |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| float          | 77.2 ms                                                | 74.8 ms: 1.03x faster                                                  |
...
| scimark_sparse_mat_mult | 4.50 ms                                                | 4.26 ms: 1.06x faster                                                  |
| html5lib                | 64.5 ms                                                | 61.1 ms: 1.06x faster                                                  |
...
| python_startup          | 8.52 ms                                                | 9.04 ms: 1.06x slower                                                  |
| async_tree_memoization  | 627 ms                                                 | 669 ms: 1.07x slower                                                   |
| xml_etree_generate      | 76.2 ms                                                | 81.9 ms: 1.07x slower                                                  |
| python_startup_no_site  | 6.01 ms                                                | 6.55 ms: 1.09x slower                                                  |
...
Benchmark hidden because not significant (7): nbody, bench_mp_pool, regex_v8, go, djangocms, async_tree_none, chameleon
