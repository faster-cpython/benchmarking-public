...
| tornado_http   | 96.3 ms                                                | 91.9 ms: 1.05x faster                                                        |
...
| Benchmark              | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230316-linux-x86_64-brandtbucher-compare_and_not_bran-3.12.0a6+-d42ac00 |
|------------------------|:------------------------------------------------------:|:----------------------------------------------------------------------------:|
| python_startup         | 8.52 ms                                                | 8.91 ms: 1.04x slower                                                        |
...
| regex_compile           | 138 ms                                                 | 135 ms: 1.02x faster                                                         |
| scimark_sparse_mat_mult | 4.50 ms                                                | 4.41 ms: 1.02x faster                                                        |
...
Benchmark hidden because not significant (7): unpickle, async_tree_cpu_io_mixed, pycparser, djangocms, bench_mp_pool, dulwich_log, genshi_text
