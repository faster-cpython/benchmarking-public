...
| Benchmark      | bm-20220323-linux-x86_64-python-v3.10.4-3.10.4-9d38120 | bm-20230428-linux-x86_64-brandtbucher-immortal_interpreter-3.12.0a7+-7f90633 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------------:|
...
| Benchmark              | bm-20220323-linux-x86_64-python-v3.10.4-3.10.4-9d38120 | bm-20230428-linux-x86_64-brandtbucher-immortal_interpreter-3.12.0a7+-7f90633 |
|------------------------|:------------------------------------------------------:|:----------------------------------------------------------------------------:|
| python_startup         | 14.2 ms                                                | 9.08 ms: 1.56x faster                                                        |
...
| unpickle                | 14.1 us                                                | 14.9 us: 1.06x slower                                                        |
| regex_effbot            | 3.23 ms                                                | 3.41 ms: 1.06x slower                                                        |
| telco                   | 6.54 ms                                                | 7.06 ms: 1.08x slower                                                        |
| python_startup_no_site  | 5.82 ms                                                | 6.66 ms: 1.14x slower                                                        |
| pickle_dict             | 27.3 us                                                | 32.6 us: 1.20x slower                                                        |
