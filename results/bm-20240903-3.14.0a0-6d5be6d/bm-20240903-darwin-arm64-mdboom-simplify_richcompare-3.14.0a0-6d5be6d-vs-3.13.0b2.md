...
| Benchmark      | bm-20240605-darwin-arm64-python-v3.13.0b2-3.13.0b2-3a83b17 | bm-20240903-darwin-arm64-mdboom-simplify_richcompare-3.14.0a0-6d5be6d |
|----------------|:----------------------------------------------------------:|:---------------------------------------------------------------------:|
| docutils       | 1.44 sec                                                   | 1.45 sec: 1.01x slower                                                |
| html5lib       | 31.2 ms                                                    | 30.2 ms: 1.03x faster                                                 |
| tornado_http   | 66.7 ms                                                    | 83.4 ms: 1.25x slower                                                 |
...
Benchmark hidden because not significant (8): async_tree_memoization, async_tree_eager_memoization_tg, async_tree_eager, async_tree_none_tg, async_tree_memoization_tg, async_tree_cpu_io_mixed_tg, async_tree_eager_memoization, async_tree_io_tg
...
| comprehensions                   | 10.2 us                                                    | 9.95 us: 1.02x faster                                                 |
...
| genshi_text                      | 13.9 ms                                                    | 13.8 ms: 1.01x faster                                                 |
| nbody                            | 59.6 ms                                                    | 59.3 ms: 1.00x faster                                                 |
| sympy_sum                        | 69.2 ms                                                    | 69.0 ms: 1.00x faster                                                 |
...
Benchmark hidden because not significant (17): async_tree_memoization, async_tree_eager_memoization_tg, async_tree_eager, scimark_lu, pyflate, pidigits, hexiom, 2to3, sympy_str, json, async_tree_none_tg, async_tree_memoization_tg, async_tree_cpu_io_mixed_tg, async_tree_eager_memoization, async_tree_io_tg, asyncio_tcp, pylint
