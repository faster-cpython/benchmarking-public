...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230205-darwin-arm64-python-ef7c2bfcf1fd618438f9-3.12.0a4+-ef7c2bf |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| regex_compile  | 96.6 ms                                                | 72.4 ms: 1.33x faster                                                  |
...
| json_dumps           | 8.38 ms                                                | 6.11 ms: 1.37x faster                                                  |
...
| xml_etree_parse      | 107 ms                                                 | 96.4 ms: 1.11x faster                                                  |
...
| unpickle_list        | 2.66 us                                                | 2.66 us: 1.00x faster                                                  |
...
| asyncio_tcp             | 673 ms                                                 | 459 ms: 1.47x faster                                                   |
...
| logging_format          | 5.01 us                                                | 3.90 us: 1.28x faster                                                  |
| sqlalchemy_imperative   | 9.03 ms                                                | 7.03 ms: 1.28x faster                                                  |
| chameleon               | 5.84 ms                                                | 4.56 ms: 1.28x faster                                                  |
...
| async_tree_cpu_io_mixed | 670 ms                                                 | 543 ms: 1.24x faster                                                   |
| docutils                | 1.78 sec                                               | 1.46 sec: 1.22x faster                                                 |
...
| sqlalchemy_declarative  | 74.8 ms                                                | 63.0 ms: 1.19x faster                                                  |
