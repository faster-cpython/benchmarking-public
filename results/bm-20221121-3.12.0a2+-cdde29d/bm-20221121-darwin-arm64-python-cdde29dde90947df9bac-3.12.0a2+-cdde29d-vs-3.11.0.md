...
Benchmark hidden because not significant (3): xml_etree_process, pickle_list, xml_etree_generate
...
Benchmark hidden because not significant (9): tornado_http, mypy, xml_etree_process, docutils, pickle_list, mdp, xml_etree_generate, pycparser, bench_mp_pool
