...
| Benchmark      | bm-20220323-arminc-aarch64-python-9d38120e335357a3b294-3.10.4-9d38120 | bm-20240930-arminc-aarch64-Yhg1s-3.13_revert_incremen-3.13.0rc2+-1ba3555 |
|----------------|:---------------------------------------------------------------------:|:------------------------------------------------------------------------:|
| 2to3           | 381 ms                                                                | 305 ms: 1.25x faster                                                     |
| chameleon      | 10.8 ms                                                               | 9.12 ms: 1.19x faster                                                    |
...
| async_tree_memoization  | 1.13 sec                                                              | 617 ms: 1.84x faster                                                     |
...
| float          | 135 ms                                                                | 93.5 ms: 1.44x faster                                                    |
...
| Benchmark              | bm-20220323-arminc-aarch64-python-9d38120e335357a3b294-3.10.4-9d38120 | bm-20240930-arminc-aarch64-Yhg1s-3.13_revert_incremen-3.13.0rc2+-1ba3555 |
|------------------------|:---------------------------------------------------------------------:|:------------------------------------------------------------------------:|
| python_startup         | 11.2 ms                                                               | 13.4 ms: 1.20x slower                                                    |
...
| Benchmark                | bm-20220323-arminc-aarch64-python-9d38120e335357a3b294-3.10.4-9d38120 | bm-20240930-arminc-aarch64-Yhg1s-3.13_revert_incremen-3.13.0rc2+-1ba3555 |
|--------------------------|:---------------------------------------------------------------------:|:------------------------------------------------------------------------:|
| typing_runtime_protocols | 661 us                                                                | 194 us: 3.42x faster                                                     |
| deltablue                | 8.94 ms                                                               | 3.86 ms: 2.32x faster                                                    |
| async_tree_io            | 2.28 sec                                                              | 1.10 sec: 2.08x faster                                                   |
| async_tree_none          | 950 ms                                                                | 486 ms: 1.96x faster                                                     |
| raytrace                 | 573 ms                                                                | 298 ms: 1.92x faster                                                     |
| bench_mp_pool            | 14.5 ms                                                               | 7.65 ms: 1.90x faster                                                    |
| async_tree_memoization   | 1.13 sec                                                              | 617 ms: 1.84x faster                                                     |
...
| django_template          | 53.3 ms                                                               | 41.5 ms: 1.28x faster                                                    |
| dask                     | 450 ms                                                                | 352 ms: 1.28x faster                                                     |
...
| create_gc_cycles         | 2.26 ms                                                               | 2.13 ms: 1.06x faster                                                    |
| xml_etree_parse          | 212 ms                                                                | 200 ms: 1.06x faster                                                     |
| unpickle_list            | 6.99 us                                                               | 6.63 us: 1.05x faster                                                    |
| flaskblogging            | 4.83 ms                                                               | 4.64 ms: 1.04x faster                                                    |
| xml_etree_iterparse      | 156 ms                                                                | 150 ms: 1.04x faster                                                     |
...
Ignored benchmarks (6) of results/bm-20240930-3.13.0rc2+-1ba3555/bm-20240930-arminc-aarch64-Yhg1s-3.13_revert_incremen-3.13.0rc2+-1ba3555.json: async_tree_cpu_io_mixed_tg, async_tree_io_tg, async_tree_memoization_tg, async_tree_none_tg, bpe_tokeniser, unpack_sequence
