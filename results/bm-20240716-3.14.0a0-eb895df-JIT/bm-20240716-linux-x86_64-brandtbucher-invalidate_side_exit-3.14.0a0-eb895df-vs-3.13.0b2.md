...
| Benchmark      | bm-20240605-linux-x86_64-python-v3.13.0b2-3.13.0b2-3a83b17 | bm-20240716-linux-x86_64-brandtbucher-invalidate_side_exit-3.14.0a0-eb895df |
|----------------|:----------------------------------------------------------:|:---------------------------------------------------------------------------:|
...
| async_tree_none            | 378 ms                                                     | 328 ms: 1.16x faster                                                        |
...
Benchmark hidden because not significant (3): sqlglot_optimize, bench_thread_pool, pylint
