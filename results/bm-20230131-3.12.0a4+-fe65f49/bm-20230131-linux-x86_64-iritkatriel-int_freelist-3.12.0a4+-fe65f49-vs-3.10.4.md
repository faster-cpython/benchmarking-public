...
| logging_silent          | 173 ns                                                 | 90.9 ns: 1.90x faster                                               |
...
| genshi_text             | 30.6 ms                                                | 21.0 ms: 1.46x faster                                               |
| mako                    | 14.3 ms                                                | 9.82 ms: 1.45x faster                                               |
| pyflate                 | 675 ms                                                 | 468 ms: 1.44x faster                                                |
...
| json_dumps              | 13.5 ms                                                | 9.52 ms: 1.42x faster                                               |
| unpack_sequence         | 59.5 ns                                                | 42.0 ns: 1.42x faster                                               |
| django_template         | 46.3 ms                                                | 32.7 ms: 1.41x faster                                               |
| nbody                   | 136 ms                                                 | 97.5 ms: 1.40x faster                                               |
| chameleon               | 8.86 ms                                                | 6.35 ms: 1.39x faster                                               |
| xml_etree_process       | 74.5 ms                                                | 53.5 ms: 1.39x faster                                               |
...
| html5lib                | 85.8 ms                                                | 62.1 ms: 1.38x faster                                               |
| sqlglot_transpile       | 2.42 ms                                                | 1.77 ms: 1.37x faster                                               |
...
| nqueens                 | 99.3 ms                                                | 74.8 ms: 1.33x faster                                               |
| async_tree_memoization  | 854 ms                                                 | 644 ms: 1.33x faster                                                |
| 2to3                    | 332 ms                                                 | 252 ms: 1.32x faster                                                |
| crypto_pyaes            | 118 ms                                                 | 89.6 ms: 1.31x faster                                               |
...
| json_loads              | 28.9 us                                                | 24.9 us: 1.16x faster                                               |
| async_generators        | 428 ms                                                 | 371 ms: 1.15x faster                                                |
| json                    | 5.35 ms                                                | 4.70 ms: 1.14x faster                                               |
| regex_v8                | 25.0 ms                                                | 22.2 ms: 1.12x faster                                               |
| xml_etree_parse         | 163 ms                                                 | 147 ms: 1.11x faster                                                |
| meteor_contest          | 114 ms                                                 | 103 ms: 1.10x faster                                                |
| sqlite_synth            | 2.90 us                                                | 2.67 us: 1.09x faster                                               |
| spectral_norm           | 148 ms                                                 | 136 ms: 1.09x faster                                                |
| xml_etree_iterparse     | 110 ms                                                 | 102 ms: 1.08x faster                                                |
| scimark_fft             | 414 ms                                                 | 383 ms: 1.08x faster                                                |
...
| pickle                  | 10.1 us                                                | 10.2 us: 1.01x slower                                               |
| pidigits                | 190 ms                                                 | 199 ms: 1.05x slower                                                |
| generators              | 75.8 ms                                                | 82.2 ms: 1.09x slower                                               |
| python_startup_no_site  | 5.76 ms                                                | 6.44 ms: 1.12x slower                                               |
| regex_effbot            | 3.21 ms                                                | 3.63 ms: 1.13x slower                                               |
| pickle_dict             | 28.3 us                                                | 32.1 us: 1.13x slower                                               |
