...
- Geometric mean: 1.01x faster (HPT: reliability of 73.23%, 1.00x faster at 99th %ile)
- Memory usage: 0.92x
...
- Geometric mean: 1.00x slower (HPT: reliability of 82.94%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
- missing benchmarks: aiohttp, dulwich_log, flaskblogging, gunicorn, pickle, pickle_dict, pickle_list, sqlite_synth, unpickle, unpickle_list
...
- Geometric mean: 1.00x slower (HPT: reliability of 74.66%, 1.00x slower at 99th %ile)
- Memory usage: 0.93x
- missing benchmarks: aiohttp, gunicorn, pickle, pickle_dict, pickle_list, sqlalchemy_declarative, sqlalchemy_imperative, sqlite_synth, unpack_sequence, unpickle, unpickle_list
- new benchmarks: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, thrift
...
- Geometric mean: 1.00x slower (HPT: reliability of 97.47%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
...
- Geometric mean: 1.02x faster (HPT: reliability of 93.36%, 1.00x faster at 99th %ile)
- Memory usage: unknown
...
- Memory usage: unknown
- missing benchmarks: flaskblogging, pickle, pickle_dict, pickle_list, sqlite_synth, unpickle, unpickle_list
