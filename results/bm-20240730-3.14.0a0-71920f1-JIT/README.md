...
- [📄table](bm-20240730-linux-x86_64-faster%252dcpython-binary_subscr_getite-3.14.0a0-71920f1-vs-3.13.0.md)
- [📈time plot](bm-20240730-linux-x86_64-faster%252dcpython-binary_subscr_getite-3.14.0a0-71920f1-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x faster (HPT: reliability of 89.00%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
