...
- Geometric mean: 1.004x faster (HPT: reliability of 96.74%, 1.00x faster at 99th %ile)
- Memory usage: 1.01x
- [🧠memory plot](bm-20250822-arminc-aarch64-faster%252dcpython-tier_2_tos_caching-3.15.0a0-efe4628-vs-base-mem.svg)
- [📄table](bm-20250822-arminc-aarch64-faster%252dcpython-tier_2_tos_caching-3.15.0a0-efe4628-vs-base.md)
- [📈time plot](bm-20250822-arminc-aarch64-faster%252dcpython-tier_2_tos_caching-3.15.0a0-efe4628-vs-base.svg)
