...
- Geometric mean: 1.081x slower (HPT: reliability of 100.00%, 1.10x slower at 99th %ile)
- Memory usage: 1.22x
- missing benchmarks: 🔴 djangocms
...
- Geometric mean: 1.198x slower (HPT: reliability of 100.00%, 1.20x slower at 99th %ile)
- Memory usage: unknown
