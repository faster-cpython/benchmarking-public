...
- Geometric mean: 1.01x faster (HPT: reliability of 62.76%, 1.00x faster at 99th %ile)
- Memory usage: 1.10x
...
- Geometric mean: 1.00x slower (HPT: reliability of 96.85%, 1.00x slower at 99th %ile)
- Memory usage: 1.01x
...
- [📄table](bm-20240904-linux-x86_64-Fidget%252dSpinner-partial_evaluator-3.14.0a0-a6bc1a0-vs-3.13.0b2.md)
- [📈time plot](bm-20240904-linux-x86_64-Fidget%252dSpinner-partial_evaluator-3.14.0a0-a6bc1a0-vs-3.13.0b2.svg)
