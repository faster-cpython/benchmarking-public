...
- Geometric mean: 1.01x faster (HPT: reliability of 71.63%, 1.00x slower at 99th %ile)
- Memory usage: 1.07x
...
- [📄table](bm-20240713-linux-x86_64-brandtbucher-no_progress_needed-3.14.0a0-a4c1908-vs-3.13.0.md)
- [📈time plot](bm-20240713-linux-x86_64-brandtbucher-no_progress_needed-3.14.0a0-a4c1908-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.01x faster (HPT: reliability of 68.74%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
