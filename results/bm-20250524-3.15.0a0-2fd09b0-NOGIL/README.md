...
- Geometric mean: 1.052x slower (HPT: reliability of 100.00%, 1.08x slower at 99th %ile)
- Memory usage: 1.22x
...
- Geometric mean: 1.047x faster (HPT: reliability of 95.50%, 1.00x slower at 99th %ile)
- Memory usage: 1.16x
- missing benchmarks: 🔴 dask
