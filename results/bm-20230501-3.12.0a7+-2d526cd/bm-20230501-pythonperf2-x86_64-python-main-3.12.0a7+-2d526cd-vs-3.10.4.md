...
| richards                | 74.1 ms                                                      | 43.7 ms: 1.70x faster                                        |
...
| fannkuch                | 496 ms                                                       | 338 ms: 1.46x faster                                         |
| mako                    | 14.7 ms                                                      | 10.1 ms: 1.46x faster                                        |
| crypto_pyaes            | 118 ms                                                       | 81.3 ms: 1.45x faster                                        |
| pickle_pure_python      | 457 us                                                       | 319 us: 1.43x faster                                         |
| float                   | 110 ms                                                       | 77.8 ms: 1.42x faster                                        |
| html5lib                | 94.6 ms                                                      | 68.0 ms: 1.39x faster                                        |
| bench_mp_pool           | 7.18 ms                                                      | 5.21 ms: 1.38x faster                                        |
...
| xml_etree_process       | 76.0 ms                                                      | 58.6 ms: 1.30x faster                                        |
| thrift                  | 1.16 ms                                                      | 904 us: 1.29x faster                                         |
| genshi_text             | 31.5 ms                                                      | 24.6 ms: 1.28x faster                                        |
...
| xml_etree_generate      | 94.6 ms                                                      | 86.2 ms: 1.10x faster                                        |
| unpack_sequence         | 59.5 ns                                                      | 55.5 ns: 1.07x faster                                        |
| xml_etree_iterparse     | 110 ms                                                       | 104 ms: 1.06x faster                                         |
| pidigits                | 271 ms                                                       | 259 ms: 1.04x faster                                         |
| python_startup          | 11.5 ms                                                      | 11.1 ms: 1.03x faster                                        |
