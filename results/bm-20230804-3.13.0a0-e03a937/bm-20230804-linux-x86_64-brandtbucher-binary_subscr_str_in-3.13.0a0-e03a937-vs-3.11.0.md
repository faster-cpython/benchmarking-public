...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230804-linux-x86_64-brandtbucher-binary_subscr_str_in-3.13.0a0-e03a937 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------------:|
...
| gc_traversal             | 4.02 ms                                                | 4.00 ms: 1.01x faster                                                       |
| regex_compile            | 138 ms                                                 | 137 ms: 1.01x faster                                                        |
...
| xml_etree_generate       | 76.2 ms                                                | 84.7 ms: 1.11x slower                                                       |
| python_startup_no_site   | 6.01 ms                                                | 6.89 ms: 1.15x slower                                                       |
| unpack_sequence          | 43.1 ns                                                | 50.7 ns: 1.18x slower                                                       |
| telco                    | 6.58 ms                                                | 7.92 ms: 1.20x slower                                                       |
| async_generators         | 368 ms                                                 | 451 ms: 1.22x slower                                                        |
| dask                     | 360 ms                                                 | 522 ms: 1.45x slower                                                        |
| Geometric mean           | (ref)                                                  | 1.04x faster                                                                |

Benchmark hidden because not significant (8): tornado_http, xml_etree_iterparse, fannkuch, regex_v8, sqlglot_optimize, bench_mp_pool, go, pycparser
