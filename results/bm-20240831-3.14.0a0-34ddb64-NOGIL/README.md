...
- Geometric mean: 1.04x slower (HPT: reliability of 99.87%, 1.01x slower at 99th %ile)
- Memory usage: 1.29x
...
- Geometric mean: 1.46x slower (HPT: reliability of 100.00%, 1.29x slower at 99th %ile)
- Memory usage: 1.15x
...
- Geometric mean: 1.16x slower (HPT: reliability of 100.00%, 1.14x slower at 99th %ile)
- Memory usage: 0.77x
- missing benchmarks: aiohttp, chameleon, dask, flaskblogging, gunicorn, mypy2, pickle, pickle_dict, pickle_list, sqlalchemy_declarative, sqlalchemy_imperative, sqlite_synth, unpack_sequence, unpickle, unpickle_list
