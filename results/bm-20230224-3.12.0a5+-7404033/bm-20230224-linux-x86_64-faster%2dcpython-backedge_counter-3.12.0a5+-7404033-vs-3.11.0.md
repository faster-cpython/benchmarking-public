...
| spectral_norm           | 100 ms                                                 | 92.4 ms: 1.08x faster                                                        |
...
| xml_etree_generate      | 76.2 ms                                                | 81.2 ms: 1.07x slower                                                        |
| python_startup_no_site  | 6.01 ms                                                | 6.55 ms: 1.09x slower                                                        |
| async_generators        | 368 ms                                                 | 422 ms: 1.15x slower                                                         |
| dask                    | 360 ms                                                 | 499 ms: 1.39x slower                                                         |
| Geometric mean          | (ref)                                                  | 1.05x faster                                                                 |

Benchmark hidden because not significant (11): djangocms, async_tree_io, crypto_pyaes, nbody, bench_mp_pool, sqlglot_transpile, chameleon, xml_etree_iterparse, scimark_lu, sqlalchemy_imperative, async_tree_cpu_io_mixed
