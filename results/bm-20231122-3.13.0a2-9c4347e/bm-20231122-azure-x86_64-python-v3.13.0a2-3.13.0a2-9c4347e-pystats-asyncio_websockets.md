...
|---|---:|---:|---:|---:|
| LOAD_FAST | 5,031,440 | 18.6% | 18.6% |  |
| POP_JUMP_IF_FALSE | 1,501,452 | 5.6% | 24.2% |  |
| LOAD_ATTR_SLOT | 1,299,760 | 4.8% | 29.0% | 0.4% |
| LOAD_CONST | 1,175,116 | 4.3% | 33.3% |  |
...
| COMPARE_OP_INT | 250,772 | 0.9% | 81.2% | 0.1% |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 805,464 | 3.0% | 6.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 404,692 | 1.5% | 22.5% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 306,912 | 1.1% | 30.1% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 275,620 | 1.0% | 31.1% |
| LOAD_FAST LOAD_CONST | 261,080 | 1.0% | 32.0% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 248,092 | 0.9% | 33.0% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 105,852 | 0.4% | 60.2% |
...
| CALL_LEN LOAD_FAST | 92,212 | 0.3% | 63.9% |
...
| LOAD_GLOBAL_BUILTIN | 404,692 | 8.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 964,960 | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE | 805,464 | 16.0% |
...
| LOAD_GLOBAL_BUILTIN | 306,912 | 20.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 105,852 | 54.0% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,292 | 8.1% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 248,092 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 306,912 | 41.1% |
...
|---|---:|---:|
| Basic | 13,034,636 | 48.2% |
| Not specialized | 4,448,188 | 16.4% |
| Specialized hits | 9,477,339 | 35.0% |
| Specialized misses | 83,163 | 0.3% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 776,418 | 32.7% |
| Frees to freelist | 780,578 |  |
| Allocations | 1,597,974 | 67.3% |
| Allocations to 512 bytes | 1,407,967 | 59.3% |
| Allocations to 4 kbytes | 132,208 | 5.6% |
| Allocations over 4 kbytes | 57,799 | 2.4% |
| Frees | 1,537,514 |  |
| New values | 34,780 |  |
| Interpreter increfs | 12,202,656 | 76.6% |
| Interpreter decrefs | 14,017,818 | 78.1% |
| Increfs | 3,737,151 | 23.4% |
| Decrefs | 3,925,877 | 21.9% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 20 | 0.1% |
| Method cache hits | 1,218,259 |  |
| Method cache misses | 42,721 |  |
| Method cache collisions | 48,127 |  |
| Method cache dunder hits | 355,296 |  |
| Method cache dunder misses | 8,604 |  |
