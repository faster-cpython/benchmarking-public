...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 14,746,400 | 7.1% |
| Frees to freelist | 14,746,340 |  |
| Allocations | 192,575,700 | 92.9% |
| Allocations to 512 bytes | 189,298,260 | 91.3% |
...
| Increfs | 453,081,720 | 98.9% |
| Decrefs | 631,627,023 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 1,638,920 |  |
| Method cache misses | 819,340 |  |
| Method cache collisions | 819,166 |  |
| Method cache dunder hits | 1,639,024 |  |
