...
| tornado_http   | 152 ms                                                       | 113 ms: 1.35x faster                                                         |
...
| richards                | 74.1 ms                                                      | 43.2 ms: 1.71x faster                                                        |
...
| scimark_monte_carlo     | 109 ms                                                       | 70.4 ms: 1.55x faster                                                        |
| unpickle_pure_python    | 321 us                                                       | 208 us: 1.54x faster                                                         |
...
| async_tree_none         | 700 ms                                                       | 480 ms: 1.46x faster                                                         |
| crypto_pyaes            | 118 ms                                                       | 81.5 ms: 1.45x faster                                                        |
| mako                    | 14.7 ms                                                      | 10.2 ms: 1.44x faster                                                        |
| fannkuch                | 496 ms                                                       | 345 ms: 1.44x faster                                                         |
| async_tree_memoization  | 824 ms                                                       | 577 ms: 1.43x faster                                                         |
| pickle_pure_python      | 457 us                                                       | 321 us: 1.42x faster                                                         |
| bench_mp_pool           | 7.18 ms                                                      | 5.16 ms: 1.39x faster                                                        |
| float                   | 110 ms                                                       | 79.4 ms: 1.39x faster                                                        |
| json_dumps              | 14.2 ms                                                      | 10.4 ms: 1.36x faster                                                        |
| tornado_http            | 152 ms                                                       | 113 ms: 1.35x faster                                                         |
| html5lib                | 94.6 ms                                                      | 70.2 ms: 1.35x faster                                                        |
...
| regex_dna               | 259 ms                                                       | 227 ms: 1.14x faster                                                         |
| unpack_sequence         | 59.5 ns                                                      | 52.3 ns: 1.14x faster                                                        |
...
| coverage                | 64.0 ms                                                      | 89.9 ms: 1.41x slower                                                        |
