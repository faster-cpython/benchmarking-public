...
- [📄table](bm-20240927-linux-x86_64-faster%252dcpython-experimental_gc_fix-3.14.0a0-615a96e-vs-3.13.0b2.md)
- [📈time plot](bm-20240927-linux-x86_64-faster%252dcpython-experimental_gc_fix-3.14.0a0-615a96e-vs-3.13.0b2.svg)

### vs. base

- Geometric mean: 1.00x faster (HPT: reliability of 87.03%, 1.00x slower at 99th %ile)
- Memory usage: 0.96x
