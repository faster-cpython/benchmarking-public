...
| chameleon      | 4.57 ms                                                | 5.79 ms: 1.27x slower                                  |
| docutils       | 1.47 sec                                               | 1.78 sec: 1.21x slower                                 |
| html5lib       | 34.7 ms                                                | 44.2 ms: 1.27x slower                                  |
| tornado_http   | 72.4 ms                                                | 91.5 ms: 1.26x slower                                  |
...
| regex_v8       | 16.2 ms                                                | 17.6 ms: 1.08x slower                                  |
| regex_compile  | 76.7 ms                                                | 96.4 ms: 1.26x slower                                  |
...
| json_dumps           | 7.72 ms                                                | 8.40 ms: 1.09x slower                                  |
| xml_etree_generate   | 48.8 ms                                                | 54.2 ms: 1.11x slower                                  |
| xml_etree_process    | 35.2 ms                                                | 44.8 ms: 1.27x slower                                  |
| unpickle_pure_python | 159 us                                                 | 203 us: 1.28x slower                                   |
| pickle_pure_python   | 199 us                                                 | 283 us: 1.43x slower                                   |
...
| Benchmark              | bm-20221024-darwin-arm64-python-v3.11.0-3.11.0-deaf509 | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 |
|------------------------|:------------------------------------------------------:|:------------------------------------------------------:|
| python_startup_no_site | 9.31 ms                                                | 8.88 ms: 1.05x faster                                  |
...
| mako            | 8.49 ms                                                | 10.5 ms: 1.23x slower                                  |
| genshi_xml      | 29.8 ms                                                | 37.2 ms: 1.25x slower                                  |
...
| Benchmark               | bm-20221024-darwin-arm64-python-v3.11.0-3.11.0-deaf509 | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 |
|-------------------------|:------------------------------------------------------:|:------------------------------------------------------:|
| coverage                | 58.6 ms                                                | 42.0 ms: 1.39x faster                                  |
| bench_mp_pool           | 43.2 ms                                                | 39.7 ms: 1.09x faster                                  |
| regex_effbot            | 2.63 ms                                                | 2.46 ms: 1.07x faster                                  |
| python_startup_no_site  | 9.31 ms                                                | 8.88 ms: 1.05x faster                                  |
| gc_traversal            | 2.43 ms                                                | 2.39 ms: 1.02x faster                                  |
| pidigits                | 281 ms                                                 | 282 ms: 1.01x slower                                   |
| unpickle                | 9.70 us                                                | 9.89 us: 1.02x slower                                  |
| unpickle_list           | 2.63 us                                                | 2.69 us: 1.02x slower                                  |
| pickle                  | 7.17 us                                                | 7.35 us: 1.03x slower                                  |
...
| python_startup          | 11.5 ms                                                | 11.9 ms: 1.03x slower                                  |
| pathlib                 | 27.8 ms                                                | 28.8 ms: 1.04x slower                                  |
| xml_etree_iterparse     | 69.2 ms                                                | 72.3 ms: 1.04x slower                                  |
| json_loads              | 16.1 us                                                | 16.9 us: 1.05x slower                                  |
...
| sympy_str               | 152 ms                                                 | 169 ms: 1.12x slower                                   |
...
| scimark_fft             | 199 ms                                                 | 230 ms: 1.16x slower                                   |
| bench_thread_pool       | 473 us                                                 | 546 us: 1.16x slower                                   |
| sympy_integrate         | 11.5 ms                                                | 13.3 ms: 1.16x slower                                  |
| sqlite_synth            | 1.27 us                                                | 1.47 us: 1.16x slower                                  |
| dask                    | 226 ms                                                 | 265 ms: 1.17x slower                                   |
| gunicorn                | 1.13 ms                                                | 1.35 ms: 1.19x slower                                  |
| sqlalchemy_declarative  | 62.7 ms                                                | 74.9 ms: 1.20x slower                                  |
| aiohttp                 | 1.06 ms                                                | 1.27 ms: 1.20x slower                                  |
| async_generators        | 195 ms                                                 | 234 ms: 1.20x slower                                   |
| genshi_text             | 15.3 ms                                                | 18.4 ms: 1.20x slower                                  |
| docutils                | 1.47 sec                                               | 1.78 sec: 1.21x slower                                 |
| create_gc_cycles        | 726 us                                                 | 880 us: 1.21x slower                                   |
| sqlalchemy_imperative   | 7.31 ms                                                | 8.89 ms: 1.22x slower                                  |
| fannkuch                | 261 ms                                                 | 317 ms: 1.22x slower                                   |
| sqlglot_optimize        | 31.2 ms                                                | 38.0 ms: 1.22x slower                                  |
| mypy2                   | 250 ms                                                 | 307 ms: 1.23x slower                                   |
| mako                    | 8.49 ms                                                | 10.5 ms: 1.23x slower                                  |
| dulwich_log             | 29.9 ms                                                | 37.1 ms: 1.24x slower                                  |
...
| unpickle_pure_python    | 159 us                                                 | 203 us: 1.28x slower                                   |
| django_template         | 21.0 ms                                                | 27.3 ms: 1.30x slower                                  |
| pprint_pformat          | 950 ms                                                 | 1.23 sec: 1.30x slower                                 |
| pprint_safe_repr        | 465 ms                                                 | 606 ms: 1.30x slower                                   |
| deepcopy_memo           | 26.3 us                                                | 34.4 us: 1.31x slower                                  |
| pycparser               | 697 ms                                                 | 916 ms: 1.31x slower                                   |
| logging_format          | 3.78 us                                                | 4.97 us: 1.32x slower                                  |
| spectral_norm           | 72.8 ms                                                | 95.8 ms: 1.32x slower                                  |
| logging_simple          | 3.50 us                                                | 4.63 us: 1.32x slower                                  |
| hexiom                  | 4.73 ms                                                | 6.32 ms: 1.34x slower                                  |
| thrift                  | 433 us                                                 | 580 us: 1.34x slower                                   |
| chaos                   | 49.5 ms                                                | 66.7 ms: 1.35x slower                                  |
| float                   | 53.0 ms                                                | 72.4 ms: 1.37x slower                                  |
| sqlglot_transpile       | 1.12 ms                                                | 1.57 ms: 1.40x slower                                  |
| async_tree_none         | 285 ms                                                 | 400 ms: 1.41x slower                                   |
| pickle_pure_python      | 199 us                                                 | 283 us: 1.43x slower                                   |
| nbody                   | 65.5 ms                                                | 93.3 ms: 1.43x slower                                  |
| sqlglot_parse           | 957 us                                                 | 1.37 ms: 1.43x slower                                  |
| async_tree_io           | 706 ms                                                 | 1.02 sec: 1.44x slower                                 |
...
| scimark_lu              | 72.1 ms                                                | 109 ms: 1.52x slower                                   |
| scimark_sor             | 83.0 ms                                                | 126 ms: 1.52x slower                                   |
| go                      | 109 ms                                                 | 165 ms: 1.52x slower                                   |
| scimark_monte_carlo     | 46.4 ms                                                | 72.5 ms: 1.56x slower                                  |
