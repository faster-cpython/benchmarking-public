...
| float          | 110 ms                                                       | 79.9 ms: 1.38x faster                                                        |
...
| regex_v8       | 26.6 ms                                                      | 24.3 ms: 1.09x faster                                                        |
...
| spectral_norm           | 136 ms                                                       | 90.5 ms: 1.50x faster                                                        |
| async_tree_memoization  | 824 ms                                                       | 549 ms: 1.50x faster                                                         |
| mako                    | 14.7 ms                                                      | 9.84 ms: 1.49x faster                                                        |
| scimark_monte_carlo     | 109 ms                                                       | 73.6 ms: 1.49x faster                                                        |
...
| pathlib                 | 21.7 ms                                                      | 20.7 ms: 1.05x faster                                                        |
| pidigits                | 271 ms                                                       | 260 ms: 1.04x faster                                                         |
| xml_etree_iterparse     | 110 ms                                                       | 107 ms: 1.03x faster                                                         |
| python_startup          | 11.5 ms                                                      | 11.3 ms: 1.02x faster                                                        |
| pickle                  | 9.94 us                                                      | 10.0 us: 1.01x slower                                                        |
...
| coverage                | 64.0 ms                                                      | 94.6 ms: 1.48x slower                                                        |
