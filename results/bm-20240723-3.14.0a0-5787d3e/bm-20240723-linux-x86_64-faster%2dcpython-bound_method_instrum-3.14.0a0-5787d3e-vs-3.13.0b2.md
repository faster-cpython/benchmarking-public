...
| Benchmark      | bm-20240605-linux-x86_64-python-v3.13.0b2-3.13.0b2-3a83b17 | bm-20240723-linux-x86_64-faster%2dcpython-bound_method_instrum-3.14.0a0-5787d3e |
|----------------|:----------------------------------------------------------:|:-------------------------------------------------------------------------------:|
...
| async_tree_io              | 939 ms                                                     | 848 ms: 1.11x faster                                                            |
| async_tree_io_tg           | 936 ms                                                     | 850 ms: 1.10x faster                                                            |
| logging_silent             | 105 ns                                                     | 95.7 ns: 1.09x faster                                                           |
...
| hexiom                     | 6.30 ms                                                    | 5.98 ms: 1.05x faster                                                           |
