...
- Geometric mean: 1.397x faster (HPT: reliability of 100.00%, 1.22x faster at 99th %ile)
- Memory usage: 1.24x
...
- Geometric mean: 1.069x faster (HPT: reliability of 99.74%, 1.00x faster at 99th %ile)
- Memory usage: 1.07x
...
- Geometric mean: 1.010x faster (HPT: reliability of 56.90%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
...
- [📄table](bm-20240906-linux-x86_64-brandtbucher-underflow_known_dyna-3.14.0a0-7ad3776-vs-3.13.0.md)
- [📈time plot](bm-20240906-linux-x86_64-brandtbucher-underflow_known_dyna-3.14.0a0-7ad3776-vs-3.13.0.svg)
