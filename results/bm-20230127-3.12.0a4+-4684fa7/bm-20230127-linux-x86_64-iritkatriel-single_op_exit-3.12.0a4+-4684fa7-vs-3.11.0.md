...
| tornado_http   | 96.3 ms                                                | 93.0 ms: 1.03x faster                                                 |
...
| bench_thread_pool       | 819 us                                                 | 769 us: 1.06x faster                                                  |
| float                   | 77.2 ms                                                | 72.8 ms: 1.06x faster                                                 |
...
Benchmark hidden because not significant (10): unpack_sequence, async_tree_none, thrift, django_template, pickle_dict, bench_mp_pool, sqlglot_transpile, pickle, async_tree_memoization, djangocms
