...
| pickle_pure_python   | 306 us                                                 | 272 us: 1.12x faster                                                         |
...
| pickle_pure_python      | 306 us                                                 | 272 us: 1.12x faster                                                         |
| crypto_pyaes            | 74.7 ms                                                | 67.2 ms: 1.11x faster                                                        |
| aiohttp                 | 1.10 ms                                                | 994 us: 1.11x faster                                                         |
| json_loads              | 26.5 us                                                | 24.0 us: 1.10x faster                                                        |
| gunicorn                | 1.18 ms                                                | 1.07 ms: 1.10x faster                                                        |
| genshi_xml              | 51.8 ms                                                | 47.1 ms: 1.10x faster                                                        |
| scimark_monte_carlo     | 68.1 ms                                                | 62.1 ms: 1.10x faster                                                        |
...
| regex_dna               | 204 ms                                                 | 210 ms: 1.03x slower                                                         |
| xml_etree_generate      | 76.2 ms                                                | 78.4 ms: 1.03x slower                                                        |
| gc_traversal            | 4.02 ms                                                | 4.16 ms: 1.04x slower                                                        |
| python_startup          | 8.52 ms                                                | 8.93 ms: 1.05x slower                                                        |
...
Benchmark hidden because not significant (8): djangocms, async_tree_none, pickle_list, bench_mp_pool, sqlglot_transpile, async_tree_memoization, deepcopy_reduce, nbody
