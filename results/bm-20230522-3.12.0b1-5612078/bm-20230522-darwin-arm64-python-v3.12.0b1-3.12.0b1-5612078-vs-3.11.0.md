...
| docutils       | 1.47 sec                                               | 1.55 sec: 1.06x slower                                     |
...
| float          | 53.0 ms                                                | 59.0 ms: 1.11x slower                                      |
...
| xml_etree_generate   | 48.3 ms                                                | 56.7 ms: 1.17x slower                                      |
...
| python_startup_no_site | 10.2 ms                                                | 9.88 ms: 1.03x faster                                      |
...
| chaos                    | 49.4 ms                                                | 46.4 ms: 1.06x faster                                      |
| pickle_pure_python       | 201 us                                                 | 188 us: 1.06x faster                                       |
...
| sqlalchemy_imperative    | 7.20 ms                                                | 6.93 ms: 1.04x faster                                      |
...
| mypy2                    | 195 ms                                                 | 192 ms: 1.01x faster                                       |
| regex_dna                | 152 ms                                                 | 150 ms: 1.01x faster                                       |
| regex_compile            | 76.7 ms                                                | 75.9 ms: 1.01x faster                                      |
...
| nbody                    | 65.6 ms                                                | 68.6 ms: 1.05x slower                                      |
| pickle                   | 7.15 us                                                | 7.49 us: 1.05x slower                                      |
| spectral_norm            | 72.6 ms                                                | 76.3 ms: 1.05x slower                                      |
| pickle_list              | 2.81 us                                                | 2.96 us: 1.05x slower                                      |
| sqlalchemy_declarative   | 62.6 ms                                                | 66.0 ms: 1.05x slower                                      |
| pickle_dict              | 18.0 us                                                | 18.9 us: 1.05x slower                                      |
| docutils                 | 1.47 sec                                               | 1.55 sec: 1.06x slower                                     |
| 2to3                     | 161 ms                                                 | 171 ms: 1.06x slower                                       |
...
| pprint_safe_repr         | 466 ms                                                 | 510 ms: 1.09x slower                                       |
| json_loads               | 16.1 us                                                | 17.6 us: 1.10x slower                                      |
...
| float                    | 53.0 ms                                                | 59.0 ms: 1.11x slower                                      |
| xml_etree_process        | 35.1 ms                                                | 39.3 ms: 1.12x slower                                      |
| sqlglot_optimize         | 31.1 ms                                                | 35.0 ms: 1.13x slower                                      |
| telco                    | 3.41 ms                                                | 3.87 ms: 1.14x slower                                      |
| scimark_sor              | 82.6 ms                                                | 94.5 ms: 1.14x slower                                      |
| xml_etree_generate       | 48.3 ms                                                | 56.7 ms: 1.17x slower                                      |
| unpickle_list            | 2.65 us                                                | 3.21 us: 1.21x slower                                      |
...
Benchmark hidden because not significant (3): dulwich_log, tornado_http, fannkuch
...
Ignored benchmarks (1) of results/bm-20230522-3.12.0b1-5612078/bm-20230522-darwin-arm64-python-v3.12.0b1-3.12.0b1-5612078.json: dask
