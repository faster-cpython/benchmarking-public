...
- [📄table](bm-20241004-linux-x86_64-mdboom-marshal_slice-3.14.0a0-f072492-vs-3.13.0b2.md)
- [📈time plot](bm-20241004-linux-x86_64-mdboom-marshal_slice-3.14.0a0-f072492-vs-3.13.0b2.svg)

### vs. base

- Geometric mean: 1.00x slower (HPT: reliability of 98.52%, 1.00x slower at 99th %ile)
- Memory usage: 1.01x
