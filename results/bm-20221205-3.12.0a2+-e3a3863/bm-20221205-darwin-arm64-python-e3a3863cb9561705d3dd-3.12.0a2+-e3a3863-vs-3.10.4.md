...
| chameleon      | 5.84 ms                                                | 4.54 ms: 1.29x faster                                                  |
...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20221205-darwin-arm64-python-e3a3863cb9561705d3dd-3.12.0a2+-e3a3863 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| nbody          | 94.1 ms                                                | 65.7 ms: 1.43x faster                                                  |
...
| regex_v8       | 17.5 ms                                                | 15.7 ms: 1.11x faster                                                  |
...
| Benchmark            | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20221205-darwin-arm64-python-e3a3863cb9561705d3dd-3.12.0a2+-e3a3863 |
|----------------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| json_dumps           | 8.38 ms                                                | 6.14 ms: 1.37x faster                                                  |
| pickle_pure_python   | 284 us                                                 | 219 us: 1.30x faster                                                   |
| unpickle_pure_python | 203 us                                                 | 161 us: 1.27x faster                                                   |
| xml_etree_process    | 45.1 ms                                                | 36.3 ms: 1.24x faster                                                  |
| xml_etree_parse      | 107 ms                                                 | 97.0 ms: 1.11x faster                                                  |
| xml_etree_generate   | 54.3 ms                                                | 49.6 ms: 1.09x faster                                                  |
| xml_etree_iterparse  | 72.6 ms                                                | 69.7 ms: 1.04x faster                                                  |
...
| async_tree_none         | 402 ms                                                 | 296 ms: 1.36x faster                                                   |
...
| tornado_http            | 91.9 ms                                                | 70.8 ms: 1.30x faster                                                  |
| pickle_pure_python      | 284 us                                                 | 219 us: 1.30x faster                                                   |
| thrift                  | 586 us                                                 | 452 us: 1.30x faster                                                   |
| spectral_norm           | 96.4 ms                                                | 74.4 ms: 1.30x faster                                                  |
| chaos                   | 66.8 ms                                                | 51.6 ms: 1.30x faster                                                  |
| chameleon               | 5.84 ms                                                | 4.54 ms: 1.29x faster                                                  |
| scimark_monte_carlo     | 72.2 ms                                                | 56.3 ms: 1.28x faster                                                  |
| mako                    | 10.5 ms                                                | 8.16 ms: 1.28x faster                                                  |
| logging_format          | 5.01 us                                                | 3.93 us: 1.27x faster                                                  |
...
| html5lib                | 44.1 ms                                                | 36.4 ms: 1.21x faster                                                  |
| async_tree_cpu_io_mixed | 670 ms                                                 | 553 ms: 1.21x faster                                                   |
...
| async_generators        | 233 ms                                                 | 206 ms: 1.13x faster                                                   |
| sqlglot_normalize       | 197 ms                                                 | 175 ms: 1.13x faster                                                   |
| deepcopy_memo           | 34.5 us                                                | 30.7 us: 1.12x faster                                                  |
| dask                    | 258 ms                                                 | 230 ms: 1.12x faster                                                   |
| regex_v8                | 17.5 ms                                                | 15.7 ms: 1.11x faster                                                  |
| sympy_integrate         | 13.4 ms                                                | 12.0 ms: 1.11x faster                                                  |
| xml_etree_parse         | 107 ms                                                 | 97.0 ms: 1.11x faster                                                  |
| deepcopy                | 278 us                                                 | 252 us: 1.10x faster                                                   |
| json                    | 3.10 ms                                                | 2.81 ms: 1.10x faster                                                  |
| xml_etree_generate      | 54.3 ms                                                | 49.6 ms: 1.09x faster                                                  |
| deepcopy_reduce         | 2.38 us                                                | 2.18 us: 1.09x faster                                                  |
| sympy_expand            | 276 ms                                                 | 252 ms: 1.09x faster                                                   |
| nqueens                 | 68.1 ms                                                | 62.4 ms: 1.09x faster                                                  |
...
| meteor_contest          | 78.6 ms                                                | 79.2 ms: 1.01x slower                                                  |
| pickle_dict             | 17.8 us                                                | 17.9 us: 1.01x slower                                                  |
...
| regex_effbot            | 2.45 ms                                                | 2.65 ms: 1.08x slower                                                  |
| unpack_sequence         | 38.7 ns                                                | 51.6 ns: 1.33x slower                                                  |
| coverage                | 40.8 ms                                                | 58.6 ms: 1.44x slower                                                  |
