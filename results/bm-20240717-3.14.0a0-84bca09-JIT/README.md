...
- Geometric mean: 1.01x faster (HPT: reliability of 50.26%, 1.00x slower at 99th %ile)
- Memory usage: 1.08x
...
- [📄table](bm-20240717-linux-x86_64-brandtbucher-tracing_jumps-3.14.0a0-84bca09-vs-3.13.0.md)
- [📈time plot](bm-20240717-linux-x86_64-brandtbucher-tracing_jumps-3.14.0a0-84bca09-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.01x slower (HPT: reliability of 66.70%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
