...
| chameleon      | 5.84 ms                                                | 4.44 ms: 1.31x faster                                                  |
...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230129-darwin-arm64-python-c4170c36b0b54c10456f-3.12.0a4+-c4170c3 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| regex_compile  | 96.6 ms                                                | 73.9 ms: 1.31x faster                                                  |
...
| genshi_xml      | 37.6 ms                                                | 28.6 ms: 1.32x faster                                                  |
...
| scimark_sor             | 127 ms                                                 | 77.7 ms: 1.63x faster                                                  |
...
| float                   | 72.3 ms                                                | 51.8 ms: 1.40x faster                                                  |
| chaos                   | 66.8 ms                                                | 48.2 ms: 1.39x faster                                                  |
...
| tornado_http            | 91.9 ms                                                | 70.2 ms: 1.31x faster                                                  |
| regex_compile           | 96.6 ms                                                | 73.9 ms: 1.31x faster                                                  |
| thrift                  | 586 us                                                 | 448 us: 1.31x faster                                                   |
...
| mypy2                   | 308 ms                                                 | 262 ms: 1.17x faster                                                   |
...
| regex_v8                | 17.5 ms                                                | 16.0 ms: 1.10x faster                                                  |
| xml_etree_generate      | 54.3 ms                                                | 49.6 ms: 1.09x faster                                                  |
| telco                   | 3.68 ms                                                | 3.45 ms: 1.07x faster                                                  |
...
| pickle                  | 7.36 us                                                | 7.49 us: 1.02x slower                                                  |
| unpickle_list           | 2.66 us                                                | 2.73 us: 1.03x slower                                                  |
| generators              | 32.9 ms                                                | 35.0 ms: 1.06x slower                                                  |
| python_startup_no_site  | 9.73 ms                                                | 10.4 ms: 1.07x slower                                                  |
| regex_effbot            | 2.45 ms                                                | 2.67 ms: 1.09x slower                                                  |
...
Benchmark hidden because not significant (3): python_startup, pickle_list, unpickle
