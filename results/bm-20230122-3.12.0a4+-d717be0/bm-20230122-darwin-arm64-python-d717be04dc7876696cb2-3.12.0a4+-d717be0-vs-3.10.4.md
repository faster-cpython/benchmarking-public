...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230122-darwin-arm64-python-d717be04dc7876696cb2-3.12.0a4+-d717be0 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| regex_compile  | 96.6 ms                                                | 73.3 ms: 1.32x faster                                                  |
...
| Benchmark       | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230122-darwin-arm64-python-d717be04dc7876696cb2-3.12.0a4+-d717be0 |
|-----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| genshi_xml      | 37.6 ms                                                | 28.5 ms: 1.32x faster                                                  |
...
| Benchmark               | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230122-darwin-arm64-python-d717be04dc7876696cb2-3.12.0a4+-d717be0 |
|-------------------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
| deltablue               | 5.15 ms                                                | 2.62 ms: 1.96x faster                                                  |
| logging_silent          | 119 ns                                                 | 66.4 ns: 1.79x faster                                                  |
| richards                | 51.4 ms                                                | 30.6 ms: 1.68x faster                                                  |
| scimark_sor             | 127 ms                                                 | 82.5 ms: 1.53x faster                                                  |
| scimark_lu              | 110 ms                                                 | 72.4 ms: 1.52x faster                                                  |
| scimark_monte_carlo     | 72.2 ms                                                | 47.7 ms: 1.52x faster                                                  |
...
| chaos                   | 66.8 ms                                                | 48.3 ms: 1.38x faster                                                  |
| json_dumps              | 8.38 ms                                                | 6.08 ms: 1.38x faster                                                  |
...
| regex_compile           | 96.6 ms                                                | 73.3 ms: 1.32x faster                                                  |
| pprint_safe_repr        | 609 ms                                                 | 461 ms: 1.32x faster                                                   |
| genshi_xml              | 37.6 ms                                                | 28.5 ms: 1.32x faster                                                  |
| logging_format          | 5.01 us                                                | 3.83 us: 1.31x faster                                                  |
| logging_simple          | 4.63 us                                                | 3.55 us: 1.31x faster                                                  |
| spectral_norm           | 96.4 ms                                                | 73.9 ms: 1.30x faster                                                  |
| chameleon               | 5.84 ms                                                | 4.51 ms: 1.30x faster                                                  |
| mako                    | 10.5 ms                                                | 8.10 ms: 1.29x faster                                                  |
...
| unpack_sequence         | 38.7 ns                                                | 33.2 ns: 1.16x faster                                                  |
...
| pickle                  | 7.36 us                                                | 7.49 us: 1.02x slower                                                  |
| unpickle_list           | 2.66 us                                                | 2.72 us: 1.02x slower                                                  |
| generators              | 32.9 ms                                                | 34.2 ms: 1.04x slower                                                  |
| python_startup_no_site  | 9.73 ms                                                | 10.4 ms: 1.07x slower                                                  |
| regex_effbot            | 2.45 ms                                                | 2.64 ms: 1.08x slower                                                  |
