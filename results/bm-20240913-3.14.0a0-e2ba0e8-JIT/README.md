...
- fork: brandtbucher/tier_two_constants_p
- version: 3.14.0a0
- config: JIT
...
- Geometric mean: 1.085x faster (HPT: reliability of 99.99%, 1.03x faster at 99th %ile)
- Memory usage: 1.07x
...
- Geometric mean: 1.027x faster (HPT: reliability of 80.28%, 1.00x faster at 99th %ile)
- Memory usage: 0.99x
...
- Geometric mean: 1.003x slower (HPT: reliability of 92.44%, 1.00x slower at 99th %ile)
- Memory usage: 1.01x
