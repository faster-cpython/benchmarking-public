...
Benchmark hidden because not significant (11): pylint, mypy, json, python_startup, chameleon, pidigits, genshi_text, pathlib, bench_mp_pool, unpickle, tornado_http
