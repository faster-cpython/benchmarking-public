...
| Benchmark      | bm-20220323-pythonperf2-x86_64-python-v3.10.4-3.10.4-9d38120 | bm-20230805-pythonperf2-x86_64-python-3.12-3.12.0b4+-236cdad |
|----------------|:------------------------------------------------------------:|:------------------------------------------------------------:|
...
| Benchmark      | bm-20220323-pythonperf2-x86_64-python-v3.10.4-3.10.4-9d38120 | bm-20230805-pythonperf2-x86_64-python-3.12-3.12.0b4+-236cdad |
|----------------|:------------------------------------------------------------:|:------------------------------------------------------------:|
| nbody          | 137 ms                                                       | 91.3 ms: 1.50x faster                                        |
...
| regex_effbot   | 2.99 ms                                                      | 3.49 ms: 1.16x slower                                        |
...
| unpickle_list        | 4.49 us                                                      | 4.65 us: 1.04x slower                                        |
...
| richards_super           | 90.8 ms                                                      | 51.4 ms: 1.77x faster                                        |
...
| fannkuch                 | 496 ms                                                       | 341 ms: 1.45x faster                                         |
| pickle_pure_python       | 457 us                                                       | 319 us: 1.43x faster                                         |
| float                    | 110 ms                                                       | 78.1 ms: 1.41x faster                                        |
| json_dumps               | 14.2 ms                                                      | 10.3 ms: 1.38x faster                                        |
| tomli_loads              | 2.97 sec                                                     | 2.17 sec: 1.37x faster                                       |
...
| nqueens                  | 112 ms                                                       | 88.7 ms: 1.27x faster                                        |
| tornado_http             | 152 ms                                                       | 122 ms: 1.25x faster                                         |
...
| gc_traversal             | 3.45 ms                                                      | 4.23 ms: 1.23x slower                                        |
