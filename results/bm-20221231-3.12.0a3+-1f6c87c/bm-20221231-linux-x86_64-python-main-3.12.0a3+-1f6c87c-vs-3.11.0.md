...
Benchmark hidden because not significant (11): async_tree_memoization, thrift, async_tree_cpu_io_mixed, coverage, bench_mp_pool, unpickle_list, pathlib, xml_etree_generate, chameleon, async_tree_io, pprint_safe_repr
