...
| chameleon      | 9.06 ms                                                | 6.15 ms: 1.47x faster                                                       |
...
| Benchmark       | bm-20220323-linux-x86_64-python-v3.10.4-3.10.4-9d38120 | bm-20230105-linux-x86_64-iritkatriel-InitializeHeader_noa-3.12.0a3+-94fa28c |
|-----------------|:------------------------------------------------------:|:---------------------------------------------------------------------------:|
| mako            | 14.8 ms                                                | 9.38 ms: 1.57x faster                                                       |
...
| pyflate                 | 673 ms                                                 | 392 ms: 1.72x faster                                                        |
| go                      | 229 ms                                                 | 135 ms: 1.69x faster                                                        |
| scimark_monte_carlo     | 108 ms                                                 | 64.1 ms: 1.69x faster                                                       |
| python_startup          | 14.2 ms                                                | 8.49 ms: 1.67x faster                                                       |
...
| coroutines              | 31.8 ms                                                | 25.4 ms: 1.26x faster                                                       |
