...
| bpe_tokeniser              | 5.02 sec                                                   | 4.58 sec: 1.10x faster                                                |
| async_tree_memoization     | 463 ms                                                     | 423 ms: 1.10x faster                                                  |
| xml_etree_iterparse        | 107 ms                                                     | 98.6 ms: 1.09x faster                                                 |
| tomli_loads                | 2.12 sec                                                   | 1.95 sec: 1.09x faster                                                |
| async_tree_cpu_io_mixed    | 611 ms                                                     | 563 ms: 1.09x faster                                                  |
| coverage                   | 93.1 ms                                                    | 86.1 ms: 1.08x faster                                                 |
...
Benchmark hidden because not significant (8): pprint_pformat, json_loads, pprint_safe_repr, html5lib, go, sqlglot_parse, coroutines, pycparser
