...
- [📄table](bm-20240819-linux-x86_64-savannahostrowski-jit_mem_gc_old-3.14.0a0-1268c80-vs-3.13.0.md)
- [📈time plot](bm-20240819-linux-x86_64-savannahostrowski-jit_mem_gc_old-3.14.0a0-1268c80-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x faster (HPT: reliability of 84.22%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
