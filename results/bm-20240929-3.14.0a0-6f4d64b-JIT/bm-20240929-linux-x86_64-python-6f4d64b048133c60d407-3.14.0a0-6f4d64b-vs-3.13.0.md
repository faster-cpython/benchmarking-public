...
Benchmark hidden because not significant (4): async_tree_none_tg, asyncio_websockets, asyncio_tcp, async_tree_cpu_io_mixed
...
| mako                       | 11.1 ms                                                | 9.80 ms: 1.13x faster                                                 |
| xml_etree_generate         | 87.0 ms                                                | 77.2 ms: 1.13x faster                                                 |
| telco                      | 8.45 ms                                                | 7.55 ms: 1.12x faster                                                 |
...
Benchmark hidden because not significant (8): async_tree_none_tg, pprint_safe_repr, thrift, asyncio_websockets, asyncio_tcp, async_tree_cpu_io_mixed, unpickle_pure_python, unpickle
