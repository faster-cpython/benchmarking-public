...
| html5lib       | 64.5 ms                                                | 59.4 ms: 1.09x faster                                             |
...
| nbody          | 93.1 ms                                                | 94.5 ms: 1.02x slower                                             |
...
| mako            | 10.1 ms                                                | 9.73 ms: 1.04x faster                                             |
...
| chaos                   | 69.2 ms                                                | 63.0 ms: 1.10x faster                                             |
...
| html5lib                | 64.5 ms                                                | 59.4 ms: 1.09x faster                                             |
| pickle_pure_python      | 306 us                                                 | 283 us: 1.08x faster                                              |
| nqueens                 | 83.4 ms                                                | 77.3 ms: 1.08x faster                                             |
...
Benchmark hidden because not significant (6): create_gc_cycles, sqlglot_transpile, pickle, async_tree_none, bench_mp_pool, djangocms
