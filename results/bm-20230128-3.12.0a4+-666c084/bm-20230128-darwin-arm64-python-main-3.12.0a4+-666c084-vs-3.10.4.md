...
| html5lib       | 44.1 ms                                                | 35.2 ms: 1.25x faster                                  |
...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230128-darwin-arm64-python-main-3.12.0a4+-666c084 |
|----------------|:------------------------------------------------------:|:------------------------------------------------------:|
| nbody          | 94.1 ms                                                | 64.2 ms: 1.47x faster                                  |
| float          | 72.3 ms                                                | 51.7 ms: 1.40x faster                                  |
...
| xml_etree_generate   | 54.3 ms                                                | 49.4 ms: 1.10x faster                                  |
| xml_etree_iterparse  | 72.6 ms                                                | 67.9 ms: 1.07x faster                                  |
...
| Benchmark       | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230128-darwin-arm64-python-main-3.12.0a4+-666c084 |
|-----------------|:------------------------------------------------------:|:------------------------------------------------------:|
| mako            | 10.5 ms                                                | 7.25 ms: 1.44x faster                                  |
...
| scimark_sor             | 127 ms                                                 | 77.8 ms: 1.63x faster                                  |
| asyncio_tcp             | 673 ms                                                 | 422 ms: 1.60x faster                                   |
...
| pprint_pformat          | 1.24 sec                                               | 950 ms: 1.31x faster                                   |
...
| generators              | 32.9 ms                                                | 34.7 ms: 1.05x slower                                  |
| regex_effbot            | 2.45 ms                                                | 2.65 ms: 1.08x slower                                  |
...
Ignored benchmarks (1) of results/bm-20230128-3.12.0a4+-666c084/bm-20230128-darwin-arm64-python-main-3.12.0a4+-666c084.json: mypy
