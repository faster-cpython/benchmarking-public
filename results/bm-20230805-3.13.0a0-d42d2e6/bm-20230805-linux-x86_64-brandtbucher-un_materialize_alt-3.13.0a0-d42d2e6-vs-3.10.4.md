...
| Benchmark      | bm-20220323-linux-x86_64-python-v3.10.4-3.10.4-9d38120 | bm-20230805-linux-x86_64-brandtbucher-un_materialize_alt-3.13.0a0-d42d2e6 |
|----------------|:------------------------------------------------------:|:-------------------------------------------------------------------------:|
...
| coverage                 | 72.8 ms                                                | 93.5 ms: 1.29x slower                                                     |
| Geometric mean           | (ref)                                                  | 1.30x faster                                                              |

Benchmark hidden because not significant (3): bench_mp_pool, gc_traversal, mypy2
