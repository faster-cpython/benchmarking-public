...
- fork: python/33eeccf6d4f16e483b4c
- version: 3.14.0a0
- config: JIT
...
- Geometric mean: 1.423x faster (HPT: reliability of 100.00%, 1.26x faster at 99th %ile)
- Memory usage: 1.21x
...
- Geometric mean: 1.029x faster (HPT: reliability of 85.17%, 1.00x faster at 99th %ile)
- Memory usage: 0.98x
