...
| chameleon      | 9.17 ms                                                | 6.12 ms: 1.50x faster                                                  |
...
| json_dumps           | 13.4 ms                                                | 9.29 ms: 1.45x faster                                                  |
...
| genshi_xml      | 63.7 ms                                                | 45.8 ms: 1.39x faster                                                  |
...
| float                   | 109 ms                                                 | 71.9 ms: 1.51x faster                                                  |
| chameleon               | 9.17 ms                                                | 6.12 ms: 1.50x faster                                                  |
| pprint_pformat          | 1.98 sec                                               | 1.35 sec: 1.47x faster                                                 |
...
| sqlglot_normalize       | 134 ms                                                 | 102 ms: 1.31x faster                                                   |
