...
- Geometric mean: 1.07x slower (HPT: reliability of 99.85%, 1.02x slower at 99th %ile)
- Memory usage: 1.44x
...
- Geometric mean: 1.38x slower (HPT: reliability of 100.00%, 1.31x slower at 99th %ile)
- Memory usage: 1.17x
...
- Geometric mean: 1.29x slower (HPT: reliability of 100.00%, 1.12x slower at 99th %ile)
- Memory usage: 1.30x
- missing benchmarks: aiohttp, chameleon, dask, gunicorn, mypy2, sqlalchemy_declarative, sqlalchemy_imperative
