...
| async_tree_memoization_tg        | 291 ms                                                 | 237 ms: 1.23x faster                                                  |
...
| async_tree_io_tg                 | 500 ms                                                 | 606 ms: 1.21x slower                                                  |
| async_tree_eager_io              | 513 ms                                                 | 699 ms: 1.36x slower                                                  |
...
| coroutines                       | 19.8 ms                                                | 16.1 ms: 1.23x faster                                                 |
| async_tree_memoization_tg        | 291 ms                                                 | 237 ms: 1.23x faster                                                  |
| comprehensions                   | 12.2 us                                                | 9.93 us: 1.23x faster                                                 |
| genshi_text                      | 16.9 ms                                                | 13.8 ms: 1.22x faster                                                 |
...
| genshi_xml                       | 34.4 ms                                                | 30.1 ms: 1.14x faster                                                 |
| logging_silent                   | 69.9 ns                                                | 61.2 ns: 1.14x faster                                                 |
...
| scimark_sor                      | 106 ms                                                 | 93.3 ms: 1.13x faster                                                 |
...
| docutils                         | 1.44 sec                                               | 1.47 sec: 1.01x slower                                                |
| json_loads                       | 16.9 us                                                | 17.2 us: 1.02x slower                                                 |
| json                             | 2.94 ms                                                | 3.01 ms: 1.03x slower                                                 |
...
Benchmark hidden because not significant (6): async_tree_cpu_io_mixed, xml_etree_iterparse, async_tree_none_tg, asyncio_tcp_ssl, pylint, tornado_http
