...
- [GitHub Action run](https://github.com/faster-cpython/benchmarking/actions/runs/12948682729)
...
- Geometric mean: 1.234x faster (HPT: reliability of 100.00%, 1.11x faster at 99th %ile)
- Memory usage: 1.51x
...
- Geometric mean: 1.007x slower (HPT: reliability of 99.98%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
