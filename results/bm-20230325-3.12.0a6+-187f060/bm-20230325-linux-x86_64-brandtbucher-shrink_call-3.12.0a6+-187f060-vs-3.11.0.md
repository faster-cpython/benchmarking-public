...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230325-linux-x86_64-brandtbucher-shrink_call-3.12.0a6+-187f060 |
|----------------|:------------------------------------------------------:|:-------------------------------------------------------------------:|
...
Benchmark hidden because not significant (10): djangocms, async_tree_none, sympy_sum, async_tree_io, dulwich_log, regex_dna, bench_mp_pool, chameleon, async_tree_cpu_io_mixed, unpickle
