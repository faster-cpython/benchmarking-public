...
- Geometric mean: 1.02x slower (HPT: reliability of 82.67%, 1.00x slower at 99th %ile)
- Memory usage: 1.04x
...
- [📄table](bm-20240919-linux-x86_64-savannahostrowski-jit_inv_cold_100-3.14.0a0-99262b6-vs-3.13.0b2.md)
- [📈time plot](bm-20240919-linux-x86_64-savannahostrowski-jit_inv_cold_100-3.14.0a0-99262b6-vs-3.13.0b2.svg)
