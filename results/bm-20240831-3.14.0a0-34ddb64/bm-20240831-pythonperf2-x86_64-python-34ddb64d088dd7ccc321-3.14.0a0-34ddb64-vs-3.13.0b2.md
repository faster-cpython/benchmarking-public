...
| docutils                   | 2.98 sec                                                         | 2.90 sec: 1.03x faster                                                      |
| json                       | 5.35 ms                                                          | 5.21 ms: 1.03x faster                                                       |
| xml_etree_iterparse        | 103 ms                                                           | 100.0 ms: 1.03x faster                                                      |
...
Benchmark hidden because not significant (7): asyncio_websockets, xml_etree_parse, mako, typing_runtime_protocols, create_gc_cycles, deltablue, pylint
