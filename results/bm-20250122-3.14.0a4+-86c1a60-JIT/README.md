...
- [pystats diff](bm-20250122-azure-x86_64-python-86c1a60d5a28cfb51f88-3.14.0a4%2B-86c1a60-pystats-vs-base.md)
...
- Geometric mean: 1.035x faster (HPT: reliability of 99.19%, 1.00x faster at 99th %ile)
- Memory usage: 1.04x
...
- Geometric mean: 1.010x slower (HPT: reliability of 99.55%, 1.00x slower at 99th %ile)
- Memory usage: 1.01x
