...
- Geometric mean: 1.14x faster (HPT: reliability of 99.99%, 1.01x faster at 99th %ile)
- Memory usage: 1.15x
...
- [📄table](bm-20240719-pythonperf2-x86_64-python-main-3.14.0a0-adf0b94-vs-3.13.0.md)
- [📈time plot](bm-20240719-pythonperf2-x86_64-python-main-3.14.0a0-adf0b94-vs-3.13.0.svg)
