...
- Geometric mean: 1.01x faster (HPT: reliability of 68.64%, 1.00x faster at 99th %ile)
- Memory usage: 1.01x
...
- [📄table](bm-20240811-linux-x86_64-python-253c6a0b2f88b3327b71-3.14.0a0-253c6a0-vs-3.13.0.md)
- [📈time plot](bm-20240811-linux-x86_64-python-253c6a0b2f88b3327b71-3.14.0a0-253c6a0-vs-3.13.0.svg)
