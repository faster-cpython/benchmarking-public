...
|---|---:|---:|---:|---:|
| LOAD_FAST | 5,031,927 | 18.6% | 18.6% |  |
| POP_JUMP_IF_FALSE | 1,499,507 | 5.5% | 24.1% |  |
| LOAD_ATTR_SLOT | 1,299,760 | 4.8% | 29.0% | 0.4% |
| LOAD_CONST | 1,175,336 | 4.3% | 33.3% |  |
...
| LOAD_ATTR_INSTANCE_VALUE | 830,813 | 3.1% | 54.4% | 0.1% |
| LOAD_GLOBAL_BUILTIN | 747,405 | 2.8% | 57.2% | 0.4% |
| LOAD_ATTR | 720,900 | 2.7% | 59.9% |  |
| POP_JUMP_IF_TRUE | 583,520 | 2.2% | 62.0% |  |
| POP_TOP | 565,803 | 2.1% | 64.1% |  |
| RETURN_VALUE | 519,860 | 1.9% | 66.0% |  |
| CALL_PY_EXACT_ARGS | 464,559 | 1.7% | 67.8% | 0.1% |
| IS_OP | 418,560 | 1.5% | 69.3% |  |
| RETURN_CONST | 384,360 | 1.4% | 70.7% |  |
| CALL | 359,498 | 1.3% | 72.1% |  |
| PUSH_NULL | 311,080 | 1.2% | 73.2% |  |
| JUMP_BACKWARD | 304,619 | 1.1% | 74.3% |  |
...
| COMPARE_OP_INT | 250,829 | 0.9% | 81.2% | 0.1% |
| LOAD_ATTR_WITH_HINT | 229,640 | 0.8% | 82.0% | 3.2% |
| BINARY_OP | 225,780 | 0.8% | 82.9% |  |
| STORE_ATTR | 225,700 | 0.8% | 83.7% |  |
| INTERPRETER_EXIT | 209,720 | 0.8% | 84.5% |  |
| CALL_LEN | 195,928 | 0.7% | 85.2% |  |
...
| CALL_METHOD_DESCRIPTOR_NOARGS | 142,663 | 0.5% | 90.5% | 7.0% |
| POP_JUMP_IF_NOT_NONE | 131,160 | 0.5% | 91.0% |  |
| NOP | 120,920 | 0.4% | 91.4% |  |
| JUMP_FORWARD | 108,864 | 0.4% | 91.8% |  |
...
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 35,860 | 0.1% | 96.9% | 92.8% |
| DELETE_SUBSCR | 33,917 | 0.1% | 97.0% |  |
| BUILD_SLICE | 33,657 | 0.1% | 97.1% |  |
...
| CALL_METHOD_DESCRIPTOR_FAST | 13,160 | 0.0% | 99.2% |  |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 805,573 | 3.0% | 6.5% |
| POP_JUMP_IF_FALSE LOAD_FAST | 784,177 | 2.9% | 9.4% |
...
| POP_JUMP_IF_TRUE LOAD_FAST | 453,999 | 1.7% | 19.5% |
| IS_OP POP_JUMP_IF_FALSE | 416,220 | 1.5% | 21.0% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 404,748 | 1.5% | 22.5% |
...
| CACHE RESUME_CHECK | 164,600 | 0.6% | 45.1% |
...
| POP_JUMP_IF_FALSE LOAD_CONST | 151,441 | 0.6% | 49.2% |
...
| CALL STORE_FAST | 137,580 | 0.5% | 55.0% |
...
| RETURN_VALUE STORE_FAST | 123,260 | 0.5% | 57.4% |
...
| RETURN_CONST INTERPRETER_EXIT | 106,420 | 0.4% | 59.4% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 106,080 | 0.4% | 59.8% |
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 105,908 | 0.4% | 60.2% |
| LOAD_GLOBAL_BUILTIN LOAD_GLOBAL_BUILTIN | 105,117 | 0.4% | 60.6% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 96,299 | 0.4% | 62.8% |
| NOP LOAD_FAST | 96,140 | 0.4% | 63.2% |
| POP_JUMP_IF_NONE LOAD_FAST | 93,160 | 0.3% | 63.5% |
| CALL_LEN LOAD_FAST | 92,268 | 0.3% | 63.9% |
| PUSH_NULL LOAD_CONST | 90,980 | 0.3% | 64.2% |
...
| LOAD_ATTR_METHOD_NO_DICT CALL_METHOD_DESCRIPTOR_NOARGS | 69,563 | 0.3% | 69.3% |
| LOAD_CONST LOAD_CONST | 69,540 | 0.3% | 69.6% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| BUILD_SLICE | 33,597 | 99.1% |
| LOAD_FAST | 260 | 0.8% |
| CALL | 60 | 0.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 33,597 | 99.1% |
| LOAD_CONST | 140 | 0.4% |
...
| POP_JUMP_IF_FALSE | 151,441 | 12.9% |
| GET_AWAITABLE | 151,360 | 12.9% |
| PUSH_NULL | 90,980 | 7.7% |
| LOAD_CONST | 69,540 | 5.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 214,214 | 18.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 784,177 | 15.6% |
| STORE_FAST | 729,260 | 14.5% |
| RESUME_CHECK | 469,160 | 9.3% |
| POP_JUMP_IF_TRUE | 453,999 | 9.0% |
| LOAD_GLOBAL_BUILTIN | 404,748 | 8.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 964,960 | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE | 805,573 | 16.0% |
...
| IS_OP | 416,220 | 27.8% |
| COMPARE_OP_INT | 248,149 | 16.5% |
| TO_BOOL_NONE | 75,540 | 5.0% |
| CONTAINS_OP | 65,300 | 4.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 784,177 | 52.3% |
| LOAD_GLOBAL_BUILTIN | 306,928 | 20.5% |
| LOAD_CONST | 151,441 | 10.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 105,908 | 54.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 2,880 | 21.9% |
| BUILD_LIST | 2,640 | 20.1% |
| LOAD_ATTR_METHOD_NO_DICT | 2,360 | 17.9% |
| LOAD_CONST | 1,540 | 11.7% |
| LOAD_FAST_LOAD_FAST | 1,240 | 9.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 3,660 | 27.8% |
| RETURN_VALUE | 3,300 | 25.1% |
| LIST_APPEND | 2,400 | 18.2% |
| LOAD_ATTR_METHOD_NO_DICT | 2,040 | 15.5% |
| BUILD_TUPLE | 840 | 6.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_METHOD_NO_DICT | 69,563 | 48.8% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,348 | 8.1% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 248,149 | 98.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 96,299 | 34.8% |
| CALL_METHOD_DESCRIPTOR_NOARGS | 69,563 | 25.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 306,928 | 41.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 18,279 | 92.6% |
| LOAD_FAST | 1,100 | 5.6% |
| TO_BOOL | 360 | 1.8% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 18,999 | 96.3% |
...
|---|---:|---:|
| Basic | 13,036,963 | 48.2% |
| Not specialized | 4,447,942 | 16.4% |
| Specialized hits | 9,478,714 | 35.0% |
| Specialized misses | 83,301 | 0.3% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 776,217 | 32.7% |
| Frees to freelist | 780,317 |  |
| Allocations | 1,598,034 | 67.3% |
| Allocations to 512 bytes | 1,407,928 | 59.3% |
| Allocations to 4 kbytes | 132,310 | 5.6% |
| Allocations over 4 kbytes | 57,796 | 2.4% |
| Frees | 1,536,942 |  |
| New values | 34,900 |  |
| Interpreter increfs | 12,202,287 | 76.6% |
| Interpreter decrefs | 14,018,083 | 78.2% |
| Increfs | 3,729,346 | 23.4% |
| Decrefs | 3,916,517 | 21.8% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,230,176 |  |
| Method cache misses | 30,144 |  |
| Method cache collisions | 33,561 |  |
| Method cache dunder hits | 358,513 |  |
| Method cache dunder misses | 5,687 |  |
