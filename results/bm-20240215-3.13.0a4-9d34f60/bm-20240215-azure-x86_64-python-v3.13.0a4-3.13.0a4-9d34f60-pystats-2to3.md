...
| LOAD_GLOBAL_BUILTIN | 2,960 | 2.5% | 57.2% | 8.1% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL | 420 | 0.4% | 53.2% |
| POP_TOP RETURN_CONST | 400 | 0.3% | 53.5% |
| CALL CALL | 400 | 0.3% | 53.8% |
...
|---|---:|---:|
| LOAD_FAST | 560 | 18.9% |
| LOAD_GLOBAL | 560 | 18.9% |
| RESUME_CHECK | 400 | 13.5% |
| NOP | 240 | 8.1% |
| LOAD_FAST_LOAD_FAST | 240 | 8.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 1,820 | 61.5% |
| CALL_ISINSTANCE | 440 | 14.9% |
| LOAD_GLOBAL_BUILTIN | 160 | 5.4% |
...
|Failure kind | Count | Ratio | 
|---|---:|---:|
| code complex parameters | 100 | 27.8% |
| cfunc noargs | 100 | 27.8% |
| class no vectorcall | 60 | 16.7% |
| metaclass | 60 | 16.7% |
| cfunc varargs | 20 | 5.6% |
| meth descr varargs | 20 | 5.6% |
...
|---|---:|---:|
| Basic | 62,640 | 52.4% |
| Not specialized | 26,880 | 22.5% |
| Specialized hits | 29,380 | 24.6% |
| Specialized misses | 680 | 0.6% |
...
|---|---:|---:|
| CALL | 3,060 | 27.2% |
| LOAD_ATTR | 2,580 | 23.0% |
| LOAD_GLOBAL | 1,840 | 16.4% |
| TO_BOOL | 1,320 | 11.7% |
| STORE_ATTR | 840 | 7.5% |
| BINARY_OP | 560 | 5.0% |
| COMPARE_OP | 540 | 4.8% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| LOAD_GLOBAL_BUILTIN | 240 | 35.3% |
| LOAD_ATTR_METHOD_NO_DICT | 160 | 23.5% |
| CALL_BOUND_METHOD_EXACT_ARGS | 120 | 17.6% |
| COMPARE_OP_STR | 80 | 11.8% |
| TO_BOOL_STR | 80 | 11.8% |
| CACHE | 0 | 0.0% |
| BEFORE_WITH | 0 | 0.0% |
...
| Frees | 11,099 |  |
| New values | 400 |  |
| Interpreter increfs | 40,740 | 59.7% |
...
| Method cache hits | 7,614 |  |
| Method cache misses | 1,366 |  |
| Method cache collisions | 1,179 |  |
| Method cache dunder hits | 2,457 |  |
