...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230805-linux-x86_64-python-main-3.13.0a0-6996b40 |
|----------------|:------------------------------------------------------:|:-----------------------------------------------------:|
...
| generators               | 73.5 ms                                                | 27.8 ms: 2.65x faster                                 |
...
Benchmark hidden because not significant (4): bench_mp_pool, meteor_contest, scimark_monte_carlo, unpickle_list
