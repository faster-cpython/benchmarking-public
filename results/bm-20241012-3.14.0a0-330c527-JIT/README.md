...
- Geometric mean: 1.03x faster (HPT: reliability of 94.40%, 1.00x faster at 99th %ile)
- Memory usage: 1.03x
- missing benchmarks: aiohttp, async_tree_cpu_io_mixed, async_tree_cpu_io_mixed_tg, async_tree_io, async_tree_io_tg, async_tree_memoization, async_tree_memoization_tg, async_tree_none, async_tree_none_tg, chameleon, dask, gunicorn, mypy2, sqlalchemy_declarative, sqlalchemy_imperative
...
- Geometric mean: 1.02x faster (HPT: reliability of 97.52%, 1.00x faster at 99th %ile)
- Memory usage: 1.07x
...
- Geometric mean: 1.02x slower (HPT: reliability of 79.05%, 1.00x slower at 99th %ile)
- Memory usage: 1.06x
...
- Geometric mean: 1.10x slower (HPT: reliability of 91.90%, 1.00x slower at 99th %ile)
- Memory usage: 0.97x
- missing benchmarks: aiohttp, async_tree_cpu_io_mixed, async_tree_cpu_io_mixed_tg, async_tree_io, async_tree_io_tg, async_tree_memoization, async_tree_memoization_tg, async_tree_none, async_tree_none_tg, chameleon, dask, gunicorn, mypy2, sqlalchemy_declarative, sqlalchemy_imperative
- new benchmarks: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, thrift
...
- Geometric mean: 1.08x slower (HPT: reliability of 68.83%, 1.00x slower at 99th %ile)
- Memory usage: 1.07x
- missing benchmarks: aiohttp, async_tree_cpu_io_mixed, async_tree_cpu_io_mixed_tg, async_tree_io, async_tree_io_tg, async_tree_memoization, async_tree_memoization_tg, async_tree_none, async_tree_none_tg, chameleon, dask, flaskblogging, gunicorn, mypy2
- new benchmarks: unpack_sequence
...
- Geometric mean: 1.03x slower (HPT: reliability of 93.88%, 1.00x slower at 99th %ile)
- Memory usage: 1.07x
...
- Geometric mean: 1.02x faster (HPT: reliability of 97.43%, 1.00x slower at 99th %ile)
- Memory usage: unknown
...
- Geometric mean: 1.01x faster (HPT: reliability of 80.83%, 1.00x faster at 99th %ile)
- Memory usage: 0.78x
- missing benchmarks: aiohttp, async_tree_cpu_io_mixed, async_tree_cpu_io_mixed_tg, async_tree_io, async_tree_io_tg, async_tree_memoization, async_tree_memoization_tg, async_tree_none, async_tree_none_tg, chameleon, dask, gunicorn, mypy2, sqlalchemy_declarative, sqlalchemy_imperative
- new benchmarks: bpe_tokeniser, genshi_text, genshi_xml, html5lib, pylint, thrift
