...
| mako            | 10.1 ms                                                | 9.56 ms: 1.05x faster                                                        |
...
| aiohttp                 | 1.10 ms                                                | 990 us: 1.11x faster                                                         |
| regex_effbot            | 3.99 ms                                                | 3.60 ms: 1.11x faster                                                        |
| json_loads              | 26.5 us                                                | 23.9 us: 1.11x faster                                                        |
...
| bench_thread_pool       | 819 us                                                 | 773 us: 1.06x faster                                                         |
...
Benchmark hidden because not significant (7): spectral_norm, nbody, djangocms, async_tree_none, sqlglot_transpile, bench_mp_pool, deepcopy_reduce
