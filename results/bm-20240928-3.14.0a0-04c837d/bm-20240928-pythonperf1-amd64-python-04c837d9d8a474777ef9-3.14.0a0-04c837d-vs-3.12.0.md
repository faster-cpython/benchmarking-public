...
| tornado_http   | 89.5 ms                                                     | 92.7 ms: 1.04x slower                                                      |
...
| unpickle             | 8.18 us                                                     | 9.24 us: 1.13x slower                                                      |
...
| chaos                      | 43.3 ms                                                     | 44.7 ms: 1.03x slower                                                      |
...
| scimark_lu                 | 58.9 ms                                                     | 68.1 ms: 1.16x slower                                                      |
...
| tomli_loads                | 1.37 sec                                                    | 1.63 sec: 1.19x slower                                                     |
| scimark_sor                | 78.8 ms                                                     | 95.5 ms: 1.21x slower                                                      |
| unpack_sequence            | 37.5 ns                                                     | 45.8 ns: 1.22x slower                                                      |
| nbody                      | 71.9 ms                                                     | 89.4 ms: 1.24x slower                                                      |
| fannkuch                   | 247 ms                                                      | 308 ms: 1.25x slower                                                       |
| json                       | 3.05 ms                                                     | 4.24 ms: 1.39x slower                                                      |
| Geometric mean             | (ref)                                                       | 1.03x slower                                                               |

Benchmark hidden because not significant (3): pathlib, bench_mp_pool, xml_etree_parse
...
Ignored benchmarks (5) of results/bm-20240928-3.14.0a0-04c837d/bm-20240928-pythonperf1-amd64-python-04c837d9d8a474777ef9-3.14.0a0-04c837d.json: genshi_text, genshi_xml, html5lib, pylint, thrift
