...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230701-linux-x86_64-python-822db860eada721742f8-3.13.0a0-822db86 |
|----------------|:------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| coverage                 | 100 ms                                                 | 92.1 ms: 1.09x faster                                                 |
| regex_effbot             | 3.99 ms                                                | 3.68 ms: 1.09x faster                                                 |
...
Benchmark hidden because not significant (7): pickle_pure_python, bench_mp_pool, bench_thread_pool, tornado_http, logging_format, deepcopy_memo, scimark_lu
