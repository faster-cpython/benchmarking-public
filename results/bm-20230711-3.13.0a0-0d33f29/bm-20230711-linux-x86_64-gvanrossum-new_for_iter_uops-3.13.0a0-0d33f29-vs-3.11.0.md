...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230711-linux-x86_64-gvanrossum-new_for_iter_uops-3.13.0a0-0d33f29 |
|----------------|:------------------------------------------------------:|:----------------------------------------------------------------------:|
...
Benchmark hidden because not significant (8): meteor_contest, regex_compile, bench_thread_pool, bench_mp_pool, scimark_lu, tornado_http, unpack_sequence, json
