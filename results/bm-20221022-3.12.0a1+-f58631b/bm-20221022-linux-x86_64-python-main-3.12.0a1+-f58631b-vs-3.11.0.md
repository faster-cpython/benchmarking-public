...
| chameleon      | 6.47 ms                                                | 6.60 ms: 1.02x slower                                  |
...
| pickle_dict             | 31.1 us                                                | 31.0 us: 1.00x faster                                  |
| pidigits                | 198 ms                                                 | 199 ms: 1.01x slower                                   |
| chaos                   | 69.2 ms                                                | 69.7 ms: 1.01x slower                                  |
| nbody                   | 93.1 ms                                                | 93.9 ms: 1.01x slower                                  |
| python_startup_no_site  | 6.01 ms                                                | 6.06 ms: 1.01x slower                                  |
| unpickle_list           | 4.91 us                                                | 4.98 us: 1.01x slower                                  |
| chameleon               | 6.47 ms                                                | 6.60 ms: 1.02x slower                                  |
...
Benchmark hidden because not significant (3): pylint, django_template, async_tree_none
