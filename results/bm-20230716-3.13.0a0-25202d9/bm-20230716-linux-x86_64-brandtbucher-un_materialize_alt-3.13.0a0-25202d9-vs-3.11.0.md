...
| Benchmark      | bm-20221024-linux-x86_64-python-v3.11.0-3.11.0-deaf509 | bm-20230716-linux-x86_64-brandtbucher-un_materialize_alt-3.13.0a0-25202d9 |
|----------------|:------------------------------------------------------:|:-------------------------------------------------------------------------:|
...
| xml_etree_generate       | 76.2 ms                                                | 83.1 ms: 1.09x slower                                                     |
| telco                    | 6.58 ms                                                | 7.18 ms: 1.09x slower                                                     |
...
Benchmark hidden because not significant (6): bench_mp_pool, create_gc_cycles, regex_v8, tornado_http, logging_silent, mypy2
