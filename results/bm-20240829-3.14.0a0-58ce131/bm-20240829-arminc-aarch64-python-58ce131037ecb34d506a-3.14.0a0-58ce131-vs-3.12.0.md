...
| logging_format             | 8.34 us                                                               | 7.66 us: 1.09x faster                                                   |
...
| sqlglot_normalize          | 126 ms                                                                | 125 ms: 1.00x faster                                                    |
| float                      | 92.1 ms                                                               | 92.6 ms: 1.01x slower                                                   |
...
| gc_traversal               | 4.40 ms                                                               | 4.84 ms: 1.10x slower                                                   |
| json_dumps                 | 12.3 ms                                                               | 13.6 ms: 1.11x slower                                                   |
...
Benchmark hidden because not significant (13): xml_etree_iterparse, pickle_pure_python, asyncio_tcp, meteor_contest, bench_mp_pool, pyflate, asyncio_websockets, pylint, xml_etree_generate, genshi_text, sqlglot_optimize, xml_etree_process, genshi_xml
