...
Benchmark hidden because not significant (3): asyncio_tcp, async_tree_cpu_io_mixed_tg, async_tree_io_tg
...
| go                               | 115 ms                                                 | 97.5 ms: 1.18x faster                                                 |
...
| pprint_pformat                   | 1.08 sec                                               | 951 ms: 1.13x faster                                                  |
...
| dask                             | 255 ms                                                 | 229 ms: 1.11x faster                                                  |
...
Benchmark hidden because not significant (6): tornado_http, asyncio_tcp, async_tree_cpu_io_mixed_tg, xml_etree_iterparse, pylint, async_tree_io_tg
