...
| Benchmark      | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230624-darwin-arm64-python-3.12-3.12.0b3+-9cd3664 |
|----------------|:------------------------------------------------------:|:------------------------------------------------------:|
...
| xml_etree_iterparse  | 72.6 ms                                                | 75.2 ms: 1.03x slower                                  |
...
| Benchmark                | bm-20220323-darwin-arm64-python-v3.10.4-3.10.4-9d38120 | bm-20230624-darwin-arm64-python-3.12-3.12.0b3+-9cd3664 |
|--------------------------|:------------------------------------------------------:|:------------------------------------------------------:|
| typing_runtime_protocols | 344 us                                                 | 89.8 us: 3.83x faster                                  |
...
| float                    | 72.3 ms                                                | 56.8 ms: 1.27x faster                                  |
| logging_simple           | 4.63 us                                                | 3.63 us: 1.27x faster                                  |
| regex_compile            | 96.6 ms                                                | 75.9 ms: 1.27x faster                                  |
