...
| async_tree_io_tg                 | 500 ms                                                 | 582 ms: 1.16x slower                                                  |
...
Benchmark hidden because not significant (9): xml_etree_iterparse, xml_etree_parse, async_tree_cpu_io_mixed, pylint, json, async_tree_none_tg, asyncio_tcp_ssl, python_startup_no_site, tornado_http
