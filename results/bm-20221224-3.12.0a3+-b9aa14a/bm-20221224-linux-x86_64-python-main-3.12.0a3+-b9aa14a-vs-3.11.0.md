...
| scimark_sparse_mat_mult | 4.59 ms                                                | 4.25 ms: 1.08x faster                                  |
| html5lib                | 64.8 ms                                                | 60.2 ms: 1.08x faster                                  |
...
Benchmark hidden because not significant (6): djangocms, async_tree_memoization, async_tree_none, chameleon, bench_mp_pool, xml_etree_generate
