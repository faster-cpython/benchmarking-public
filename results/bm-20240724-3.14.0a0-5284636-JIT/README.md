...
- Geometric mean: 1.01x faster (HPT: reliability of 69.67%, 1.00x faster at 99th %ile)
- Memory usage: 1.07x
...
- [📄table](bm-20240724-linux-x86_64-brandtbucher-5284636f582a834c7628-3.14.0a0-5284636-vs-3.13.0.md)
- [📈time plot](bm-20240724-linux-x86_64-brandtbucher-5284636f582a834c7628-3.14.0a0-5284636-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x faster (HPT: reliability of 68.12%, 1.00x faster at 99th %ile)
- Memory usage: 0.99x
