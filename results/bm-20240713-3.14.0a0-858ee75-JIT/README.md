...
- Geometric mean: 1.01x faster (HPT: reliability of 58.41%, 1.00x faster at 99th %ile)
- Memory usage: 1.07x
...
- [📄table](bm-20240713-linux-x86_64-brandtbucher-tier_two_improvement-3.14.0a0-858ee75-vs-3.13.0.md)
- [📈time plot](bm-20240713-linux-x86_64-brandtbucher-tier_two_improvement-3.14.0a0-858ee75-vs-3.13.0.svg)

### vs. base

- Geometric mean: 1.00x faster (HPT: reliability of 97.01%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
