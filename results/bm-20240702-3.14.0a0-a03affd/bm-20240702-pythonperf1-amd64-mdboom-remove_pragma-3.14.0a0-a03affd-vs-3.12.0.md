...
| float          | 56.8 ms                                                     | 57.8 ms: 1.02x slower                                               |
...
| bench_thread_pool          | 857 us                                                      | 770 us: 1.11x faster                                                |
...
Benchmark hidden because not significant (2): asyncio_tcp, sympy_sum
...
Ignored benchmarks (5) of results/bm-20240702-3.14.0a0-a03affd/bm-20240702-pythonperf1-amd64-mdboom-remove_pragma-3.14.0a0-a03affd.json: genshi_text, genshi_xml, html5lib, pylint, thrift
