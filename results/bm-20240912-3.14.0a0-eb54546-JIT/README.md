...
- Geometric mean: 1.00x faster (HPT: reliability of 79.53%, 1.00x faster at 99th %ile)
- Memory usage: 1.08x
...
- Geometric mean: 1.00x faster (HPT: reliability of 99.32%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
...
- [📄table](bm-20240912-linux-x86_64-brandtbucher-tier_two_constants-3.14.0a0-eb54546-vs-3.13.0b2.md)
- [📈time plot](bm-20240912-linux-x86_64-brandtbucher-tier_two_constants-3.14.0a0-eb54546-vs-3.13.0b2.svg)
