...
| Benchmark      | bm-20241007-darwin-arm64-python-v3.13.0-3.13.0-60403a5 | bm-20240824-darwin-arm64-PeterYang12-accelerate_DJBX33A-3.14.0a0-bf9cfa8 |
|----------------|:------------------------------------------------------:|:------------------------------------------------------------------------:|
...
| Benchmark      | bm-20241007-darwin-arm64-python-v3.13.0-3.13.0-60403a5 | bm-20240824-darwin-arm64-PeterYang12-accelerate_DJBX33A-3.14.0a0-bf9cfa8 |
|----------------|:------------------------------------------------------:|:------------------------------------------------------------------------:|
| regex_compile  | 78.5 ms                                                | 66.7 ms: 1.18x faster                                                    |
...
| json_dumps           | 6.56 ms                                                | 6.33 ms: 1.04x faster                                                    |
...
| mako            | 7.68 ms                                                | 7.09 ms: 1.08x faster                                                    |
...
| richards_super                   | 39.1 ms                                                | 33.0 ms: 1.19x faster                                                    |
| pprint_safe_repr                 | 531 ms                                                 | 449 ms: 1.18x faster                                                     |
| regex_compile                    | 78.5 ms                                                | 66.7 ms: 1.18x faster                                                    |
| nqueens                          | 62.9 ms                                                | 53.5 ms: 1.17x faster                                                    |
| html5lib                         | 36.6 ms                                                | 31.2 ms: 1.17x faster                                                    |
| richards                         | 35.4 ms                                                | 30.3 ms: 1.17x faster                                                    |
| pprint_pformat                   | 1.08 sec                                               | 923 ms: 1.17x faster                                                     |
| pickle_pure_python               | 213 us                                                 | 182 us: 1.17x faster                                                     |
...
| 2to3                             | 178 ms                                                 | 159 ms: 1.12x faster                                                     |
| typing_runtime_protocols         | 101 us                                                 | 90.3 us: 1.12x faster                                                    |
...
| tomli_loads                      | 1.56 sec                                               | 1.47 sec: 1.06x faster                                                   |
| bench_mp_pool                    | 50.9 ms                                                | 48.2 ms: 1.05x faster                                                    |
| async_generators                 | 294 ms                                                 | 281 ms: 1.05x faster                                                     |
...
Benchmark hidden because not significant (8): async_tree_none_tg, async_tree_cpu_io_mixed, telco, xml_etree_parse, pylint, json, asyncio_tcp_ssl, tornado_http
