...
- [📄table](bm-20240925-linux-x86_64-savannahostrowski-jit_invalidate_500k-3.14.0a0-61a6174-vs-3.13.0b2.md)
- [📈time plot](bm-20240925-linux-x86_64-savannahostrowski-jit_invalidate_500k-3.14.0a0-61a6174-vs-3.13.0b2.svg)

### vs. base

- Geometric mean: 1.00x slower (HPT: reliability of 99.44%, 1.00x slower at 99th %ile)
- Memory usage: 0.99x
